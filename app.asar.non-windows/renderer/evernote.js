/*! For license information please see evernote.js.LICENSE.txt */
  ...
  [208],
  {
          ...
          var l = (s.MD5 = o.extend({
            ...
            _doProcessBlock: function (t, e) {
              ...
              (C = A(C, _, x, j, s, 7, a[0])),
                ...
                (j = A(j, C, _, x, E, 12, a[13])),
                (x = A(x, j, C, _, b, 17, a[14])),
                (C = c(
                  C,
    ...
    39179: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        c = n(86633),
        u = n(16704);
      const f = "http://localhost/oauth_callback",
        d = (0, c.ZP)("evernote"),
        p = {
          data: () => ({
            showSpinner: !1,
          ...
          methods: {
            switchToChina(t) {
              (this.china = t), (this.showSpinner = !1), this.getOauthURL();
            },
            handleAuthorization({ target: t }) {
              this.showSpinner = !1;
              const e = t.getURL();
              if (0 !== e.indexOf(f)) return;
              const n = o().parse(e, !0).query.oauth_verifier;
              n
                ? this.evernoteClient.getAccessToken(
                    this.oauthToken,
                    this.oauthTokenSecret,
                    n,
                    (t, e) => {
                      this.$safeRun(async () => {
                        this.evernoteClient = new (a().Client)({
                          token: e,
                          sandbox: !1,
                          china: this.china,
                        });
                        const t = this.evernoteClient.getUserStore(),
                          n = await t.getUser(),
                          i = { oauthToken: e, china: this.china, ...n };
                        l.ZP.fetch(A.Pp, {
                          mutations: [
                            {
                              id: "evernote",
                          ...
                          await l.ZP.fetch((0, A.iM)(window.id), i),
                            window.close();
                        });
                      });
                    },
            ...
            getOauthURL() {
              try {
                (this.evernoteClient = new (a().Client)({
                  consumerKey: "xmind",
                  consumerSecret: "ee87a7c738511e29",
                  sandbox: !1,
                  china: this.china,
                })),
                  this.evernoteClient.getRequestToken(f, (t, e, n) => {
                    t
                      ? d.error("Request token error: %s", (0, u.SC)(t))
                      : ((this.oauthToken = e),
                        (this.oauthTokenSecret = n),
                        (this.oathURL =
                          this.evernoteClient.getAuthorizeUrl(e)));
                  });
              } catch (t) {
                throw t;
              }
              ...
              e(
                ...
                [
                  e(
                    ...
                    {
                      staticClass:
                        "uk-tab uk-tab-contained uk-flex uk-flex-center",
                      attrs: { "uk-tab": "" },
                    },
                    [
                      e(
                  ...
                  e(
                    ...
                    [
                      e("webview", {
                        ...
                        attrs: { src: t.oathURL, partition: "evernote" },
                        on: {
        ...
        t.data.show ||
          ...
          R &&
            ...
            Or(() => {
              Qr(n, x),
                z.cancelled ||
                  (Lr(n, T), Y || ($r(Q) ? setTimeout(z, Q) : Rr(n, A, z)));
            })),
        ...
        const {
          ...
          I = (n._leaveCb = O(() => {
            n.parentNode &&
              ...
              v && (Qr(n, c), Qr(n, u)),
              I.cancelled ? (v && Qr(n, A), g && g(n)) : (e(), h && h(n)),
              (n._leaveCb = null);
          }));
        function B() {
          I.cancelled ||
      ...
      const Jr = (function (t) {
                  ...
                  for (; d <= h && p <= m; )
                    i(g)
                      ...
                      : i(y)
                        ? (y = e[--h])
                        : Ui(g, v)
                          ? (b(g, v, o, n, p), (g = e[++d]), (v = n[++p]))
                          : Ui(y, M)
                            ? (b(y, M, o, n, m), (y = e[--h]), (M = n[--m]))
                            : Ui(g, M)
                              ? (b(g, M, o, n, m),
                                B &&
                                  c.insertBefore(
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, A);
            ...
            if (!i && Ui(t, e)) b(t, e, A, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
    ...
    77412: (t, e, n) => {
      ...
      function y(t, n, r = {}, s, l, A) {
        ...
        return (
          ...
          b && A && r.hydrate && r.hydrate(T.$state, b),
          (w = !0),
          (M = !0),
          T
        );
