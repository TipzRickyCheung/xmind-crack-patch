/*! For license information please see 4045.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [4045, 5586],
  {
    ...
    7836: (t, e, n) => {
      ...
      var i = {
        ...
        methods: {
          ...
          onMutations: function (t) {
            for (var e = this, n = !1, i = 0; i < t.length; i++) {
              var r = t[i],
                o = Array.from(r.addedNodes).filter(function (t) {
                  return !e.nodes.includes(t);
                });
              Array.from(r.removedNodes).includes(this.parent)
                ? (this.disable(), (this.waiting = !this.disabled))
                : this.waiting && o.length > 0 && (n = !0);
            }
            n && this.move();
          },
      ...
      function r(t, e, n, i, r, o, s, a, l, c) {
          ...
          return (function (t, e) {
            ...
            if (!i.ids.has(t)) {
              ...
              if (
                ...
                A[a] && i.element.removeChild(A[a]),
                  A.length
                    ? i.element.insertBefore(c, A[a])
      ...
      var f = {
          install: function t(e) {
            t.installed || ((t.installed = !0), e.component("Teleport", u));
          },
        },
        d = null;
      "undefined" != typeof window
