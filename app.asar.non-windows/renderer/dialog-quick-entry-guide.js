/*! For license information please see dialog-quick-entry-guide.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [9231],
  {
    ...
    48239: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".uk-lang-de-DE .start-quick-entry-btn[data-v-0caafb39],\n.uk-lang-ru-RU .start-quick-entry-btn[data-v-0caafb39] {\n  line-height: 20px;\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    65453: (t, e, n) => {
      ...
      const s = {
        ...
        data() {
          return {
            illustrationImageURL: this.$toResourceURL(
              "static/assets/images/quick-entry-guide-dialog-illustration.svg",
            ),
            buildNumber: "",
          };
        },
        computed: {
          touchBarItems() {
            return [
              ...
              {
                type: "button",
                label: this.$T("Launch Quick Entry"),
                backgroundColor: "primary",
                click: "startQuickEntry",
              },
              { type: "space", size: "flexible" },
            ].filter(Boolean);
          },
        ...
        methods: {
          startQuickEntry() {
            (0, o.JX)().handleCommand("openQuickEntry"),
              setTimeout(() => {
                window.close();
              }, 0);
          },
            ...
            [
              ...
              e("div", { staticClass: "uk-window-body uk-flex uk-flex-row" }, [
                ...
                e(
                  ...
                  {
                    staticClass:
                      "uk-panel uk-padding-large uk-flex uk-flex-column uk-width-expand",
                  },
                  [
                    e("div", { staticClass: "uk-height-expand" }, [
                      e(
                        "h1",
                        {
                          staticClass: "uk-margin-top uk-text-bold",
                          staticStyle: {
                            "font-size": "22px",
                            "padding-top": "18px",
                          },
                        ...
                        [
                          t._v(
                            "\n          " +
                              t._s(t.$T("Quick Entry")) +
                              "\n        ",
                          ),
                        ],
                      ),
                      t._v(" "),
                      e("h5", { staticClass: "uk-margin" }, [
                        t._v(
                          "\n          " +
                            t._s(
                              t.$T(
                                "Jot down your ideas with Quick Entry and create a mind map for them instantly. Now you can even set it to start with the system in Preferences at anytime.",
                              ),
                            ) +
                            "\n        ",
                        ),
                    ...
                    e(
                      ...
                      {
                        staticClass:
                          "uk-button uk-button-large uk-button-primary uk-width-1-1 uk-margin-large start-quick-entry-btn",
                        attrs: { type: "button" },
                        on: { click: t.startQuickEntry },
                      },
                      [
                        t._v(
                          "\n        " +
                            t._s(t.$T("Launch Quick Entry")) +
                            "\n      ",
                        ),
                      ],
                    ),
                    ...
                    e("div", { staticClass: "uk-text-center" }, [
                      e("span", { staticClass: "uk-text-muted" }, [
                        t._v(t._s(t.$T("You can always find it in app menu."))),
                      ]),
                    ]),
                  ],
                ),
      ...
      (0, i.Z)(a, { name: "dialog-quick-entry-guide" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
