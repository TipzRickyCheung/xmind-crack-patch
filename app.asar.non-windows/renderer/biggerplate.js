/*! For license information please see biggerplate.js.LICENSE.txt */
  ...
  [2963],
  {
    ...
    6462: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        l = n(54856),
        A = n(16704);
      const c = "K9FIvBKyOCYhS1Q1i6ov2YuC5FZ7iXOVzTdBS7GD",
        u = "http://localhost/biggerplate_callback",
        f = (0, a.ZP)("biggerplate"),
        d = {
          data: () => ({
            showSpinner: !1,
            oathURL: `https://accounts.biggerplate.com/oauth/auth?client_id=${c}&redirect_uri=${encodeURIComponent(u)}&response_type=code&scope=account+maps`,
          }),
          methods: {
            handleAuthorization({ target: t }) {
              const e = t.getURL();
              if (0 !== e.indexOf(u)) return;
              const n = o().parse(e, !0).query.code;
              n
                ? ((this.showSpinner = !0),
                  this.$safeRun(() => {
                    fetch("https://accounts.biggerplate.com/oauth/token", {
                      headers: {
                        "Content-Type":
                      ...
                      body: new URLSearchParams({
                        client_id: c,
                        client_secret:
                          "Uoe5YUPf14wkes5Gy5HIwTygMxPGe7hrztVMuIGU",
                        redirect_uri: u,
                        response_type: "token",
                        code: n,
                      ...
                      .then((t) =>
                        t
                          ? t.ok
                            ? t.json()
                            : Promise.reject(
                                "Biggerplate authorization is not ok: " +
                                  t.status,
                              )
                      ...
                      .then(
                        ({
                          ...
                          if (!t) return Promise.reject("Invalid access_token");
                          s.ZP.fetch(l.Pp, {
                            mutations: [
                              {
                                id: "biggerplate",
                                type: "updateBiggerplate",
                                payload: [
                                  {
                                    accessToken: t,
                                    realExpireTime:
                            ...
                            (this.showSpinner = !1), window.close();
                          });
                        },
                      )
                      .catch((t) => {
              ...
              e(
                ...
                [
                  e("div", { staticClass: "uk-window-title" }, [
                    t._v("Biggerplate Authorization"),
                  ]),
                  t._v(" "),
              ...
              e(
                ...
                [
                  e("webview", {
                    ...
                    attrs: { src: t.oathURL, partition: "biggerplate" },
                    on: {
                      "did-finish-load": function (e) {
                        return t.handleAuthorization(e);
                      },
                  ...
                  e(
                    "div",
                    {
                      ...
                      staticClass:
                        "uk-background-default uk-position-cover uk-flex uk-flex-1 uk-flex-center uk-flex-middle",
                    },
                    [e("div", { attrs: { "uk-spinner": "ratio: 4;" } })],
                  ),
                ],
                1,
              ),
    ...
    77760: (t) => {
      ...
      function Rn(t, s, a, A, c) {
        ...
        if (o(t.options.functional))
          return (function (t, i, o, s, a) {
            ...
            else r(o.attrs) && Dn(A, o.attrs), r(o.props) && Dn(A, o.props);
      ...
      function Ki(t, e) {
        ...
        for (s in (($ || J) && u.value !== c.value && Zi(A, "value", u.value),
        c))
          i(u[s]) &&
            (Bi(s)
        ...
        t.data.show ||
          ...
          R &&
            ...
            Or(() => {
              Lr(n, x),
                z.cancelled ||
                  (Qr(n, T), Y || (Pr(L) ? setTimeout(z, L) : Rr(n, A, z)));
            })),
          ...
          I.cancelled ||
            ...
            v &&
              ...
              Or(() => {
                Lr(n, A),
                  I.cancelled ||
                    (Qr(n, c), w || (Pr(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
