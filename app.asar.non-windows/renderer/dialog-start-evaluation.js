...
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [4615],
  {
    ...
    82594: (t, e, n) => {
      ...
      const d = (0, A.R)(window.location.search),
        p = (0, r.aZ)({
            ...
            const t = (0, r.FN)().proxy,
              ...
              A = (0, r.Fl)(() => ({
                zenMode: {
                  ...
                  HDImage: `${t.$toResourceURL("static/assets/images/dialog-evaluation/ZEN.png")} 1x, ${t.$toResourceURL("static/assets/images/dialog-evaluation/ZEN@2x.png")} 2x`,
                },
                pitch: {
                  title: n("Pitch Mode"),
                  desc: `${n("Your mind map is a slide show, one click to go. Pitch Mode generates smooth transitions and layouts for your mind map. Brainstorm, outline, rehearse, and present all in one place.")}\n\n${n("You can only present the first five slides in Xmind free plan. Upgrade to Xmind Pro to fully present.")}`,
                  image: t.$toResourceURL(
                    "static/assets/images/dialog-evaluation/pitch.png",
                  ),
                  HDImage: `${t.$toResourceURL("static/assets/images/dialog-evaluation/pitch.png")} 1x, ${t.$toResourceURL("static/assets/images/dialog-evaluation/pitch@2x.png")} 2x`,
                  noLimitHint: !0,
                },
                mapShot: {
                  title: n("Map Shot"),
                  ...
                  HDImage: `${t.$toResourceURL("static/assets/images/dialog-evaluation/map-shot.png")} 1x, ${t.$toResourceURL("static/assets/images/dialog-evaluation/map-shot@2x.png")} 2x`,
                },
              })),
              p = (0, r.Fl)(() => A.value[e].image),
              h = (0, r.Fl)(() => A.value[e].HDImage),
              g = () => {
                window.close();
              };
            return (
              (0, r.bv)(() =>
                f(this, void 0, void 0, function* () {
                  if (i.value) {
                    const { rawData: t } = yield l.ZP.fetch(a.lf.DEVICE_BIND);
                    (0, u.c7)().updateAccount({ rawSubscriptionData: t });
                  }
                  (0, c.L9)({ eventAction: "showStartEvaluation" });
                }),
              ),
              (0, r.YP)(
                () => (0, u.Yh)().status,
                (t) => {
                  if (t === s.wi.VALID) return g();
                },
              ),
              {
                ...
                clickUnlimitedTrialFeature: () => {
                  return (
                    (0, c.L9)({ eventAction: "clickStartEvaluation" }),
                    (t = { prompt: !0 }),
                    l.ZP.fetch((0, a.iM)(window.id), t).then(() =>
                      window.close(),
                    )
                  );
                  var t;
                ...
                cancel: g,
                purchaseNow: () => {
                  (0, c.L9)({ eventAction: "clickPurchaseInStartEvaluation" }),
                    l.ZP.fetch(a.Fx, {
      ...
      (0, i.Z)(h, { name: "dialog-start-evaluation" });
    },
    4075: (t, e, n) => {
      "use strict";
      n.d(e, { R: () => r });
    ...
    77760: (t) => {
        ...
        return (
          (y.run = () => {
            if (y.active)
              if (i) {
                const t = y.get();
                (o || p || (h ? t.some((t, e) => O(t, m[e])) : O(t, m))) &&
                  (d && d(),
      ...
      function Gr(t, e) {
        ...
        const _ = x && d ? d : A,
          ...
          z = (n._enterCb = L(() => {
            R && (Qr(n, T), Qr(n, j)),
              z.cancelled ? (R && Qr(n, _), O && O(n)) : S && S(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
