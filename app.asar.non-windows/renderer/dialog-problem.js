/*! For license information please see dialog-problem.js.LICENSE.txt */
  ...
  [3757],
  {
    ...
    92455: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        a = n(69931),
        l = n(85786);
      const c = o.Us["dialog-problem"];
      var A;
      !(function (t) {
        (t.OPEN_FILE = "OPEN_FILE"),
          (t.OPEN_LINK = "OPEN_LINK"),
          (t.OPEN_EMAIL = "OPEN_EMAIL");
      })(A || (A = {}));
      const u = (0, r.aZ)({
        setup() {
          const {
              ...
              stack: e,
              message: n,
            } = (0, s.JS)("dialog-problem")().error,
            i = (0, s.JE)().T,
            o = (0, r.Fl)(() => {
              switch (t) {
                case A.OPEN_FILE:
                  return i("Unable to Open File");
                case A.OPEN_LINK:
                  return i("The Browser Can't Be Opened");
                case A.OPEN_EMAIL:
                  return i("The E-mail Client Can't Be Opened");
              }
            }),
            u = (0, r.Fl)(() => {
              switch (t) {
                case A.OPEN_FILE:
                  return i(
                    "This file may have become corrupted. You may be able to retrieve previous versions from your File Cache, or report the issue to us for a solution. Thank you for helping us improve.",
                  );
                case A.OPEN_LINK:
                  return i(
                    "Oops, there was an error here. You may check the default browser of the system, or report it to us for a solution. Thank you for helping us to get better.",
                  );
                case A.OPEN_EMAIL:
                  return i(
                    "Oops, there was an error here. You may check the default e-mail client of the system, or report it to us for a solution. Thank you for helping us to get better.",
                  );
              }
            }),
            f = (0, r.Fl)(() => {
              const t = (0, l.Yv)();
              return `${[t.platform, t.arch, t.release].join(",")}:\n--------------------------------------------------\n${e || n}`;
            });
          return {
            iconImageURL: (0, a.ju)("static/images/error-dialog-icon.svg"),
            errorTitle: o,
            errorDesc: u,
            errorDetails: f,
            isOpenFileErr: t === A.OPEN_FILE,
            openFileCache: () => {
              (0, s.JX)().handleCommand("fileCache");
            },
            sendFeedback: () => {
              (0, s.JX)().handleCommand("feedback", {
                query: { isSendDiagnostic: !0 },
              });
            },
            expandDialog: () => {
              window.resizeTo(c.width, c.height + 180);
            },
            shrinkDialog: () => {
              window.resizeTo(c.width, c.height + 8);
            },
            close: () => {
              window.close();
            },
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-window-body uk-flex uk-flex-column uk-overflow-hidden",
                  staticStyle: { padding: "22px 24px" },
                },
                [
                  e("div", { staticClass: "uk-flex uk-flex-top uk-margin" }, [
                    e("div", {
                      staticStyle: {
                        width: "88px",
                        height: "88px",
                      ...
                      attrs: { "data-src": t.iconImageURL, "uk-img": "" },
                    }),
                    t._v(" "),
                    e(
                      "div",
                      { staticClass: "uk-width-expand uk-margin-left" },
                      [
                        e("h1", { staticClass: "uk-margin-remove" }, [
                          t._v(t._s(t.errorTitle)),
                        ]),
                        t._v(" "),
                        e("p", { staticStyle: { margin: "8px 0 12px" } }, [
                          t._v(t._s(t.errorDesc)),
                        ]),
                        t._v(" "),
                        e(
                          "div",
                            ...
                            directives: [
                              {
                                name: "show",
                                rawName: "v-show",
                                value: t.isOpenFileErr,
                                expression: "isOpenFileErr",
                              },
                            ],
                          },
                          [
                            e("div", [
                              e(
                                "button",
                                {
                                  ...
                                  on: { click: t.openFileCache },
                                },
                                [
                                  t._v(
                                    "\n              " +
                                      t._s(t.$T("Retrieve from File Cache")) +
                                      "\n            ",
                                  ),
                                ],
                              ),
                            ...
                            e(
                              ...
                              [
                                t._v(
                                  "\n            " +
                                    t._s(t.$T("Report Issue to Xmind")) +
                                    "\n          ",
                                ),
                              ],
                            ),
                  ...
                  e(
                    ...
                    {
                      staticClass:
                        "uk-panel uk-height-expand error-details-toggle-group",
                      attrs: { hidden: !0 },
                    },
                    [
                      e(
                        "pre",
                        {
                          staticClass: "uk-panel-scrollable uk-height-1-1",
                          staticStyle: { "user-select": "text" },
                        },
                        [t._v(t._s(t.errorDetails))],
                      ),
                    ],
                  ),
                ],
              ...
              e("div", { staticClass: "uk-window-button-bar" }, [
                ...
                e(
                  ...
                  {
                    staticClass:
                      "uk-button uk-button-default error-details-toggle-group",
                    attrs: {
                      type: "button",
                      "uk-toggle": "target: .error-details-toggle-group",
                      autofocus: "",
                    },
                    on: { click: t.expandDialog },
                  },
                  [t._v("\n      " + t._s(t.$T("Error Code")) + "\n    ")],
                ),
                t._v(" "),
    ...
    77760: (t) => {
      ...
      function jt(t) {
        return Tt(t, !0), z(t, "__v_isShallow", !0), t;
      }
      function Tt(t, e) {
        St(t) || Et(t, e, tt());
      }
      ...
      function Rn(t, s, a, c, A) {
        ...
        if (o(t.options.functional))
          return (function (t, i, o, s, a) {
            ...
            if (f instanceof at) return On(f, o, u.parent, l);
            if (n(f)) {
              const t = qt(f) || [],
                e = new Array(t.length);
              for (let n = 0; n < t.length; n++)
                e[n] = On(t[n], o, u.parent, l);
              return e;
            }
          })(t, p, s, a, c);
        const h = s.on;
      ...
      xr &&
        ...
        void 0 === window.onanimationend &&
          ...
          ((kr = "WebkitAnimation"), (Or = "webkitAnimationEnd")));
      const Sr = V
      ...
      function Gr(t, e) {
        ...
        const x = _ && d ? d : A,
          ...
          F = (n._enterCb = D(() => {
            R && (Qr(n, T), Qr(n, j)),
              F.cancelled ? (R && Qr(n, x), L && L(n)) : S && S(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
          ...
          R &&
            ...
            Dr(() => {
              Qr(n, x),
                F.cancelled ||
                  (Lr(n, T), Y || (Pr(Q) ? setTimeout(F, Q) : Rr(n, c, F)));
            })),
          t.data.show && (e && e(), O && O(n, F)),
          R || Y || F();
      }
      function Vr(t, e) {
        const n = t.elm;
      ...
      function y(t, n, r = {}, s, l, c) {
        ...
        for (const e in k) {
          ...
          if (
            ...
            c ||
              (!E ||
                ((O = n), i.isVue2 ? h.has(O) : a(O) && O.hasOwnProperty(p)) ||
