/*! For license information please see dialog-rate.js.LICENSE.txt */
    ...
    20820: (t, e, n) => {
      ...
      const l = {
        ...
        data() {
          return {
            illustrationImageURL: this.$toResourceURL(
              "static/assets/images/rate-dialog-illustration.png",
            ),
            illustrationHDImageURL: `${this.$toResourceURL("static/assets/images/rate-dialog-illustration.png")} 1x, ${this.$toResourceURL("static/assets/images/rate-dialog-illustration@2x.png")} 2x`,
            fiveStarURL: this.$toResourceURL(
              "static/assets/images/rate-dialog-five-star.svg",
            ),
          };
        },
        computed: {
          touchBarItems() {
            return [
              ...
              { type: "button", label: this.$T("Feedback"), click: "feedback" },
              { type: "space", size: "flexible" },
            ].filter(Boolean);
          },
        },
        methods: {
          async feedback() {
            (0, a.Rg)().disableRate(),
              await o.ZP.fetch(r.Fx, { name: "feedback" }),
              setTimeout(() => {
                window.close();
              }, 0);
          },
          async rateUs() {
            ...
            const t = (0, a.JE)().T;
            (0, s.DL)(
              "macappstore://itunes.apple.com/app/id1327661892?action=write-review",
              t,
            ),
              setTimeout(() => {
                window.close();
          ...
          return e(
            ...
            [
              ...
              e("div", { staticClass: "uk-window-body uk-flex uk-flex-row" }, [
                e("img", {
                  staticClass: "uk-background-cover uk-height-1-1",
                  ...
                  [
                    e("div", { staticClass: "uk-height-expand" }, [
                      ...
                      e("h6", { staticClass: "uk-margin-small" }, [
                        t._v(
                          "\n          " +
                            t._s(
                              t.$T(
                                "Please share your love of Xmind by rating us 5 stars on Mac App Store, or send feedback to us for making it better.",
                              ),
                            ) +
                            "\n        ",
                        ),
                      ...
                      e(
                        ...
                        {
                          staticClass:
                            "uk-margin uk-button-group uk-flex-row-reverse",
                        },
                        [
                          e(
                            "button",
