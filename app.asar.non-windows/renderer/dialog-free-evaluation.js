/*! For license information please see dialog-free-evaluation.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [2439],
  {
    ...
    8077: (t, e, n) => {
      ...
      const p = (0, A.R)(window.location.search),
        h = (0, r.aZ)({
          name: "DialogFreeEvaluation",
          setup() {
            const t = (t) => {
                const e = t || (0, f.S)().language,
                  n = (0, f.Yh)().openTrialTime;
                return ((t, ...e) => (0, f.JE)().T(t, ...e))(
                  "Free evaluation will be end on $1.",
                  new Date(n.openTrialEndTime).toLocaleDateString(e),
                );
              },
              e = (0, r.iH)(t()),
              n = (0, r.Fl)(() => Boolean((0, f.c7)().user)),
              i = (0, r.Fl)(() =>
                (0, u.Al)(
                  "static/assets/images/dialog-evaluation/free-evaluation.png",
                ),
              ),
              A = (0, r.Fl)(
                () =>
                  `${(0, u.Al)("static/assets/images/dialog-evaluation/free-evaluation.png")} 1x, ${(0, u.Al)("static/assets/images/dialog-evaluation/free-evaluation@2x.png")} 2x`,
              ),
              h = () => {
                window.close();
              };
            return (
              (0, r.bv)(() =>
                d(this, void 0, void 0, function* () {
                  if (n.value) {
                    ...
                    (0, f.c7)().updateAccount({ rawSubscriptionData: t });
                  }
                  (0, c.L9)({ eventAction: "showFreeTrial" });
                }),
              ),
              (0, r.YP)(
                () => (0, f.S)().language,
              ...
              ),
              {
                ...
                openTrialEndTimeStr: e,
                freeEvaluationURL: i,
                freeEvaluationHDURL: A,
                clickLimitedTrialFeature: () => {
                  (0, c.L9)({ eventAction: "clickFreeTrial" });
                  return "" === (0, f.c7)().user && "" === (0, f.c7)().token
                    ? l.ZP.fetch(a.Fx, {
                        name: "dialog-signin",
                        query: { innerFeatureName: p.innerFeatureName },
                      })
                    : ((t = { prompt: !0 }),
                ...
                cancel: h,
                purchaseNow: () => {
                  (0, c.L9)({ eventAction: "clickPurchaseInFreeTrial" }),
                    l.ZP.fetch(a.Fx, {
            ...
            [
              ...
              e("div", { staticClass: "uk-flex uk-flex-column" }, [
                ...
                e(
                  ...
                  [
                    e("div", {
                      ...
                      attrs: {
                        "data-src": t.freeEvaluationURL,
                        "data-srcset": t.freeEvaluationHDURL,
                        "uk-img": "",
                      },
                    }),
                  ],
                ...
                e(
                  ...
                  {
                    staticClass:
                      "uk-padding-large uk-flex uk-flex-column uk-flex-between",
                    staticStyle: {
                      height: "281px",
                    ...
                    e("div", [
                      e(
                        ...
                        [
                          t._v(
                            "\n          " +
                              t._s(t.$T("Free Evaluation")) +
                              "\n        ",
                          ),
                        ],
                      ),
                      t._v(" "),
                      e("div", { staticStyle: { "margin-bottom": "8px" } }, [
                        t._v(
                          "\n          " +
                            t._s(
                              t.$T(
                      ...
                      e("div", [
                        t._v(
                          "\n          " +
                            t._s(
                              t.$T(
                                "This feature is originally inactive and now open for free evaluation in a limited time.",
                              ),
                            ) +
                            "\n        ",
                        ),
                        ...
                        [
                          ...
                          e(
                            "button",
                            {
                              ...
                              on: {
                                click: function (e) {
                                  return t.clickLimitedTrialFeature();
                                },
                              },
                            },
                            [
      ...
      (0, i.Z)(g, { name: "dialog-free-evaluation" });
    },
    4075: (t, e, n) => {
      "use strict";
      n.d(e, { R: () => r });
