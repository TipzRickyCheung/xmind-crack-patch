/*! For license information please see 2768.js.LICENSE.txt */
  ...
  [2768],
  {
    ...
    26601: (t, e, n) => {
      ...
      function u(t) {
        var e,
          n,
          i = t.sizes.shift(),
          r = Math.max(Math.ceil(i[0]), 1),
          o = Math.max(Math.ceil(i[1]), 1),
          s = [r - 1, o - 1, 1, 1],
          a = Date.now(),
          l =
        ...
        l
          ? ((e = new OffscreenCanvas(1, 1)), (n = new OffscreenCanvas(r, o)))
        ...
        var c = e.getContext("2d"),
          A = n.getContext("2d");
        A &&
          (A.fillRect.apply(A, s),
          c.drawImage(n, r - 1, o - 1, 1, 1, 0, 0, 1, 1));
        var f = c && 0 !== c.getImageData(0, 0, 1, 1).data[3],
          d = Date.now() - a;
        return (
          ...
          l
            ? (postMessage({
              ...
              !f && t.sizes.length && u(t))
            : f
              ? t.onSuccess(r, o, d)
              : (t.onError(r, o, d), t.sizes.length && u(t)),
          f
        );
      }
      n.d(e, { Z: () => w });
      var f = [16384, 14188, 11402, 11180, 10836, 8192, 4096, 1],
        d = [8388607, 65535, 32767, 16384, 8192, 4096, 1],
        p = [4194303, 65535, 32767, 16384, 8192, 4096, 1],
        h = ["onError", "onSuccess"],
        g = {
          max: null,
          min: 1,
      ...
      function v(t) {
        ...
        if (t.useWorker && n) {
          var f = "\n            var canvasTest = ".concat(
            ...
            d = new Blob([f], { type: "application/javascript" }),
          ...
          (A = new Worker(p)),
            ...
            (A.onmessage = function (t) {
              var e = t.data,
                ...
                o = e.benchmark;
              e.isTestPass
                ? (y[i].onSuccess(n, r, o), delete y[i])
                : y[i].onError(n, r, o);
            });
        }
        return t.usePromise
          ? new Promise(function (e, n) {
              var s = r(
                ...
                {},
                {
                  onError: function (e, i, r) {
                    var s;
                    if (0 === t.sizes.length) s = !0;
                    else {
                      var l = a(t.sizes.slice(-1), 1),
                        c = a(l[0], 2),
                        A = c[0],
                        u = c[1];
                      s = e === A && i === u;
                    }
                    o(e, i, r), s && n({ width: e, height: i, benchmark: r });
                  },
                  onSuccess: function (t, n, i) {
                    l(t, n, i), e({ width: t, height: n, benchmark: i });
                  },
                },
              );
              if (A) {
                var f = s.onError,
                  d = s.onSuccess;
                (y[i] = { onError: f, onSuccess: d }), A.postMessage(c);
              } else u(s);
            })
          : A
            ? ((y[i] = { onError: o, onSuccess: l }), void A.postMessage(c))
            : u(t);
      }
      var w = {
        maxArea: function () {
        ...
        test: function () {
          ...
          return (
            (e.sizes = l(e.sizes)),
            e.width && e.height && (e.sizes = [[e.width, e.height]]),
            v(e)
          );
        },
      };
    ...
    41809: (t, e) => {
      ...
      function n(t) {
        ...
        for (var n = 0; n < t.length; n++) e = i[255 & (e ^ t[n])] ^ (e >>> 8);
        return -1 ^ e;
      }
      (e.E4 = function (t, e) {
        var n = t.slice(0, 33);
        return new Promise(function (i, r) {
          ...
          (o.onload = function () {
            var n = new Uint8Array(o.result),
              r = t.slice(33),
              s = d(n, e, t.type);
            i(new Blob([s, r], { type: t.type }));
          }),
        ...
        (e.Hv = function (t, e) {
          ...
          if (-1 !== i.indexOf(r)) {
            ...
            p >= 0 ? ((u = 4 * Math.ceil((p + 28) / 3)), (f = !0)) : (u = 44);
          }
          -1 !== i.indexOf(o) && ((A = o), (u = 24));
          for (
            var h = c.substring(0, u),
              g = c.substring(u),
              y = atob(h),
              m = new Uint8Array(y.length),
              v = 0;
            v < m.length;
            v++
          )
      ...
      function d(t, e, i, s) {
        ...
        if (i === r) {
          ...
          if (
            ...
            return t.set(a, p), t.set(d, p + 13), t;
          }
          var h = new Uint8Array(4);
          (h[0] = 0), (h[1] = 0), (h[2] = 0), (h[3] = 9);
          var g = new Uint8Array(54);
          return g.set(t, 0), g.set(h, 33), g.set(a, 37), g.set(d, 50), g;
        }
      }
    },
    ...
    77760: (t) => {
      ...
      xr &&
        ...
        void 0 === window.onanimationend &&
          ...
          ((Sr = "WebkitAnimation"), (Or = "webkitAnimationEnd")));
      const Dr = V
