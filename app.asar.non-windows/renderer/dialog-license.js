/*! For license information please see dialog-license.js.LICENSE.txt */
  ...
  [6103],
  {
    ...
    1687: (t, e, n) => {
      ...
      I("REMOTE_RENDERER_CALLBACK", (t, e) => {
        ...
        (e.require = (t) =>
          w(s.ipcRenderer.sendSync("REMOTE_BROWSER_REQUIRE", p, t, E()))),
        (e.getBuiltin = function (t) {
          return w(
            s.ipcRenderer.sendSync("REMOTE_BROWSER_GET_BUILTIN", p, t, E()),
          );
        }),
        (e.getCurrentWindow = function () {
          return w(
            s.ipcRenderer.sendSync("REMOTE_BROWSER_GET_CURRENT_WINDOW", p, E()),
          );
        }),
        ...
        (e.getGlobal = function (t) {
          return w(
            s.ipcRenderer.sendSync("REMOTE_BROWSER_GET_GLOBAL", p, t, E()),
          );
        }),
          ...
          var l = (o.MD5 = s.extend({
            ...
            _doProcessBlock: function (t, e) {
              ...
              (C = c(C, _, x, j, o, 7, a[0])),
                ...
                (j = c(j, C, _, x, E, 12, a[13])),
                (x = c(x, j, C, _, b, 17, a[14])),
                (C = A(
                  C,
                ...
                (C = u(C, _, x, j, E, 4, a[40])),
                (j = u(j, C, _, x, o, 11, a[41])),
    ...
    11632: (t, e, n) => {
      ...
      var i = n(77412),
        ...
        a = n(90435),
        l = n(50965);
      const c = [r.Zr.E_KEY_BIND_TO_ANOTHER_MACHINE, r.Zr.E_KEY_NOT_EXIST],
        A = {
          data: () => ({
            licenseKey: "",
            email: "",
            validity: r.lX.VALID,
            serverStatus: r.Zr.VALID,
            activating: !1,
          }),
          computed: {
            ...(0, i.rn)(l.Yh, {
              validatePerMachineLicenseKey: (t) =>
                t.validatePerMachineLicenseKey,
              parsePerMachineLicenseData: (t) => t.parsePerMachineLicenseData,
              validatePerMachineLicenseData: (t) =>
                t.validatePerMachineLicenseData,
            }),
            canActivate() {
              return this.licenseKey && this.email && !this.activating;
            },
            errMsg() {
              if (this.validity !== r.lX.VALID) {
                switch (this.validity) {
                  case r.lX.E_KEY_INVALID:
                    return this.$T(
                      "Invalid license. Please enter a correct email and key.",
                    );
                  case r.lX.E_OUTDATED:
                    return this.$T("Please enter a valid license key.");
                  case r.lX.E_MAJOR_VERSION_UNMATCHED:
                    return this.$T(
                      "This license key cannot be used in this version of Xmind.",
                    );
                  case r.lX.E_MACHINE_ID_UNMATCHED:
                    return this.$T(
              ...
              if (this.serverStatus !== r.Zr.VALID) {
                switch (this.serverStatus) {
                  case r.Zr.E_KEY_BIND_TO_ANOTHER_MACHINE:
                    return this.$T(
                      "This license key is already bound with another device.",
                    );
                  case r.Zr.E_KEY_NOT_EXIST:
                    return this.$T(
                      "Activation failed, please check your Email and license key.",
                    );
                  case r.Zr.E_PARAM_MISSING:
                    return this.$T(
                      "Unexpected error occurred during activating license.",
                    );
                  case r.Zr.E_SERVER_ERR:
                    return this.$T(
          ...
          methods: {
            ...
            async activate() {
              if (this.canActivate) {
                this.activating = !0;
                try {
                  (this.validity = r.lX.VALID),
                    (this.serverStatus = r.Zr.VALID);
                  const t = (0, s.Nc)(this.licenseKey),
                    e = this.email.trim();
                  let n;
                  try {
                    n = await a.ZP.fetch(o.lf.SME_LICENSE_ACTIVATE, {
                      key: t,
                      email: e,
                    });
                  } catch (i) {
                    if (c.includes(i.code))
                      return void (this.serverStatus = i.code);
                    n = { key: t, email: e };
                  }
                  try {
                    let t = this.parsePerMachineLicenseData(n);
                    this.validity = this.validatePerMachineLicenseData(t);
                  } catch (t) {
                    this.validity = r.lX.E_KEY_INVALID;
                  }
                  if (this.validity !== r.lX.VALID) return;
                  await Promise.all([
                    a.ZP.fetch(o.Pp, {
                      mutations: [
                        {
                          ...
                          payload: [{ rawData: { ...n, email: e } }],
                        },
                      ],
                    }),
                    a.ZP.fetch((0, o.iM)(window.id), { success: !0 }),
                  ]),
                    setTimeout(() => window.close(), 0),
                    await a.ZP.fetch(o.Fx, { name: "dialog-congratulate" });
                } finally {
                  this.activating = !1;
                }
              }
        ...
        data() {
          return {
            illustrationImageURL: this.$toResourceURL(
              "static/assets/images/license-dialog-illustration.png",
            ),
            illustrationHDImageURL: `${this.$toResourceURL("static/assets/images/license-dialog-illustration.png")} 1x, ${this.$toResourceURL("static/assets/images/license-dialog-illustration@2x.png")} 2x`,
          };
        },
        computed: {
        ...
        function () {
          ...
          return e(
            ...
            [
              ...
              e(
                "div",
                { staticClass: "uk-window-body uk-flex uk-child-width-expand" },
                [
                  e("article", { staticClass: "uk-flex uk-height-1-1" }, [
                    e(
                      "div",
                      { staticClass: "uk-height-1-1 uk-flex-no-shrink" },
                      [
                        e("img", {
                          staticClass: "uk-height-1-1",
                          attrs: {
                            draggable: "false",
                            src: t.illustrationImageURL,
                            srcset: t.illustrationHDImageURL,
                          },
                        }),
                      ],
                    ),
                    ...
                    e(
                      ...
                      [
                        e(
                          ...
                          [
                            e("h1", { staticClass: "uk-margin-bottom" }, [
                              t._v(
                                "\n            " +
                                  t._s(t.$T("Enter License")) +
                                  "\n          ",
                              ),
                            ]),
                            t._v(" "),
                            ...
                            e(
                              "form",
                              {
                                ...
                                attrs: { id: "per_machine_license_form" },
                                on: {
                                  submit: function (e) {
                                    return (
                                      e.preventDefault(),
                                      t.submitForm.apply(null, arguments)
                                    );
                                  },
                                },
                              },
                              [
                                ...
                                e(
                                  ...
                                  {
                                    staticClass:
                                      "uk-margin uk-margin-remove-bottom",
                                  },
                                  [
                                    e(
                                      "label",
                                    ...
                                    e(
                                      ...
                                      [
                                        e("textarea", {
                                          ...
                                          domProps: { value: t.licenseKey },
                                          on: {
                                            input: function (e) {
                                              e.target.composing ||
                                                (t.licenseKey = e.target.value);
                                            },
                                          },
                                        }),
                                      ],
    ...
    77760: (t) => {
      ...
      function bt(t, e, i) {
        return t && v(t, "__ob__") && t.__ob__ instanceof Et
          ? t.__ob__
          : !Mt ||
              (!i && tt()) ||
              (!n(t) && !A(t)) ||
        ...
        return (
          (y.run = () => {
            if (y.active)
              if (i) {
                const t = y.get();
                (s || p || (h ? t.some((t, e) => O(t, m[e])) : O(t, m))) &&
                  (d && d(),
        ...
        return {
          get attrs() {
            if (!t._attrsProxy) {
              ...
              U(n, "_v_attr_proxy", !0), Ee(n, t.$attrs, e, t, "$attrs");
            }
      ...
      function Ee(t, e, n, i, r) {
        let s = !1;
        for (const o in e)
          o in t ? e[o] !== n[o] && (s = !0) : ((s = !0), be(t, o, i, r));
      ...
      function ke(t, e, n) {
        if (
          ...
          for (let o = 0, a = t.children.length; o < a; o++) {
            ...
            r(a.tag) && (i(a.ns) || (s(n) && "svg" !== a.tag)) && ke(a, e, n);
          }
      }
      function De(t, e, n) {
        ht();
        ...
        try {
          (s = n ? t.apply(e, n) : t.call(e)),
            s &&
              ...
              f(s) &&
              !s._handled &&
              (s.catch((t) => De(t, i, r + " (Promise/async)")),
              (s._handled = !0));
        } catch (t) {
          De(t, i, r);
        }
      ...
      var nn = Object.freeze({
        ...
        computed: function (t, e) {
          ...
          const s = tt() ? null : new cn(st, n, j, { lazy: !0 }),
            o = {
              effect: s,
              get value() {
                return s
      ...
      function kn(t, i, r, o, a) {
        ...
        (this.data = t),
          ...
          (this.injections = Tn(l.inject, o)),
          (this.slots = () => (
            this.$slots || we(o, t.scopedSlots, (this.$slots = ye(r, o))),
            this.$slots
          )),
      ...
      const On = {
          ...
          prepatch(t, n) {
            ...
            !(function (t, n, i, r, s) {
              ...
              c && ((t.$slots = ye(s, r.context)), t.$forceUpdate());
            })(
      ...
      function Rn(t, o, a, c, A) {
        ...
        if (s(t.options.functional))
          return (function (t, i, s, o, a) {
            ...
            else r(s.attrs) && Sn(c, s.attrs), r(s.props) && Sn(c, s.props);
            const u = new kn(s, c, a, o, t),
              f = l.render.call(null, u._c, u);
            if (f instanceof at) return Dn(f, s, u.parent, l);
            if (n(f)) {
              const t = qt(f) || [],
                e = new Array(t.length);
              for (let n = 0; n < t.length; n++)
                e[n] = Dn(t[n], s, u.parent, l);
              return e;
            }
          })(t, p, o, a, c);
        const h = o.on;
        ...
        e.computed &&
          (function (t, e) {
            ...
            for (const r in e) {
              const s = e[r],
                o = a(s) ? s : s.get;
              i || (n[r] = new cn(t, o || j, j, ii)), r in t || ri(t, r, s);
            }
          })(t, e.computed),
          e.watch &&
            e.watch !== Z &&
      ...
      function ri(t, e, n) {
        const i = !tt();
        a(n)
          ? ((ti.get = i ? si(e) : oi(n)), (ti.set = j))
          : ((ti.get = n.get ? (i && !1 !== n.cache ? si(e) : oi(n.get)) : j),
            (ti.set = n.set || j)),
          ...
          (t.prototype.$on = function (t, i) {
            ...
            (t.prototype.$emit = function (t) {
              ...
              if (n) {
                ...
                for (let t = 0, s = n.length; t < s; t++) Se(n[t], e, i, e, r);
              }
              return e;
            });
        })(Ai),
          ...
          ge(t.prototype),
            ...
            (t.prototype._render = function () {
              ...
              i &&
                ...
                (t.$vnode = i);
              try {
                ot(t), (_e = t), (r = e.call(t._renderProxy, t.$createElement));
              } catch (e) {
      ...
      function Qi(t, e) {
        ...
        const s = t.context,
          ...
          l = e ? null : o,
          c = e ? void 0 : o;
        if (a(i)) return void Se(i, s, [l], s, "template ref function");
      ...
      function Ri({ _setupState: t }, e, n) {
        t && v(t, e) && (Lt(t[e]) ? (t[e].value = n) : (t[e] = n));
      }
      const Yi = new at("", {}, []),
      ...
      const gr = /^--/,
        ...
        mr = (t, e, n) => {
          if (gr.test(e)) t.style.setProperty(e, n);
            ...
            t.style.setProperty(b(e), n.replace(yr, ""), "important");
          else {
            const i = Mr(e);
            if (Array.isArray(n))
      ...
      function Gr(t, e) {
        ...
        const x = _ && d ? d : A,
          ...
          z = (n._enterCb = L(() => {
            R && (Qr(n, T), Qr(n, j)),
              z.cancelled ? (R && Qr(n, x), O && O(n)) : S && S(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
          ...
          R &&
            ...
            Lr(() => {
              Qr(n, x),
                z.cancelled ||
                  (Or(n, T), Y || ($r(Q) ? setTimeout(z, Q) : Rr(n, c, z)));
            })),
          ...
          I.cancelled ||
            ...
            v &&
              ...
              Lr(() => {
                Qr(n, c),
                  I.cancelled ||
                    (Or(n, A), w || ($r(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
      ...
      const Jr = (function (t) {
                  ...
                  for (; d <= h && p <= m; )
                    i(g)
                      ...
                      : i(y)
                        ? (y = e[--h])
                        : Ui(g, v)
                          ? (b(g, v, s, n, p), (g = e[++d]), (v = n[++p]))
                          : Ui(y, M)
                            ? (b(y, M, s, n, m), (y = e[--h]), (M = n[--m]))
                            : Ui(g, M)
                              ? (b(g, M, s, n, m),
                                B &&
                                  A.insertBefore(
        ...
        return function (t, e, n, o) {
          ...
          if (i(t)) (a = !0), f(e, c);
            ...
            if (!i && Ui(t, e)) b(t, e, c, null, null, o);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
      ...
      function Zr(t, e, n) {
        ...
        for (let e = 0, n = t.options.length; e < n; e++)
          if (((o = t.options[e]), r))
            (s = S(i, qr(o)) > -1), o.selected !== s && (o.selected = s);
          else if (D(qr(o), i))
      ...
      function as(t) {
        ...
        return e && e.Ctor.options.abstract ? as(je(e.children)) : t;
      }
      function ls(t) {
        const e = {},
          n = t.$options;
      ...
      const ds = _({ tag: String, moveClass: String }, os);
      delete ds.mode;
      var ps = {
        props: ds,
        beforeMount() {
      ...
      (Ai.config.mustUseProp = (t, e, n) =>
        ...
        _(Ai.options.directives, ss),
        _(Ai.options.components, ms),
    ...
    77412: (t, e, n) => {
      ...
      function y(t, n, r = {}, o, l, c) {
        ...
        const j = {
          ...
          $dispose: function () {
            y.stop(), (B = []), (E = []), o._s.delete(t);
          },
        };
        i.isVue2 && (j._r = !1);
        const T = i.reactive(j);
        o._s.set(t, T);
        const k = o._e.run(() => ((y = i.effectScope()), y.run(() => n())));
        for (const e in k) {
          const n = k[e];
          if (
        ...
        return (
          ...
          o._p.forEach((t) => {
            g(
              T,
              y.run(() => t({ store: T, app: o._a, pinia: o, options: m })),
            );
          }),
          b && c && r.hydrate && r.hydrate(T.$state, b),
          (w = !0),
          (M = !0),
          T
        );
