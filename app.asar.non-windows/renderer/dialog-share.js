/*! For license information please see dialog-share.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [1011],
  {
    ...
    6568: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".uk-form-label[data-v-bc2fbe76] {\n  min-width: 50px;\n  text-align: right;\n  margin-right: 8px;\n  height: 25px;\n  display: block;\n  line-height: 24px;\n  white-space: nowrap;\n}\n.error-text[data-v-bc2fbe76] {\n  font-size: 11px;\n  margin-top: 11px;\n}\n",
        "",
      ]);
      const o = r;
    },
        ...
        methods: {
          updateTouchBarItems(t) {
            const e = (t) => {
              ...
              return (
                n ||
                  ((n = {
                    method: e,
                    endpoint: (0, r.A6)(window.id, (0, o.rs)(e)),
                  }),
            ...
            (t = (t || this.touchBarItems || []).map(
              ...
              (0, s.JS)("window")?.().updateTouchBarItems(t);
          },
        },
        beforeCreate() {
    ...
    77319: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        l = n(54856),
        c = n(40334);
      const A = o().parse(location.search.substr(1)),
        u = {
          mixins: [c.Z],
          data: () => ({
            errorText: "",
            mapNameModel: A.mapName,
            descriptionModel: "",
          ...
          computed: {
            uploadTypes() {
              return [
                { key: "CURRENT_SHEET", value: this.$T("Current Sheet") },
                { key: "WHOLE_WORKBOOK", value: this.$T("Current File") },
              ];
            },
            touchBarItems() {
              return [
            ...
            heading() {
              return {
                blog: this.$T("Share to Blog"),
                facebook: this.$T("Share to Facebook"),
                twitter: this.$T("Share to X"),
                pinterest: this.$T("Share to Pinterest"),
                linkedin: this.$T("Share to LinkedIn"),
                biggerplate: this.$T("Share Map on Biggerplate"),
                "xmind share": this.$T("Xmind Share"),
              }[A.type];
            },
            tip() {
              return {
                biggerplate: this.$T(
                  "This map will be uploaded to Xmind.app to post on Biggerplate.",
                ),
                blog: this.$T(
                  "This map will be uploaded to Xmind.app to post on your blog.",
                ),
                facebook: this.$T(
                  "This map will be uploaded to Xmind.app to post on Facebook.",
                ),
                twitter: this.$T(
                  "This map will be uploaded to Xmind.app to post on X.",
                ),
                pinterest: this.$T(
                  "This map will be uploaded to Xmind.app to post on Pinterest.",
                ),
                linkedin: this.$T(
                  "This map will be uploaded to Xmind.app to post on Linkedin.",
                ),
                "xmind share": this.$T(
                  "This map will be uploaded to Xmind.app.",
                ),
              }[A.type];
            },
          },
          methods: {
            ...
            async upload() {
              (this.errorText = ""), (this.uploading = !0);
              const t = {
                  title: this.mapNameModel,
                  description: this.descriptionModel,
                  lang: "all",
                  preview: this.preview,
                  isPrivate: !this.shareToGallery,
                  uploadSheetTypes: this.uploadTypes[this.uploadIndexModel].key,
                },
                e = await s.ZP.fetch((0, l.dm)(A.editorId), t);
              (this.uploading = !1),
                e && e.code === a.W1
                  ? (await s.ZP.fetch(l.Pp, {
                      mutations: [{ id: "account", type: "clearAccount" }],
                    }),
                    await s.ZP.fetch(l.Fx, { name: "dialog-signin" }))
                  : e instanceof Error &&
                    (this.errorText = this.$T(
                      "Uploading to Xmind Share failed. Please check the network or re-login your Xmind ID.",
                    )),
                setTimeout(() => {
                  this.errorText || window.close();
                }, 0);
            },
            openXMindGallery() {
              s.ZP.fetch(l.lf.GO_LIBRARY_MORE_MAPS);
            },
          },
          components: {
      ...
      const f = (0, n(51900).Z)(
        ...
        function () {
          var t = this,
            e = t._self._c;
          return e("div", { staticClass: "uk-window uk-window-dialog" }, [
            e(
              "div",
              {
            ...
            e(
              ...
              {
                staticClass:
                  "uk-window-body uk-padding-large uk-overflow-hidden",
              ...
              [
                ...
                e(
                  ...
                  {
                    staticClass:
                      "uk-flex uk-flex-between uk-margin-remove-bottom",
                  },
                  [
                    e(
                      "figcaption",
                      {
                        staticClass:
                          "uk-flex-auto uk-flex-column uk-flex-between uk-flex",
                      },
                      [
                        e("div", { staticClass: "uk-flex uk-flex-left" }, [
                          e("div", { staticClass: "uk-form-controls" }, [
                            e(
                              "label",
                              { staticClass: "uk-form-label uk-flex-none" },
                            ...
                            e(
                              ...
                              {
                                staticClass:
                                  "uk-form-label uk-flex-none uk-margin-xsmall-top",
                              },
                              [t._v(t._s(t.$T("Option")) + ":")],
                            ),
                          ]),
                          t._v(" "),
                          e("div", { staticClass: "uk-form-controls" }, [
                            e(
                              ...
                              {
                                staticClass:
                                  "uk-button uk-button-popover-toggle uk-select-icon uk-text-left uk-margin-small-bottom",
                                style: { width: "176px" },
                              },
                              [
                                t._v(
                                  "\n              " +
                                    t._s(
                                      (t.uploadTypes[t.uploadIndexModel] || {})
                                        .value,
                                    ) +
                                    "\n            ",
                                ),
                            ...
                            e(
                              ...
                              [
                                e(
                                  ...
                                  t._l(t.uploadTypes, function (n, i) {
                                    return e("li", { key: i }, [
                                      e(
                                        "button",
                                        {
                                          class: {
                                            "uk-checked": t.uploadTypes === i,
                                          },
                                          on: {
                                            click: function (e) {
                                              t.uploadIndexModel = i;
                                            },
                                          },
                                        },
                                        [
                ...
                t._v(" "),
                e("div", { staticClass: "uk-text-danger error-text" }, [
                  t._v("\n      " + t._s(t.errorText) + "\n    "),
                ]),
              ],
            ),
                  ...
                  [
                    ...
                    e("span", { staticClass: "uk-text-middle" }, [
                      t._v(
                        "\n          " +
                          t._s(
                            "xmind share" === t.shareType
                              ? t.$T("Upload & Create Link")
                              : t.$T("Upload"),
                          ) +
                          "\n        ",
                      ),
    ...
    77760: (t) => {
        ...
        for (let a = 0; a < s.length; a++)
          (i = s[a]),
            "__ob__" !== i &&
              ((r = t[i]),
              (o = e[i]),
              n && v(t, i) ? r !== o && A(r) && A(o) && Fn(r, o) : Ct(t, i, o));
        return t;
      }
      function Gn(t, e, n) {
        return n
        ...
        if (
          ...
          (function (t) {
            ...
            if (n) {
              ...
              st(t), ht();
              const r = De(n, null, [t._props || Tt({}), i], t, "setup");
      ...
      function Gr(t, e) {
        ...
        const x = _ && d ? d : A,
          ...
          z = (n._enterCb = O(() => {
            R && (Qr(n, j), Qr(n, T)),
              z.cancelled ? (R && Qr(n, x), L && L(n)) : D && D(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
      ...
      const Jr = (function (t) {
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, c);
            ...
            if (!i && Ui(t, e)) E(t, e, c, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
