/*! For license information please see dialog-err.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [494],
  {
    ...
    55627: (t, e, n) => {
      ...
      var A = n(50965),
        u = n(77412);
      const f = r.Us["dialog-err"],
        d = {
          mixins: [a.Z],
          data: () => ({
            iconImageURL: (0, o.ju)("static/images/error-dialog-icon.svg"),
          }),
          mounted() {
            this.autoExpand && this.expandDialog();
          },
          computed: {
            ...(0, u.rn)(() => (0, A.JS)("dialog-err")(), {
              message: (t) => t.error.message,
              stack: (t) => t.error.stack,
              code: (t) => t.error.code,
              title: (t) => t.error.title,
              isCustomError: (t) => t.error.isCustomError,
              autoExpand: (t) => t.error.autoExpand,
              expansionHeight: (t) => t.error.expansionHeight,
            }),
            errorTitle() {
              return this.title ? this.title : (this.code, this.$T("Whoops!"));
            },
            errorDesc() {
              switch (this.code) {
                case l:
                  return this.$T(
                    "Maybe your machine could not be activated by entering license. Please send feedback to us.",
                  );
                case c:
                  return this.$T(
                    "There may be several reasons such as corrupted/encrypted files.",
                  );
                default:
                  return this.$T(
                    "Sorry, something went wrong. But don't worry, it's not your fault. Please send feedback to help us solve this problem.",
                  );
              }
            },
            errorDetails() {
              let t = (0, s.Yv)(),
                e = [t.platform, t.arch, t.release].join(",");
            ...
            touchBarItems() {
              return [
                ...
                {
                  type: "button",
                  label: this.isCustomError ? this.$T("OK") : this.$T("Cancel"),
                  click: "close",
                },
                !this.isCustomError && {
                  type: "button",
                  label: this.$T("Send to Xmind"),
          ...
          methods: {
            expandDialog() {
              const t =
                void 0 === this.expansionHeight ? 180 : this.expansionHeight;
              window.resizeTo(f.width, f.height + t);
            },
            shrinkDialog() {
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-window-body uk-padding uk-flex uk-flex-column uk-overflow-hidden",
                },
                [
                  e("div", { staticClass: "uk-flex uk-flex-top uk-margin" }, [
                    ...
                    e(
                      ...
                      [
                        e("h1", [t._v(t._s(t.errorTitle))]),
                        t._v(" "),
                        e("p", [t._v(t._s(t.errorDesc))]),
                      ],
                    ),
                  ]),
                  t._v(" "),
