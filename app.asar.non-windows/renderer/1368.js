...
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [1368],
  {
    ...
    77760: (t) => {
      ...
      function St(t) {
        return kt(t) ? St(t.__v_raw) : !(!t || !t.__ob__);
      }
      function Dt(t) {
      ...
      function Wt(t, e) {
        function i() {
          const t = i.fns;
          if (!n(t)) return ke(t, null, arguments, e, "v-on handler");
          {
            const n = t.slice();
            for (let t = 0; t < n.length; t++)
              ke(n[t], null, arguments, e, "v-on handler");
          }
        }
        return (i.fns = t), i;
      }
      ...
      function Rn(t, s, a, c, A) {
        ...
        if (o(t.options.functional))
          return (function (t, i, o, s, a) {
            ...
            else r(o.attrs) && kn(c, o.attrs), r(o.props) && kn(c, o.props);
        ...
        if (
          ...
          (function (t) {
            ...
            if (n) {
              ...
              st(t), ht();
              const r = ke(n, null, [t._props || jt({}), i], t, "setup");
          ...
          (t.prototype.$on = function (t, i) {
            ...
            (t.prototype.$emit = function (t) {
              ...
              if (n) {
                ...
                for (let t = 0, o = n.length; t < o; t++) ke(n[t], e, i, e, r);
              }
              return e;
            });
        })(Ai),
      ...
      const _i = {
        ...
        ki = h("text,number,password,search,email,tel,url");
      ...
      function Qi(t, e) {
        ...
        const o = t.context,
          ...
          l = e ? null : s,
          c = e ? void 0 : s;
        if (a(i)) return void ke(i, o, [l], o, "template ref function");
      ...
      _r &&
        ...
        void 0 === window.onanimationend &&
          ...
          ((Sr = "WebkitAnimation"), (Dr = "webkitAnimationEnd")));
      const kr = V
      ...
      function Gr(t, e) {
        ...
        const _ = x && d ? d : A,
          ...
          z = (n._enterCb = O(() => {
            R && (Qr(n, T), Qr(n, j)),
              z.cancelled ? (R && Qr(n, _), L && L(n)) : k && k(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
          ...
          R &&
            ...
            Or(() => {
              Qr(n, _),
                z.cancelled ||
                  (Lr(n, T), Y || (Pr(Q) ? setTimeout(z, Q) : Rr(n, c, z)));
            })),
          ...
          I.cancelled ||
            ...
            v &&
              ...
              Or(() => {
                Qr(n, c),
                  I.cancelled ||
                    (Lr(n, A), w || (Pr(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
      ...
      function Zr(t, e, n) {
        ...
        for (let e = 0, n = t.options.length; e < n; e++)
          if (((s = t.options[e]), r))
            (o = k(i, qr(s)) > -1), s.selected !== o && (s.selected = o);
          else if (D(qr(s), i))
    ...
    77412: (t, e, n) => {
      ...
      function y(t, n, r = {}, s, l, c) {
        ...
        for (const e in S) {
          const n = S[e];
          if (
            (i.isRef(n) && ((k = n), !i.isRef(k) || !k.effect)) ||
            i.isReactive(n)
          )
            c ||
              (!E ||
      ...
      !(function t(e, n, i, r) {
          ...
          I =
            ...
            "function" == typeof cancelAnimationFrame
              ? ((f = function (t) {
                  var e = Math.random();
                  return (
                    (h[e] = requestAnimationFrame(function n(i) {
                      g === i || g + p - 1 < i
                        ? ((g = i), delete h[e], t())
                    ...
                    (t.fire = function (n, i, r) {
                      ...
                      return (m = c(function (i) {
                        ...
                        t.addEventListener("message", s),
                          e(n, o),
                          (v[o] = s.bind(null, { data: { callback: o } }));
                      }));
                    }),
                    (t.reset = function () {
        ...
        function S(t, e) {
          ...
          if (
            ...
            var p = t.createPattern(M.transform(e.shape.bitmap), "no-repeat");
            p.setTransform(d),
              (t.globalAlpha = 1 - n),
              (t.fillStyle = p),
              t.fillRect(e.x - u / 2, e.y - f / 2, u, f),
              (t.globalAlpha = 1);
            ...
            t.ellipse
              ? t.ellipse(
                  e.x,
                  e.y,
                  Math.abs(o - i) * e.ovalScalar,
                  Math.abs(a - r) * e.ovalScalar,
                  (Math.PI / 10) * e.wobble,
                  0,
                  2 * Math.PI,
                )
        ...
        function D(t, n) {
          var s,
            ...
            l = !!E(n || {}, "resize"),
            A = !1,
            u = E(n, "disableForReducedMotion", Boolean),
            f = o && !!E(n || {}, "useWorker") ? b() : null,
            d = a ? j : T,
          ...
          function g(e, n, o) {
            for (
              var a,
                ...
                u,
                f,
                p = E(e, "particleCount", N),
                h = E(e, "angle", Number),
                g = E(e, "spread", Number),
                y = E(e, "startVelocity", Number),
                m = E(e, "decay", Number),
                v = E(e, "gravity", Number),
                w = E(e, "drift", Number),
                b = E(e, "colors", x),
                B = E(e, "ticks", Number),
                C = E(e, "shapes"),
                ...
                T = (function (t) {
                  ...
                  return (
                    (e.x = E(e, "x", Number)), (e.y = E(e, "y", Number)), e
                  );
                })(e),
                D = p,
                k = [],
              ...
              k.push(
                ...
                (l = void 0),
                (A = void 0),
                (l = a.angle * (Math.PI / 180)),
                (A = a.spread * (Math.PI / 180)),
                {
                  x: a.x,
                  y: a.y,
                  ...
                  velocity:
                    0.5 * a.startVelocity + Math.random() * a.startVelocity,
                  angle2D: -l + (0.5 * A - Math.random() * A),
          ...
          function y(n) {
            var i = u || E(n, "disableForReducedMotion", Boolean),
              r = E(n, "zIndex", Number);
            if (i && h)
              return c(function (t) {
                t();
            ...
            function m() {
              (s = null),
                l && ((A = !1), e.removeEventListener("resize", y)),
                a && t && (document.body.removeChild(t), (t = null), (p = !1));
            }
            return (
              f && !p && f.init(t),
              (p = !0),
              f && (t.__confetti_initialized = !0),
              l && !A && ((A = !0), e.addEventListener("resize", y, !1)),
              f ? f.fire(n, o, m) : g(n, o, m)
            );
          }
          return (
            (y.reset = function () {
        ...
        function k() {
          return w || (w = D(null, { useWorker: !0, resize: !0 })), w;
        }
        (n.exports = function () {
          ...
          (n.exports.shapeFromPath = function (t) {
            ...
            if (!n) {
              for (
                var o, a, l = 1e3, c = l, A = l, u = 0, f = 0, d = 0;
                d < l;
                d += 2
              )
                for (var p = 0; p < l; p += 2)
                  r.isPointInPath(i, d, p, "nonzero") &&
                    ((c = Math.min(c, d)),
                    (A = Math.min(A, p)),
                    (u = Math.max(u, d)),
                    (f = Math.max(f, p)));
              (o = u - c), (a = f - A);
              var h = Math.min(10 / o, 10 / a);
              n = [
                h,
                0,
                0,
            ...
            return { type: "path", path: e, matrix: n };
          }),
          (n.exports.shapeFromText = function (t) {
            ...
            (A += 4),
              (u += 4),
              ((l = (a = new OffscreenCanvas(A, u)).getContext("2d")).font = s),
              (l.fillStyle = i),
              l.fillText(e, f, d);
            var p = 1 / n;
            return {
