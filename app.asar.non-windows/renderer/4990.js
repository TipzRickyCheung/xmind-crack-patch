/*! For license information please see 4990.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [4990],
  {
    ...
    36625: (t, e) => {
      ...
      s[T] = "(?:~>?)";
      var S = a++;
      (s[S] = "(\\s*)" + s[T] + "\\s+"), (o[S] = new RegExp(s[S], "g"));
      var D = a++;
      s[D] = "^" + s[T] + s[N] + "$";
      var k = a++;
      s[k] = "^" + s[T] + s[C] + "$";
      ...
      s[O] = "(?:\\^)";
      var Q = a++;
      (s[Q] = "(\\s*)" + s[O] + "\\s+"), (o[Q] = new RegExp(s[Q], "g"));
      var L = a++;
      s[L] = "^" + s[O] + s[N] + "$";
      var R = a++;
      s[R] = "^" + s[O] + s[C] + "$";
      ...
      function P(t, e) {
        ...
        if (!(e.loose ? o[I] : o[v]).test(t)) return null;
        try {
          return new H(t, e);
        } catch (t) {
          return null;
      ...
      function H(t, e) {
        ...
        var s = t.trim().match(e.loose ? o[I] : o[v]);
        ...
        s[4]
          ? (this.prerelease = s[4].split(".").map(function (t) {
              if (/^[0-9]+$/.test(t)) {
                var e = +t;
                if (e >= 0 && e < r) return e;
              }
      ...
      (e.parse = P),
        ...
        (H.prototype.compareMain = function (t) {
          return (
            t instanceof H || (t = new H(t, this.options)),
            W(this.major, t.major) ||
              W(this.minor, t.minor) ||
              W(this.patch, t.patch)
          );
        }),
        (H.prototype.comparePre = function (t) {
          if (
            (t instanceof H || (t = new H(t, this.options)),
          ...
          var e = 0;
          do {
            var i = this.prerelease[e],
              r = t.prerelease[e];
            if (
              (n("prerelease compare", e, i, r), void 0 === i && void 0 === r)
            )
              return 0;
        ...
        (e.inc = function (t, e, n, i) {
          "string" == typeof n && ((i = n), (n = void 0));
          try {
            return new H(t, n).inc(e, i).version;
          } catch (t) {
            return null;
          }
        }),
        (e.diff = function (t, e) {
          if (q(t, e)) return null;
          var n = P(t),
            i = P(e),
            r = "";
      ...
      function W(t, e) {
        ...
        return (
          n && i && ((t = +t), (e = +e)),
          t === e ? 0 : n && !i ? -1 : i && !n ? 1 : t < e ? -1 : 1
        );
      }
      function K(t, e, n) {
        return new H(t, n).compare(new H(e, n));
      }
      function Z(t, e, n) {
        return K(t, e, n) > 0;
      }
      ...
      (e.rcompareIdentifiers = function (t, e) {
        ...
        (e.major = function (t, e) {
          return new H(t, e).major;
        }),
        (e.minor = function (t, e) {
          return new H(t, e).minor;
        }),
        (e.patch = function (t, e) {
          return new H(t, e).patch;
        }),
        (e.compare = K),
        ...
        (e.sort = function (t, n) {
          return t.sort(function (t, i) {
            return e.compare(t, i, n);
          });
        }),
        (e.rsort = function (t, n) {
          return t.sort(function (t, i) {
            return e.rcompare(t, i, n);
          });
        }),
        (e.gt = Z),
        (e.lt = X),
      ...
      function st(t, e) {
        if (
          ...
          return t.loose === !!e.loose &&
            ...
            ? t
            : new st(t.raw, e);
        if (t instanceof rt) return new st(t.value, e);
      ...
      function lt(t, e, n, i, r, o, s, a, l, c, A, u, f) {
        return (
          (e = at(n)
            ? ""
            : at(i)
      ...
      function ct(t, e, i) {
        ...
        if (e.prerelease.length && !i.includePrerelease) {
          for (r = 0; r < t.length; r++)
            if (
              (n(t[r].semver),
              t[r].semver !== ot && t[r].semver.prerelease.length > 0)
            ) {
              var o = t[r].semver;
              if (
                o.major === e.major &&
      ...
      function ut(t, e, n, i) {
        var r, o, s, a, l;
        switch (((t = new H(t, i)), (e = new st(e, i)), n)) {
          case ">":
            (r = Z), (o = nt), (s = X), (a = ">"), (l = ">=");
            break;
          case "<":
        ...
        for (var c = 0; c < e.set.length; ++c) {
          ...
          if (
            (A.forEach(function (t) {
              t.semver === ot && (t = new rt(">=0.0.0")),
                (u = u || t),
                (f = f || t),
                r(t.semver, u.semver, i)
                  ? (u = t)
                  : s(t.semver, f.semver, i) && (f = t);
            }),
            u.operator === a || u.operator === l)
          )
            return !1;
          if ((!f.operator || f.operator === a) && o(t, f.semver)) return !1;
          if (f.operator === l && s(t, f.semver)) return !1;
        }
        return !0;
      }
      (rt.prototype.parse = function (t) {
        var e = this.options.loose ? o[Y] : o[z],
          n = t.match(e);
        ...
        (rt.prototype.test = function (t) {
          return (
            n("Comparator.test", t, this.options.loose),
            this.semver === ot ||
              ("string" == typeof t && (t = new H(t, this.options)),
              it(t, this.operator, this.semver, this.options))
          );
        }),
        (rt.prototype.intersects = function (t, e) {
          if (!(t instanceof rt))
          ...
          if (
            ...
            return (n = new st(t.value, e)), At(this.value, n, e);
          if ("" === t.operator)
            return (n = new st(this.value, e)), At(t.semver, n, e);
          var i = !(
              (">=" !== this.operator && ">" !== this.operator) ||
        ...
        (st.prototype.parseRange = function (t) {
          ...
          (t = t.replace(i, lt)),
            n("hyphen replace", t),
            (t = t.replace(o[U], "$1$2$3")),
            n("comparator trim", t, o[U]),
            (t = (t = (t = t.replace(o[S], "$1~")).replace(o[Q], "$1^"))
              .split(/\s+/)
              .join(" "));
          var r = e ? o[Y] : o[z],
            s = t
              ...
              .map(function (t) {
                return (function (t, e) {
                  return (
                    ...
                    (t = (function (t, e) {
                      return t
                        ...
                        .map(function (t) {
                          return (function (t, e) {
                            n("caret", t, e);
                            var i = e.loose ? o[R] : o[L];
                            return t.replace(i, function (e, i, r, o, s) {
                              var a;
                              return (
                                n("caret", t, e, i, r, o, s),
                                at(i)
                      ...
                      return (
                        ...
                        t
                          ...
                          .map(function (t) {
                            return (function (t, e) {
                              t = t.trim();
                              var i = e.loose ? o[x] : o[_];
                              return t.replace(i, function (e, i, r, o, s, a) {
                                n("xRange", t, e, i, r, o, s, a);
                                var l = at(r),
                                  c = l || at(o),
                                  A = c || at(s);
                                return (
                    ...
                    (t = (function (t, e) {
                      return (
                        n("replaceStars", t, e), t.trim().replace(o[V], "")
                      );
                    })(t, e)),
                    n("stars", t),
                    t
        ...
        (st.prototype.test = function (t) {
          ...
          for (var e = 0; e < this.set.length; e++)
            if (ct(this.set[e], t, this.options)) return !0;
          return !1;
        }),
        (e.satisfies = At),
        ...
        (e.minVersion = function (t, e) {
          ...
          if (((n = new H("0.0.0-0")), t.test(n))) return n;
          n = null;
          for (var i = 0; i < t.set.length; ++i) {
            t.set[i].forEach(function (t) {
              var e = new H(t.semver.version);
              switch (t.operator) {
                case ">":
    ...
    77760: (t) => {
      ...
      function Gr(t, e) {
        ...
        const x = _ && d ? d : A,
          ...
          z = (n._enterCb = O(() => {
            R && (Lr(n, T), Lr(n, j)),
              z.cancelled ? (R && Lr(n, x), Q && Q(n)) : k && k(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
          ...
          R &&
            ...
            Or(() => {
              Lr(n, x),
                z.cancelled ||
                  (Qr(n, T), Y || ($r(L) ? setTimeout(z, L) : Rr(n, c, z)));
            })),
          ...
          I.cancelled ||
            ...
            v &&
              ...
              Or(() => {
                Lr(n, c),
                  I.cancelled ||
                    (Qr(n, A), w || ($r(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
      ...
      const Jr = (function (t) {
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, c);
            ...
            if (!i && Ui(t, e)) b(t, e, c, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
