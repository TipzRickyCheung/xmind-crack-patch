/*! For license information please see dialog-congratulate.js.LICENSE.txt */
  ...
  [8244],
  {
    ...
    45188: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        o = n(69931),
        s = n(63477);
      const a = n.n(s)().parse(location.search.substring(1)),
        l = {
          name: "Congratulate",
          data: function () {
            return { isOldUser: !1 };
          ...
          computed: {
            headlineImageURL() {
              return (0, o.ju)(
                this.isOldUser
                  ? "static/assets/images/congratulate-old-friend-dialog-headline.png"
                  : "static/assets/images/congratulate-dialog-headline.png",
              );
            },
            headlineHDImageURL() {
              return this.isOldUser
                ? `${(0, o.ju)("static/assets/images/congratulate-old-friend-dialog-headline.png")} 1x, ${(0, o.ju)("static/assets/images/congratulate-old-friend-dialog-headline@2x.png")} 2x`
                : `${(0, o.ju)("static/assets/images/congratulate-dialog-headline.png")} 1x, ${(0, o.ju)("static/assets/images/congratulate-dialog-headline@2x.png")} 2x`;
            },
          },
          mounted: function () {
            (0, r.L9)({
              eventCategory: "Activate",
              eventAction: "showCongratulate",
            }),
              a && "true" === a.isOldUser && (this.isOldUser = !0);
          },
          methods: {
            close() {
              window.close();
        ...
        function () {
          ...
          return e(
            ...
            [
              ...
              e(
                "div",
                { staticClass: "uk-flex uk-flex-column uk-window-body" },
                [
                  e("img", {
                    attrs: {
                      draggable: "false",
                      src: t.headlineImageURL,
                      srcset: t.headlineHDImageURL,
                    },
                  }),
                  t._v(" "),
                  e(
                    ...
                    {
                      staticClass:
                        "uk-flex uk-flex-center uk-flex-column uk-margin-medium-left uk-margin-medium-right uk-height-expand",
                    },
                    [
                      e(
                        "div",
                        ...
                        [
                          e(
                            ...
                            {
                              staticClass:
                                "uk-heading-primary uk-text-bold uk-margin-small-bottom",
                            },
                            [
                              t._v(
                                "\n          " +
                                  t._s(
                                    t.isOldUser
                                      ? t.$T("Hello, Old Friend")
                                      : t.$T("Upgrade Successful"),
                                  ) +
                                  "\n        ",
                              ),
                            ],
                          ...
                          t._v(" "),
                          e("span", { staticClass: "uk-margin-xsmall-top" }, [
                            t._v(
                              "\n          " +
                                t._s(
                                  t.isOldUser
                                    ? t.$T(
                                        "Thank you for continuing to choose Xmind Pro. Glad to see that you are still on your way towards becoming a great thinker full of productivity and creativity.",
                                      )
                                    : t.$T(
                                        "Thank you for upgrading to Xmind Pro. We are happy for you that you are a big step closer to efficient work and creative ideas.",
                                      ),
                                ) +
                                "\n        ",
                            ),
      ...
      (0, i.Z)(A, { name: "dialog-congratulate" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
        ...
        for (let a = 0; a < s.length; a++)
          (i = s[a]),
            "__ob__" !== i &&
              ((r = t[i]),
              (o = e[i]),
              n && v(t, i) ? r !== o && c(r) && c(o) && Fn(r, o) : Ct(t, i, o));
        return t;
      }
      function Gn(t, e, n) {
        return n
      ...
      const Jr = (function (t) {
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, A);
            ...
            if (!i && Ui(t, e)) E(t, e, A, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
