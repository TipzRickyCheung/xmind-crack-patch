/*! For license information please see dialog-share-to-gallery.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [3503],
  {
          ...
          var l = (s.MD5 = o.extend({
            ...
            _doProcessBlock: function (t, e) {
              ...
              (C = c(C, x, _, k, s, 7, a[0])),
                ...
                (_ = c(_, k, C, x, y, 17, a[6])),
                (x = c(x, _, k, C, m, 22, a[7])),
                (C = c(C, x, _, k, v, 7, a[8])),
                ...
                (k = A(k, C, x, _, y, 9, a[17])),
                (_ = A(_, k, C, x, I, 14, a[18])),
                (x = A(x, _, k, C, s, 20, a[19])),
                ...
                (_ = u(_, k, C, x, m, 16, a[38])),
                (x = u(x, _, k, C, M, 23, a[39])),
                (C = u(C, x, _, k, B, 4, a[40])),
                (k = u(k, C, x, _, s, 11, a[41])),
                (_ = u(_, k, C, x, p, 16, a[42])),
                (x = u(x, _, k, C, y, 23, a[43])),
    ...
    60879: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".share-content-list[data-v-a2197500] {\n  margin: 24px 0 0 0;\n  padding: 0;\n}\n.share-content-list-item[data-v-a2197500] {\n  margin-bottom: 8px;\n}\n.share-content-list-item[data-v-a2197500]:last-of-type {\n  margin-bottom: 0px;\n}\n.share-content-list-item-desc[data-v-a2197500] {\n  font-size: 11px;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  display: -webkit-box;\n  -webkit-line-clamp: 3;\n  -webkit-box-orient: vertical;\n  word-break: break-all;\n}\n.share-content-error-text[data-v-a2197500] {\n  margin: 20px 0 0;\n  font-size: 12px;\n}\n.share-to-gallery-checkbox[data-v-a2197500] {\n  margin-left: 1px;\n  margin-top: 13px;\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    21431: (t, e, n) => {
      ...
      !(function (t) {
        (t.CURRENT_SHEET = "CURRENT_SHEET"),
          (t.WHOLE_WORKBOOK = "WHOLE_WORKBOOK");
      })(i || (i = {}));
      const d = a().parse(location.search.slice(1)),
        p = Array.isArray(d.sheetIds) ? d.sheetIds : [d.sheetIds],
        h = "xmind-share-of-cn" === d.type,
        g = (0, o.aZ)({
          components: {
            PrivacyOptionTemplate: {
              props: ["linkClickHanlder"],
              render(t) {
                const e = (0, u.JE)().T,
                  n = e("Xmind Gallery"),
                  i = e(
                    "I agree this mind map can be displayed on $1 and downloaded by other users.",
                    n,
                  ),
                  r = t(
                    "span",
                    {
                      ...
                      on: {
                        click: (t) => {
                          t.preventDefault(),
                            t.stopPropagation(),
                            this.linkClickHanlder();
                        },
                      },
                    },
                    n,
                  ),
                  o = i.split(n).map((e) => t("span", e));
                return t("span", [o[0], r, o[1]]);
              },
            },
            ShareOfCNDescTemplate: {
              props: ["linkClickHanlder"],
              render(t) {
                const e = (0, u.JE)().T,
                  n = e("Xmind Gallery"),
                  i = e(
                    "The map will be uploaded to xmind.cn, and may be featured to display on $1.",
                    n,
                  ),
                  r = t(
                    "span",
          ...
          setup() {
            const t = (0, u.JE)().T,
              e = (0, o.iH)({}),
              n = (0, o.iH)(0),
              r = (0, o.iH)(i.CURRENT_SHEET),
              s = (0, o.iH)(!1),
              a = (0, o.iH)(!1),
              g = (0, o.iH)(!1),
              y = (0, o.Fl)(() =>
                r.value === i.CURRENT_SHEET ? [d.currSheetId] : p,
              ),
              m = (0, o.Fl)(() => y.value.map((t) => e.value[t])),
              v = (0, o.Fl)(() => {
                const t = m.value[n.value];
                return t
                ...
                () =>
                  ({
                    "xmind share": {
                      title: t("Xmind Share"),
                      desc: t(
                        "The map you choose will be uploaded to xmind.app.",
                      ),
                      confirmText: t("Upload & Create Link"),
                      errorText: t(
                        "Uploading to Xmind Share failed. Please check the network or re-login your Xmind ID.",
                      ),
                    },
                    "xmind-share-of-cn": {
                      title: t("Choose a Map to Submit"),
                      confirmText: t("Go to Submit"),
                      errorText: t(
                        "Uploading failed. Please check the network or re-login your Xmind ID.",
                      ),
                    },
                  })[d.type],
              ),
              I = (0, o.Fl)(() => [
                {
                  label: t("Current Map"),
                  value: i.CURRENT_SHEET,
                  title: d.mapTitle,
                },
                {
                  label: t("Current File"),
                  value: i.WHOLE_WORKBOOK,
                  title: d.fileTitle,
                },
              ]),
              b = (0, o.Fl)(() => M.value.errorText);
            (0, o.bv)(() => {
              p.map((t) =>
                c.ZP.fetch((0, l.vN)(d.editorId), {
                  exportImageOptions: {
                    format: "SVG",
                    noBackground: !1,
                    skipFont: !0,
                  ...
                  e.value = Object.assign(Object.assign({}, e.value), {
                    [t]: n,
                  });
                }),
              );
            ...
            return {
              ...
              currPreviewIndex: n,
              currPreviewImage: v,
              currPreviewImageSize: w,
              displayPreviewImages: m,
              shareText: M,
              shareContentVal: r,
              shareContentOpts: I,
              shareErrorText: b,
              ...
              shareToGallery: g,
              openXMindGallery: () => {
                c.ZP.fetch(l.lf.GO_LIBRARY_MORE_MAPS);
              },
              handleShareContentChange: (t) => {
                (r.value = t), (n.value = 0);
              },
              handleClose: B,
              handleConfirm: () =>
                f(this, void 0, void 0, function* () {
                  (a.value = !0), h && (0, A.JC)("goSubmitClick");
                  const t = I.value.find((t) => t.value === r.value),
                    e = {
                      title: t.title,
                      description: "",
                      lang: "all",
                      isPrivate: !!h || !g.value,
                      uploadSheetTypes: t.value,
                    },
                    n = yield c.ZP.fetch((0, l.dm)(d.editorId), e);
                  (a.value = !1),
                    n instanceof Error
                      ? ((0, A.JC)("jumpToSubmitPageFail"), (s.value = !0))
                      : ((0, A.JC)("jumpToSubmitPageSucc"), (s.value = !1)),
                    setTimeout(() => {
                      s.value || B();
                    });
                }),
              ...
              e(
                ...
                [
                        ...
                        [
                          t.currPreviewImage
                            ? e(
                                ...
                                {
                                  staticClass:
                                    "uk-box-shadow-small uk-padding-small",
                                ...
                                [
                                  e("img", {
                                    ...
                                    attrs: {
                                      "uk-svg": "",
                                      draggable: "false",
                                      "data-src": t.currPreviewImage,
                                      width: t.currPreviewImageSize.width,
                                      height: t.currPreviewImageSize.height,
                                    },
                                  }),
                                ],
                              )
                        ...
                        [
                          e("button", {
                            ...
                            attrs: {
                              ...
                              disabled: 0 === t.currPreviewIndex,
                            },
                            on: {
                              click: function (e) {
                                t.currPreviewIndex = 0;
                              },
                            },
                          }),
                          t._v(" "),
                          e("button", {
                            ...
                            on: {
                              click: function (e) {
                                t.currPreviewIndex > 0 && t.currPreviewIndex--;
                              },
                            },
                          }),
                          t._v(" "),
                          e(
                            ...
                            [
                              t._v(
                                "\n          " +
                                  t._s(
                                    `${t.displayPreviewImages.length > 0 ? t.currPreviewIndex + 1 : 0}/${t.displayPreviewImages.length}`,
                                  ) +
                                  "\n        ",
                              ),
                            ],
                          ...
                          e("button", {
                            ...
                            attrs: {
                              ...
                              disabled:
                                t.currPreviewIndex ===
                                t.displayPreviewImages.length - 1,
                            },
                            on: {
                              click: function (e) {
                                t.currPreviewIndex <
                  ...
                  e(
                    ...
                    {
                      staticClass:
                        "uk-padding-large uk-flex uk-flex-1 uk-flex-column uk-flex-between uk-background-default uk-height-1-1",
                      staticStyle: { "padding-bottom": "22px" },
                    },
                    [
                      e("div", [
                        e("h1", { staticStyle: { "margin-bottom": "8px" } }, [
                          t._v(
                            "\n          " +
                              t._s(t.shareText.title) +
                              "\n        ",
                          ),
                        ]),
                        t._v(" "),
                        e(
                          ...
                          [
                            t.isXmindShareOfCN
                              ? e("ShareOfCNDescTemplate", {
                                  attrs: {
                                    "link-click-hanlder": t.openXMindGallery,
                                  },
                                })
                              : e("span", [t._v(t._s(t.shareText.desc))]),
                          ],
                          1,
                        ),
                        t._v(" "),
                        e(
                          "ul",
                          { staticClass: "share-content-list" },
                          t._l(t.shareContentOpts, function (n) {
                            return e(
                              "li",
                              {
                                key: n.value,
                                staticClass:
                                  "uk-flex uk-flex-top share-content-list-item",
                              },
                              [
                                e("input", {
                                  staticClass: "uk-radio uk-margin-remove-top",
                                  staticStyle: {
                                    "min-width": "16px",
                                    "min-height": "16px",
                                  },
                                  ...
                                  domProps: {
                                    value: n.value,
                                    checked: t.shareContentVal === n.value,
                                  },
                                  on: {
                                    change: function (e) {
                                      return t.handleShareContentChange(
                                        e.target.value,
                                      );
                                    },
                                  },
                                ...
                                e(
                                  ...
                                  [
                                    ...
                                    e(
                                      ...
                                      {
                                        staticClass:
                                          "uk-text-muted share-content-list-item-desc",
                                      },
                                      [t._v(t._s(n.title))],
                                    ),
                                  ],
                        ...
                        t.isXmindShareOfCN
                          ...
                          : e(
                              ...
                              {
                                staticClass:
                                  "uk-flex share-to-gallery-checkbox",
                              },
                              [
                                e("span", [
                                  e("input", {
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: t.shareToGallery,
                                        expression: "shareToGallery",
                                      },
                                    ],
                                    ...
                                    domProps: {
                                      checked: Array.isArray(t.shareToGallery)
                                        ? t._i(t.shareToGallery, null) > -1
                                        : t.shareToGallery,
                                    },
                                    on: {
                                      change: function (e) {
                                        var n = t.shareToGallery,
                                          i = e.target,
                                          r = !!i.checked;
                                        if (Array.isArray(n)) {
                                          var o = t._i(n, null);
                                ...
                                e(
                                  "span",
                                  {
                                    ...
                                    on: {
                                      click: function (e) {
                                        t.shareToGallery = !t.shareToGallery;
                                      },
                                    },
                                  },
                                  [
                                    e("PrivacyOptionTemplate", {
                                      attrs: {
                                        "link-click-hanlder":
                                          t.openXMindGallery,
                                      },
                        ...
                        t.isShareFaild
                          ? e(
                              ...
                              {
                                staticClass:
                                  "uk-text-danger share-content-error-text",
                              },
                              [
                                t._v(
                                  "\n          " +
                                    t._s(t.shareErrorText) +
                                    "\n        ",
                                ),
                              ],
                            )
                      ...
                      e(
                        ...
                        {
                          staticClass:
                            "uk-window-button-bar uk-background-default uk-padding-remove",
                          ...
                          e("div", { staticClass: "uk-button-group" }, [
                            e(
                              ...
                              [
                                ...
                                t._v(" "),
                                e("span", { staticClass: "uk-text-middle" }, [
                                  t._v(
                                    "\n              " +
                                      t._s(t.shareText.confirmText) +
                                      "\n            ",
                                  ),
                                ]),
                              ],
      ...
      (0, r.Z)(y, { name: "dialog-share-to-gallery" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
    ...
    77760: (t) => {
      ...
      const U = new RegExp(
        ...
        V = P && window.navigator.userAgent.toLowerCase(),
        H = V && /msie|trident/.test(V),
        $ = V && V.indexOf("msie 9.0") > 0,
        J = V && V.indexOf("edge/") > 0;
      V && V.indexOf("android");
      const W = V && /iphone|ipad|ipod|ios/.test(V);
            ...
            set: function (e) {
              ...
              if (L(n, e)) {
                if (A) A.call(t, e);
                  ...
                  if (c) return;
                  if (!o && Ot(n) && !Ot(e)) return void (n.value = e);
                  i = e;
                }
      ...
      function jt(t) {
        return Dt(t) ? jt(t.__v_raw) : !(!t || !t.__ob__);
      }
      function St(t) {
      ...
      function Le(t, e, n) {
        if (!P || "undefined" == typeof console) throw t;
        console.error(t);
      }
      let Qe = !1;
      const Re = [];
      ...
      var nn = Object.freeze({
        ...
        computed: function (t, e) {
          ...
          const o = tt() ? null : new cn(ot, n, k, { lazy: !0 }),
            s = {
              effect: o,
              get value() {
                return o
      ...
      function jn(t, i, r, s, a) {
        ...
        (this.data = t),
          ...
          l._scopeId
            ? (this._c = (t, e, i, r) => {
                const o = Te(c, t, e, i, r, u);
                return (
                  o && !n(o) && ((o.fnScopeId = l._scopeId), (o.fnContext = s)),
                  o
                );
              })
            : (this._c = (t, e, n, i) => Te(c, t, e, n, i, u));
      }
          ...
          (t = (function (t, e) {
            ...
            if (n && !r(t.owners)) {
              ...
              const A = (t) => {
                ...
                u = O((n) => {
                  (t.resolved = _e(n, e)), s ? (o.length = 0) : A(!0);
                }),
                d = O((e) => {
        ...
        e.computed &&
          (function (t, e) {
            ...
            for (const r in e) {
              const o = e[r],
                s = a(o) ? o : o.get;
              i || (n[r] = new cn(t, s || k, k, ii)), r in t || ri(t, r, o);
            }
          })(t, e.computed),
          e.watch &&
            e.watch !== Z &&
          ...
          (t.prototype.$on = function (t, i) {
            ...
            (t.prototype.$emit = function (t) {
              ...
              if (n) {
                ...
                for (let t = 0, o = n.length; t < o; t++) De(n[t], e, i, e, r);
              }
              return e;
            });
        })(Ai),
          ...
          ge(t.prototype),
            ...
            (t.prototype._render = function () {
              ...
              i &&
                ...
                (t.$vnode = i);
              try {
                st(t), (xe = t), (r = e.call(t._renderProxy, t.$createElement));
              } catch (e) {
      ...
      function Qi(t, e) {
        ...
        const o = t.context,
          ...
          l = e ? null : s,
          c = e ? void 0 : s;
        if (a(i)) return void De(i, o, [l], o, "template ref function");
      ...
      function Ki(t, e) {
        ...
        for (s in ((H || J) && u.value !== A.value && Zi(c, "value", u.value),
        A))
          i(u[s]) &&
            (bi(s)
        ...
        t.data.show ||
          ...
          R &&
            ...
            Or(() => {
              Qr(n, _),
                z.cancelled ||
                  (Lr(n, T), Y || (Vr(Q) ? setTimeout(z, Q) : Rr(n, c, z)));
            })),
      ...
      function Zr(t, e, n) {
        ...
        for (let e = 0, n = t.options.length; e < n; e++)
          if (((s = t.options[e]), r))
            (o = D(i, qr(s)) > -1), s.selected !== o && (s.selected = o);
          else if (S(qr(s), i))
      ...
      const po = x({ tag: String, moveClass: String }, so);
      delete po.mode;
      var ho = {
        props: po,
        beforeMount() {
      ...
      (Ai.config.mustUseProp = (t, e, n) =>
        ...
        x(Ai.options.directives, oo),
        x(Ai.options.components, vo),
        (Ai.prototype.__patch__ = P ? Jr : k),
      ...
      function y(t, n, r = {}, s, l, c) {
        ...
        function _(e, n) {
          return function () {
            ...
            try {
              l = n.apply(this && this.$id === t ? this : T, i);
            } catch (t) {
              throw (f(a, t), t);
            }
        ...
        s._s.set(t, T);
        const j = s._e.run(() => ((y = i.effectScope()), y.run(() => n())));
        for (const e in j) {
          const n = j[e];
          if (
        ...
        return (
          ...
          s._p.forEach((t) => {
            g(
              T,
              y.run(() => t({ store: T, app: s._a, pinia: s, options: m })),
            );
          }),
          E && c && r.hydrate && r.hydrate(T.$state, E),
          (w = !0),
          (M = !0),
          T
        );
