/*! For license information please see dialog-setpassword.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [7726],
  {
    ...
    63733: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".uk-lang-pt-PT .uk-form-aligned .uk-margin[data-v-c75eb1d8] {\n  margin: 10px 0;\n}\n.uk-form-aligned > div[data-v-c75eb1d8] {\n  align-items: center;\n}\n",
        "",
      ]);
      const s = r;
    },
    ...
    93201: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        l = n(90435),
        c = n(40334);
      const A = o.Us["dialog-setpassword"],
        u = s().parse(window.location.search.slice(1)),
        f = /^[a-zA-Z0-9_!\-()?[\]#$^&*+=`~ ]{1,128}$/,
        d = {
          mixins: [c.Z],
          data: () => ({
          ...
          computed: {
            ...
            canSetPassword() {
              return (
                ...
                (!this.oldPassword || this.oldPasswordConfirmed) &&
                this.validPassword
              );
            },
            canRemovePassword() {
              return "" !== this.oldPassword && this.oldPasswordConfirmed;
            },
            ...
            contentDefaultHeight() {
              let t = A.height;
              return this.oldPassword && (t += 61), t;
            },
            touchBarItems() {
              return [
                this.oldPassword
            ...
            validPassword() {
              return this.newPassword && f.test(this.newPassword);
            },
            errorHint() {
              return this.validPassword || !this.newPassword
                ? ""
                : this.$T("Your password contains invalid characters.");
            },
          },
          created() {
            this.newPasswordHint = this.passwordHint;
          },
          mounted() {
            this.oldPassword && this.expandDialog();
          },
          methods: {
            expandDialog() {
              window.resizeTo(A.width, A.height + 61);
            },
            handleInputState(t) {
              "Enter" === t.key ? (this.isInput = !1) : (this.isInput = !0);
            },
            cancel: function () {
              window.close();
            },
                ...
                this.newPassword &&
                  ...
                  this.$safeRun(async () => {
                    await l.ZP.fetch((0, a.iM)(window.id), {
                      ...
                      newPasswordHint: this.newPasswordHint.slice(0, 45),
                    }),
                      setTimeout(() => {
                        window.close();
                      }, 0);
            ...
            removePassword: function () {
              this.$safeRun(async () => {
                await l.ZP.fetch((0, a.iM)(window.id), { action: "remove" }),
                  setTimeout(() => {
                    window.close();
                  }, 0);
              });
        ...
        function () {
          ...
          return e("div", { staticClass: "uk-window uk-window-dialog" }, [
            ...
            e(
              ...
              {
                staticClass:
                  "uk-window-body uk-margin-large-left uk-margin-xlarge-top uk-margin-large-right uk-margin-large-bottom uk-overflow-hidden",
              },
              [
                ...
                e("div", [
                  t._v(
                    "\n      " +
                      t._s(
                        t.$T(
                          "If you forgot the password, the file can't be opened in any way.",
                        ),
                      ) +
                      "\n    ",
                  ),
                ...
                e(
                  "form",
                  {
                    ...
                    attrs: { id: "password_form" },
                    on: { submit: t.submitForm },
                  },
                  [
                    e("div", { staticClass: "uk-form-aligned" }, [
                      t.oldPassword
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: t.confirmOldPassword,
                                    expression: "confirmOldPassword",
                                  },
                                ],
                                staticClass: "uk-input",
                                class: {
                                  "uk-form-danger": !t.oldPasswordConfirmed,
                                },
                                attrs: {
                                  type: "password",
                                  autofocus: t.oldPassword,
                                },
                                domProps: { value: t.confirmOldPassword },
                                on: {
                                  input: function (e) {
                                    e.target.composing ||
                                      (t.confirmOldPassword = e.target.value);
                                  },
                                },
                              }),
                            ]),
                        ...
                        e("div", { staticClass: "uk-form-controls" }, [
                          e("input", {
                            ...
                            on: {
                              ...
                              keypress: t.handleInputState,
                              input: function (e) {
                                e.target.composing ||
                                  (t.newPassword = e.target.value);
                              },
                            },
                          }),
                        ]),
                    ...
                    e("div", { staticClass: "uk-form-aligned" }, [
                      e("div", { staticClass: "uk-margin" }, [
                        e(
                          ...
                          [t._v(t._s(t.$T("Confirm Password:")))],
                        ),
                        t._v(" "),
                        e("div", { staticClass: "uk-form-controls" }, [
                          e("input", {
                            ...
                            class: {
                              "uk-form-danger":
                                !t.newPasswordConfirmed &&
                                t.newPassword &&
                                !t.isInput,
                            },
                            attrs: { type: "password" },
                            domProps: { value: t.confirmNewPassword },
                            on: {
                              input: function (e) {
                                e.target.composing ||
                                  (t.confirmNewPassword = e.target.value);
                              },
                            },
                          }),
                        ]),
                    ...
                    e("div", { staticClass: "uk-form-aligned" }, [
                      e("div", { staticClass: "uk-margin" }, [
                        e(
                          ...
                          [t._v(t._s(t.$T("Password Hint (Optional):")))],
                        ),
                        t._v(" "),
                        e("div", { staticClass: "uk-form-controls" }, [
                          e("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: t.newPasswordHint,
                                expression: "newPasswordHint",
                              },
                            ],
                            staticClass: "uk-input",
                            attrs: { type: "text" },
                            domProps: { value: t.newPasswordHint },
                            on: {
                              input: function (e) {
                                e.target.composing ||
                                  (t.newPasswordHint = e.target.value);
                              },
                            },
                          }),
                        ]),
                ...
                t.oldPassword
                  ? e(
                      "button",
                      {
                        ...
                        attrs: {
                          type: "button",
                          disabled: !t.canRemovePassword,
                        },
                        on: { click: t.removePassword },
                      },
                      [t._v("\n        " + t._s(t.$T("Remove")) + "\n      ")],
                    )
                  : t._e(),
      ...
      (0, i.Z)(p, { name: "dialog-setpassword" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
    ...
    77760: (t) => {
        ...
        return (
          (y.run = () => {
            if (y.active)
              if (i) {
                const t = y.get();
                (s || p || (h ? t.some((t, e) => Q(t, m[e])) : Q(t, m))) &&
                  (d && d(),
        ...
        for (let a = 0; a < o.length; a++)
          (i = o[a]),
            "__ob__" !== i &&
              ((r = t[i]),
              (s = e[i]),
              n && v(t, i) ? r !== s && A(r) && A(s) && Un(r, s) : Ct(t, i, s));
        return t;
      }
      function Pn(t, e, n) {
        return n
      ...
      function Ki(t, e) {
        ...
        for (o in (($ || J) && u.value !== A.value && Zi(c, "value", u.value),
        A))
          i(u[o]) &&
            (Bi(o)
        ...
        t.data.show ||
          ...
          R &&
            ...
            Or(() => {
              Lr(n, x),
                z.cancelled ||
                  (Qr(n, T), Y || (Vr(L) ? setTimeout(z, L) : Rr(n, c, z)));
            })),
          ...
          I.cancelled ||
            ...
            v &&
              ...
              Or(() => {
                Lr(n, c),
                  I.cancelled ||
                    (Qr(n, A), w || (Vr(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
