/*! For license information please see dialog-payment.js.LICENSE.txt */
    ...
    96715: (t, e, n) => {
      ...
      const g = (0, r.aZ)({
        ...
        setup(t) {
          ...
          let i = null;
          const { updateIgnoreAppearance: g } = (0, f.O)(),
            y = (0, r.iH)(!0),
            m = (0, r.iH)(!1),
            v = (0, r.iH)(!1),
            w = (0, r.iH)(null),
            M = (0, r.iH)(""),
            I = (0, r.Fl)(() => (0, A.ju)("static/assets/images/no-wifi.svg")),
            B = (0, r.Fl)(() =>
            ...
            _ = (0, r.Fl)(
              () => (0, a.IW)().isPDVisible && (0, a.IW)().isFromPD,
            ),
            x = () =>
              h(this, void 0, void 0, function* () {
                try {
                  if (((m.value = !1), !C.value)) return void (m.value = !0);
                  let t = null;
                  const e = {
                    extend: C.value.extend,
                    autorenew: C.value.autorenew,
                    amount: C.value.amount,
                    currency: C.value.currency,
                    code: C.value.couponCode,
                  };
                  (t = _.value
                    ? yield c.ZP.fetch(s.lf.PAYWALL_D_ORDERS, e)
                    : yield c.ZP.fetch(s.lf.PAY_ORDER, e)),
                    (M.value = t.orderHash);
                } catch (t) {
                  (m.value = !0),
                    (M.value = ""),
                    e.error("post order failed", t);
                }
              }),
            j = () => {
              M.value &&
                ...
                (i = setInterval(
                  () =>
                    h(this, void 0, void 0, function* () {
                      try {
                        if (!navigator.onLine || !M.value)
                          return (m.value = !0), void (i && clearInterval(i));
                        m.value = !1;
                        const t = yield c.ZP.fetch(s.lf.PAY_ORDER_STATUS, {
                          orderHash: M.value,
                        });
                        0 === t.status
                          ? (clearInterval(i), yield T())
                          : 4 === t.status && window.close();
                      } catch (t) {
                        (m.value = !0),
                          i && clearInterval(i),
            ...
            T = () =>
              h(this, void 0, void 0, function* () {
                (0, u.wp)(), _.value && (0, a.IW)().updateHasPDExpired(!0);
                const { rawData: t } = yield c.ZP.fetch(s.lf.DEVICE_BIND);
                yield c.ZP.fetch(s.Fx, { name: "dialog-congratulate" }),
                  (0, a.c7)().updateAccount({ rawSubscriptionData: t }),
                  window.close();
              }),
            k = () =>
              h(this, void 0, void 0, function* () {
                try {
                  if (!M.value) return;
                  (m.value = !1),
                    w.value && (w.value.destroy(), (w.value = null));
                  const t = window.Stripe("pk_live_QGIYsKfxf8HwfftPKCtxyUxE"),
                    { clientSecret: e } = yield c.ZP.fetch(
                      s.lf.PAY_ORDER_STRIPE_CHECKOUT,
                      { orderHash: M.value, locale: n[N.value] },
                    );
                  (y.value = !1),
                    (w.value = yield t.initEmbeddedCheckout({
                      clientSecret: e,
                    })),
                    w.value.mount("#checkout");
                } catch (t) {
                  (m.value = !0),
                    (y.value = !1),
                    e.error("init stripe checkout failed", t);
                }
              }),
            S = () => {
              (function (t) {
              ...
              })("https://js.stripe.com/v3/").onload = () => {
                (v.value = !0), k();
                const t = o.getCurrentWindow();
                t.on("close", () => {
                  t.destroy();
                });
              };
          ...
          return (
            (0, r.bv)(() =>
              h(this, void 0, void 0, function* () {
                g(!0), (0, d.Z)("dark"), (0, u.xy)(), yield x(), S(), j();
              }),
            ),
            (0, r.Jd)(() => {
              g(!1), i && clearInterval(i);
            }),
            (0, r.YP)(
              () => [C.value, _.value],
              ([t, e], [n, i]) =>
            ...
            (0, r.YP)(
              () => m.value,
              (t) => {
                t && w.value && (w.value.destroy(), (w.value = null));
              },
              { immediate: !1 },
            ),
            (0, r.YP)(
            ...
            ),
            {
              ...
              logger: e,
              localeFromLang: n,
              orderStatusIntervalID: i,
              ORDER_STATUS_REFRESH_TIME: 5e3,
              updateIgnoreAppearance: g,
              isPaymentLoading: y,
              isPaymentLoadingFailed: m,
              hasStripeLoaded: v,
              stripeCheckout: w,
              orderHash: M,
              networkErrorURL: I,
              ...
              isFromPD: _,
              refreshPayOrder: x,
              refreshPayOrderStatus: j,
              refreshSubscriptionAndClose: T,
              refreshStripeCheckout: k,
              loadStripe: S,
              handleRetry: () =>
                h(this, void 0, void 0, function* () {
                  (y.value = !0), M.value || (yield x()), S(), j();
                }),
              Spinner: p.default,
            }
          );
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-window-body uk-flex uk-flex-middle uk-flex-center",
                },
                [
                  e("img", {
                  ...
                  n.isPaymentLoadingFailed
                          ...
                          e("div", { staticClass: "uk-margin-small-top" }, [
                            t._v(
                              "\n        " +
                                t._s(
                                  t.$T(
                                    "Request exception. Please check the network and try again.",
                                  ),
                                ) +
                                "\n      ",
                            ),
                    ...
                    : n.isPaymentLoading
                      ? e(n.Spinner, {
                          attrs: { text: t.$T("Processing Order") },
                        })
                      : e("div", {
      ...
      const Jr = (function (t) {
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, c);
            ...
            if (!i && Fi(t, e)) b(t, e, c, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
