/*! For license information please see dialog-coupon.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [49],
  {
    ...
    7518: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".coupon-code-title[data-v-3589b83e] {\n  margin: 40px 0 20px;\n  font-size: 20px;\n  font-weight: 700;\n  line-height: 25px;\n  letter-spacing: 0.123px;\n  color: #fff;\n}\n.coupon-code-input[data-v-3589b83e] {\n  width: 100%;\n  height: 36px;\n}\n.coupon-code-error-text[data-v-3589b83e] {\n  margin-top: 4px;\n  color: #ef5350;\n  font-size: 13px;\n  font-weight: 400;\n  letter-spacing: 0.08px;\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    89660: (t, e, n) => {
      ...
      const f = (0, r.aZ)({
        __name: "app",
        setup(t) {
          const e = (0, l.ZP)("coupon-code"),
            { updateIgnoreAppearance: n } = (0, c.O)(),
            i = (0, r.iH)(""),
            f = (0, r.iH)(!1),
            d = (0, r.iH)(!1),
            p = (0, r.Fl)(() => (0, o.IW)().productItems);
          return (
            (0, r.bv)(() => {
              n(!0), (0, A.Z)("dark");
            }),
            ...
            }),
            {
              __sfc: !0,
              logger: e,
              updateIgnoreAppearance: n,
              couponCode: i,
              isCouponCodeChecking: f,
              isCouponCodeErr: d,
              productItems: p,
              handleCouponCodeChange: (t) => {
              ...
              handleCouponCodeApply: () =>
                u(this, void 0, void 0, function* () {
                  try {
                    ...
                    if ("" === i.value)
                      return (
                        yield a.ZP.fetch((0, s.iM)(window.id), {
                          action: "remove-coupon-code",
                        }),
                        void window.close()
                      );
                    (f.value = !0), (d.value = !1);
                    const t = yield Promise.allSettled(
                      p.value.map((t) =>
                        a.ZP.fetch(s.lf.PAY_COUPON_CODE, {
                          code: i.value,
                          extend_month: t.extend,
                          autorenew_month: t.autorenew,
                        }),
                      ),
                    );
                    if (
                      (t.map((t) => {
                        "rejected" === t.status &&
                          e.error("invalid coupon code", t.reason);
                      }),
                      t.every((t) => "rejected" === t.status))
                    )
                      return void (d.value = !0);
                    const n = t.map((t) =>
                      "fulfilled" === t.status
                        ? t.value
                        : "rejected" === t.status
                    ...
                    yield a.ZP.fetch((0, s.iM)(window.id), {
                      action: "update-coupon-code",
                      data: { couponCode: i.value, discount: n },
                    }),
                      window.close();
                  } catch (t) {
                    e.error("invalid coupon code", t), (d.value = !0);
                  } finally {
                    f.value = !1;
                  }
                }),
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-window-body uk-flex uk-flex-column uk-flex-between",
                },
                [
                  e("div", { staticStyle: { padding: "0 24px" } }, [
                    e("h1", { staticClass: "coupon-code-title" }, [
                      t._v(t._s(t.$T("Enter Coupon Code"))),
                    ]),
                    t._v(" "),
                    e("input", {
                      staticClass: "uk-input coupon-code-input",
                      attrs: {
                        type: "text",
                        placeholder: t.$T("Coupon Code"),
                        autofocus: "",
                      },
                      domProps: { value: n.couponCode },
                      on: { input: n.handleCouponCodeChange },
                    }),
                    t._v(" "),
                    n.isCouponCodeErr
                      ? e("div", { staticClass: "coupon-code-error-text" }, [
                          t._v(
                            "\n        " +
                              t._s(t.$T("Coupon code is not valid.")) +
                              "\n      ",
                          ),
                        ])
                      : t._e(),
                    ...
                    e("div", { staticClass: "uk-button-group" }, [
                      e(
                        "button",
                        {
                          ...
                          attrs: { autofocus: "" },
                          on: { click: n.handleCouponCodeApply },
                        },
                        [
                          t._v(
                            "\n          " + t._s(t.$T("Apply")) + "\n        ",
