/*! For license information please see dialog-merging-options.js.LICENSE.txt */
  ...
  [9083],
  {
    ...
    31676: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        l = n(50965);
      const c = (0, r.aZ)({
        name: "DialogMergingOptions",
        mixins: [a.Z],
        setup() {
          const t = (0, r.FN)().proxy,
            e = (t, ...e) => (0, l.JE)().T(t, ...e),
            n = (0, r.qj)({ mergeTarget: 0, createIndexSheet: !1 }),
            i = (0, r.Fl)(() => [e("Multiple Sheets"), e("Current Map")]),
            a = (0, r.Fl)(() =>
              e(
                "To merge multiple files, hold down Shift or Ctrl when choosing files.",
              ),
            ),
            c = (0, r.Fl)(() => [
              { type: "space", size: "flexible" },
              { type: "button", label: e("Cancel"), click: "onCancel" },
              {
                type: "button",
                label: e("Choose"),
          ...
          return {
            ...
            onConfirm: () => {
              t.$safeRun(() => {
                s.ZP.fetch((0, o.iM)(window.id), {
                  createIndexSheet: n.createIndexSheet,
                  mergeIntoMultiSheet: 0 === n.mergeTarget,
                  mergeIntoCurrentSheet: 1 === n.mergeTarget,
                }).then(() => window.close());
              });
            },
            onCancel: () => {
              t.$safeRun(() => {
                s.ZP.fetch((0, o.iM)(window.id), null).then(() =>
                  window.close(),
                );
              });
            },
            onMergeTargetChange: (t) => {
              (n.mergeTarget = t), 1 === t && (n.createIndexSheet = !1);
            },
            state: n,
            tip: a,
            touchBarItems: c,
        ...
        function () {
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                [
                  e(
                    ...
                    {
                      staticClass:
                        "uk-panel uk-padding uk-flex uk-flex-column uk-height-expand",
                    },
                    [
                      e(
                        "h1",
                              ...
                              e(
                                ...
                                [
                                  t._v(
                                    "\n              " +
                                      t._s(
                                        t.mergeOptions[t.state.mergeTarget],
                                      ) +
                                      "\n            ",
                                  ),
                                ],
                              ...
                              e(
                                ...
                                [
                                  e(
                                    ...
                                    t._l(t.mergeOptions, function (n, i) {
                                      return e("li", { key: i }, [
                                        e(
                                          "button",
                                          {
                                            class: {
                                              "uk-checked":
                                                t.state.mergeTarget === i,
                                            },
                                            on: {
                                              click: () =>
                                                t.onMergeTargetChange(i),
                                            },
                                          },
                                          [
                                            t._v(
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: t.state.createIndexSheet,
                                        expression: "state.createIndexSheet",
                                      },
                                    ],
                                    staticClass:
                                      "uk-checkbox uk-margin-xsmall-right",
                                    attrs: {
                                      type: "checkbox",
                                      disabled: 1 === t.state.mergeTarget,
                                    },
                                    domProps: {
                                      checked: Array.isArray(
                                        t.state.createIndexSheet,
                                      )
                                        ? t._i(t.state.createIndexSheet, null) >
                                          -1
                                        : t.state.createIndexSheet,
                                    },
                                    on: {
                                      change: function (e) {
                                        var n = t.state.createIndexSheet,
                                          i = e.target,
                                          r = !!i.checked;
                                        if (Array.isArray(n)) {
                                          var o = t._i(n, null);
              ...
              t._v(" "),
              e("hr", {
                staticClass: "uk-margin-xsmall-bottom",
                staticStyle: {
                  color: "#ececec",
                  "margin-left": "30px",
                  "margin-right": "30px",
      ...
      (0, i.Z)(A, { name: "dialog-merging-options" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
