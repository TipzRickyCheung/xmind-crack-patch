/*! For license information please see dialog-evernote.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [6661],
  {
    ...
    51897: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".uk-form-aligned.uk-form-aligned-small > div > .uk-form-label {\n  width: 100px;\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    47833: (t, e, n) => {
      ...
      const c = {
        components: {},
        data: () => ({
          iconImageURL: (0, l.ju)("static/images/evernote-dialog-icon.svg"),
          errorMsg: "",
          bookList: [],
          bookIndexModel: 0,
          mindMapModel: !0,
        ...
        computed: {
          canSave() {
            return (
              ...
              (this.mindMapModel || this.mindFileModel || this.plainTextModel)
            );
          },
        },
        created() {
          ...
          (this.bookList =
            ("string" == typeof t.bookList &&
              JSON.parse(decodeURIComponent(t.bookList))) ||
            []),
            (this.editorId = t.editorId || "");
        },
        methods: {
          save() {
            (this.errorMsg = ""),
              (this.uploading = !0),
              s.ZP.fetch((0, a.wZ)(this.editorId), {
                notebookGuid: this.bookList[this.bookIndexModel].guid,
                selectedFile: this.mindFileModel,
                selectedImage: this.mindMapModel,
                selectedPlain: this.plainTextModel,
              })
                .then((t) => {
                  (this.uploading = !1),
                    t && t.code
                      ? (this.errorMsg = this.$T(
                          "File upload failed, please check your network and try again later.",
                        ))
                      : window.close();
                })
                .catch((t) => {
                  let e;
                  switch (null == t ? void 0 : t.data) {
                    case "Note":
                      e = this.$T("Maximum number of notes per account.");
                      break;
                    case "Note.size":
                      e = this.$T("The total note size is too large.");
                      break;
                    case "Note.resources":
                      e = this.$T("Too many resources on note.");
                      break;
                    case "Note.tagGuids":
                      e = this.$T("Too many tags on note.");
                      break;
                    case "Resource.data.size":
                      e = this.$T("The resource is too large.");
                      break;
                    case "Accounting.uploadLimit":
                      e = this.$T(
                  ...
                  (this.errorMsg = e), (this.uploading = !1);
                });
          },
          close() {
            window.close();
      ...
      const A = (0, n(51900).Z)(
        ...
        function () {
          var t = this,
            e = t._self._c;
          return e("div", { staticClass: "uk-window", attrs: { id: "app" } }, [
            e(
              "div",
              {
            ...
            e(
              "div",
              { staticClass: "uk-window-body uk-flex uk-flex-top uk-padding" },
              [
                e("div", {
                  staticClass: "uk-background-contain",
                  staticStyle: { width: "88px", height: "88px" },
                  attrs: { "data-src": t.iconImageURL, "uk-img": "" },
                }),
                t._v(" "),
                e("div", { staticClass: "uk-width-expand uk-margin-left" }, [
                  e("h1", [t._v(t._s(t.$T("Save To Evernote")))]),
                  t._v(" "),
                  e(
                    "form",
                    { staticClass: "uk-form-aligned uk-form-aligned-small" },
                    [
                      e("div", { staticClass: "uk-margin" }, [
                        e("label", { staticClass: "uk-form-label" }, [
                          t._v(t._s(t.$T("Save Content"))),
                        ]),
                        t._v(" "),
                        e(
                          "div",
                          {
                            staticClass:
                              "uk-form-controls uk-form-contorls-text",
                          },
                          [
                            e("label", [
                              e("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: t.mindMapModel,
                                    expression: "mindMapModel",
                                  },
                                ],
                                staticClass: "uk-checkbox",
                                attrs: { type: "checkbox" },
                                domProps: {
                                  checked: Array.isArray(t.mindMapModel)
                                    ? t._i(t.mindMapModel, null) > -1
                                    : t.mindMapModel,
                                },
                                on: {
                                  change: function (e) {
                                    var n = t.mindMapModel,
                                      i = e.target,
                                      r = !!i.checked;
                                    if (Array.isArray(n)) {
                                      var o = t._i(n, null);
                                      i.checked
                                        ? o < 0 &&
                                          (t.mindMapModel = n.concat([null]))
                                        : o > -1 &&
                                          (t.mindMapModel = n
                                            .slice(0, o)
                                            .concat(n.slice(o + 1)));
                                    } else t.mindMapModel = r;
                                  },
                                },
                              }),
                              t._v(
                                "\n              " +
                                  t._s(t.$T("Mind Map (Image)")) +
                                  "\n            ",
                              ),
                            ]),
                            t._v(" "),
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: t.mindFileModel,
                                    expression: "mindFileModel",
                                  },
                                ],
                                staticClass: "uk-checkbox",
                                attrs: { type: "checkbox" },
                                domProps: {
                                  checked: Array.isArray(t.mindFileModel)
                                    ? t._i(t.mindFileModel, null) > -1
                                    : t.mindFileModel,
                                },
                                on: {
                                  change: function (e) {
                                    var n = t.mindFileModel,
                                      i = e.target,
                                      r = !!i.checked;
                                    if (Array.isArray(n)) {
                                      var o = t._i(n, null);
                                      i.checked
                                        ? o < 0 &&
                                          (t.mindFileModel = n.concat([null]))
                                        : o > -1 &&
                                          (t.mindFileModel = n
                                            .slice(0, o)
                                            .concat(n.slice(o + 1)));
                                    } else t.mindFileModel = r;
                                  },
                                },
                              }),
                              t._v(
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: t.plainTextModel,
                                    expression: "plainTextModel",
                                  },
                                ],
                                staticClass: "uk-checkbox",
                                attrs: { type: "checkbox" },
                                domProps: {
                                  checked: Array.isArray(t.plainTextModel)
                                    ? t._i(t.plainTextModel, null) > -1
                                    : t.plainTextModel,
                                },
                                on: {
                                  change: function (e) {
                                    var n = t.plainTextModel,
                                      i = e.target,
                                      r = !!i.checked;
                                    if (Array.isArray(n)) {
                                      var o = t._i(n, null);
                                      i.checked
                                        ? o < 0 &&
                                          (t.plainTextModel = n.concat([null]))
                                        : o > -1 &&
                                          (t.plainTextModel = n
                                            .slice(0, o)
                                            .concat(n.slice(o + 1)));
                                    } else t.plainTextModel = r;
                                  },
                                },
                              }),
                              t._v(
                            ...
                            "select",
                            {
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: t.bookIndexModel,
                                  expression: "bookIndexModel",
                                },
                              ],
                              ...
                              on: {
                                change: function (e) {
                                  ...
                                  t.bookIndexModel = e.target.multiple
                                    ? n
                                    : n[0];
                                },
                              },
                            },
                            t._l(t.bookList, function (n, i) {
                              return e(
                                "option",
                  ...
                  e(
                    "p",
                    { staticClass: "uk-text-danger uk-margin-remove-bottom" },
                    [t._v("\n        " + t._s(t.errorMsg || " ") + "\n      ")],
                  ),
                ]),
              ],
              ...
              e("div", { staticClass: "uk-button-group" }, [
                e(
                  "button",
                  {
                    ...
                    attrs: { disabled: !t.canSave || t.uploading },
                    on: { click: t.save },
                  },
                  [
                    e("div", {
