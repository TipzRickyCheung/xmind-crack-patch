/*! For license information please see dialog-promotion.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [1958],
  {
          ...
          var l = (s.MD5 = o.extend({
            ...
            _doProcessBlock: function (t, e) {
              ...
              var o = this._hash.words,
                ...
                T = o[3];
              (C = c(C, _, x, T, s, 7, a[0])),
                (T = c(T, C, _, x, l, 12, a[1])),
                (x = c(x, T, C, _, d, 17, a[2])),
                (_ = c(_, x, T, C, p, 22, a[3])),
                (C = c(C, _, x, T, h, 7, a[4])),
                (T = c(T, C, _, x, g, 12, a[5])),
                (x = c(x, T, C, _, y, 17, a[6])),
                (_ = c(_, x, T, C, m, 22, a[7])),
                (C = c(C, _, x, T, v, 7, a[8])),
                (T = c(T, C, _, x, w, 12, a[9])),
                (x = c(x, T, C, _, M, 17, a[10])),
                (_ = c(_, x, T, C, I, 22, a[11])),
                (C = c(C, _, x, T, B, 7, a[12])),
                (T = c(T, C, _, x, b, 12, a[13])),
                (x = c(x, T, C, _, E, 17, a[14])),
                (C = A(
                  C,
                  (_ = c(_, x, T, C, N, 22, a[15])),
                  x,
                  T,
                  l,
                  5,
                ...
                (T = A(T, C, _, x, y, 9, a[17])),
                (x = A(x, T, C, _, I, 14, a[18])),
                (_ = A(_, x, T, C, s, 20, a[19])),
                (C = A(C, _, x, T, g, 5, a[20])),
                (T = A(T, C, _, x, M, 9, a[21])),
                (x = A(x, T, C, _, N, 14, a[22])),
                (_ = A(_, x, T, C, h, 20, a[23])),
                (C = A(C, _, x, T, w, 5, a[24])),
                (T = A(T, C, _, x, E, 9, a[25])),
                (x = A(x, T, C, _, p, 14, a[26])),
                (_ = A(_, x, T, C, v, 20, a[27])),
                (C = A(C, _, x, T, b, 5, a[28])),
                (T = A(T, C, _, x, d, 9, a[29])),
                (x = A(x, T, C, _, m, 14, a[30])),
                (C = u(
                  C,
                  (_ = A(_, x, T, C, B, 20, a[31])),
                  x,
                  T,
                  g,
                  4,
                ...
                (T = u(T, C, _, x, v, 11, a[33])),
                (x = u(x, T, C, _, I, 16, a[34])),
                (_ = u(_, x, T, C, E, 23, a[35])),
                (C = u(C, _, x, T, l, 4, a[36])),
                (T = u(T, C, _, x, h, 11, a[37])),
                (x = u(x, T, C, _, m, 16, a[38])),
                (_ = u(_, x, T, C, M, 23, a[39])),
                (C = u(C, _, x, T, b, 4, a[40])),
                (T = u(T, C, _, x, s, 11, a[41])),
                (x = u(x, T, C, _, p, 16, a[42])),
                (_ = u(_, x, T, C, y, 23, a[43])),
                (C = u(C, _, x, T, w, 4, a[44])),
                (T = u(T, C, _, x, B, 11, a[45])),
                (x = u(x, T, C, _, N, 16, a[46])),
                (C = f(
                  C,
                  (_ = u(_, x, T, C, d, 23, a[47])),
                  x,
                  T,
                  s,
                  6,
                ...
                (T = f(T, C, _, x, m, 10, a[49])),
                (x = f(x, T, C, _, E, 15, a[50])),
                (_ = f(_, x, T, C, g, 21, a[51])),
                (C = f(C, _, x, T, B, 6, a[52])),
                (T = f(T, C, _, x, p, 10, a[53])),
                (x = f(x, T, C, _, M, 15, a[54])),
                (_ = f(_, x, T, C, l, 21, a[55])),
                (C = f(C, _, x, T, v, 6, a[56])),
                (T = f(T, C, _, x, N, 10, a[57])),
                (x = f(x, T, C, _, y, 15, a[58])),
                (_ = f(_, x, T, C, b, 21, a[59])),
                (C = f(C, _, x, T, h, 6, a[60])),
                (T = f(T, C, _, x, I, 10, a[61])),
                (x = f(x, T, C, _, d, 15, a[62])),
                (_ = f(_, x, T, C, w, 21, a[63])),
                (o[0] = (o[0] + C) | 0),
                (o[1] = (o[1] + _) | 0),
                (o[2] = (o[2] + x) | 0),
                (o[3] = (o[3] + T) | 0);
    ...
    8931: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".promotion[data-v-4f327d77] {\n  cursor: default;\n  user-select: none;\n  transition-timing-function: linear;\n}\n.promotion-close[data-v-4f327d77] {\n  position: absolute;\n  z-index: 1;\n  fill-opacity: 0.5;\n  padding: 5px;\n  opacity: var(--opacity);\n  width: 20px;\n  height: 20px;\n  right: 6px;\n  top: 12px;\n}\n.promotion-close[data-v-4f327d77]:hover {\n  opacity: 1;\n}\n.promotion-close[data-v-4f327d77]:before,\n.promotion-close[data-v-4f327d77]:after {\n  position: absolute;\n  left: 9px;\n  content: ' ';\n  height: 11px;\n  width: 1px;\n  background-color: var(--close-color);\n}\n.promotion-close[data-v-4f327d77]:before {\n  transform: rotate(45deg);\n}\n.promotion-close[data-v-4f327d77]:after {\n  transform: rotate(-45deg);\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    99241: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        d = n(21029);
      l.app.vud;
      const p = l.app.eventManager;
      l.app.tvud, l.app.workspace;
      var h = n(18621),
        g = n(86633);
      const y = (0, r.aZ)({
        __name: "app",
        setup(t) {
          const e = (0, g.ZP)("promotion"),
            n = (0, r.iH)(null),
            i = (0, r.iH)(!1),
            s = (0, r.iH)(!1),
            y = (0, r.iH)(!0),
            m = (0, r.iH)(null),
            v = (0, r.Fl)(() => (0, c.Gu)().currentPromotion.id),
            w = (0, r.Fl)(() => (0, c.Gu)().currentPromotion.duration),
            M = (0, r.Fl)(() => (0, c.Gu)().currentPromotion.url),
            I = (0, r.Fl)(() => o.parse(M.value)),
            B = (0, r.Fl)(() => a().parse(I.value.query)),
            b = (0, r.Fl)(() => B.value.w || 0),
            E = (0, r.Fl)(() => B.value.h || 0),
            N = (0, r.Fl)(() => "#" + B.value["close-color"] || 0),
            C = (0, r.Fl)(() => B.value.opacity || 0.3),
            _ = (0, r.Fl)(
              () =>
                s.value &&
                i.value &&
                y.value &&
                !(0, f.E)().isBeginnerModeVisible &&
                !(0, f.E)().isBeginnerDialogVisible &&
                !(0, d.$)().zenMode &&
                !(0, d.$)().pitchMode,
            ),
            x = (0, r.Fl)(() => ({
            ...
            j = (t = !0) => {
              w.value <= 0 ||
                (t
                  ? (m.value = setTimeout(() => {
                      (i.value = !1), (s.value = !1), O("autoClose");
                    }, w.value))
            ...
            S = () => {
              (s.value = !0),
                (i.value = !0),
                (0, h.Fk)({ actionName: "Promotion" });
            },
            k = (t) => {
              e.info("FailLoad:", t), (i.value = !1);
            },
            O = (t) => {
              (i.value = !1),
                p.emit("promotion:completedOne", {
                  eventid: v.value,
                  winid: l.getCurrentWindow().id,
                }),
                (0, h.L9)({
                  eventCategory: "Notification",
                  eventAction: "closePromotionBy" + t,
                  eventName: v.value,
                }),
                window.close();
            };
          if (
            ...
            "popup" === (0, c.Gu)().currentPromotion.style
          )
            if (
              (e.info("Event id:", (0, c.Gu)().currentPromotion.id),
              b.value && E.value)
            ) {
              const t = I.value.protocol;
              "http:" !== t &&
                "https:" !== t &&
                (e.warn("Wrong url protocol!"), O("wrongProtocol"));
            } else e.warn("Wrong width or height!"), O("wrongWidthOrHeight");
          return (
            (0, r.YP)(_, () => {
              j(_.value);
            }),
            (0, r.bv)(() => {
              (s.value = !1),
                n.value &&
                  (n.value.addEventListener("load", S),
                  n.value.addEventListener("error", k));
            }),
            (0, r.Jd)(() => {
              u.ZP.fetch((0, A.iM)(window.id), { action: "close" });
            }),
            {
              __sfc: !0,
              logger: e,
      ...
      const m = (0, n(51900).Z)(
        ...
        function () {
          ...
          return e(
            ...
            {
              staticClass:
                "uk-window uk-window-dialog uk-window-default promotion",
              style: n.styleObject,
              attrs: { id: "app" },
            },
            [
              e("span", {
                staticClass: "promotion-close",
                style: n.closeStyleObject,
                on: {
                  click: function (t) {
                    return n.closeOne("closeButton");
                  },
                },
              }),
              t._v(" "),
    ...
    69537: (t, e, n) => {
      ...
      const a = [
        {
          ...
          tooltip: (0, s.WZ)("View topic outline and search the map."),
        },
        {
          key: i.NOTE,
          image: (0, o.ju)("static/images/navigation-panel/filter-note.svg"),
          tooltip: (0, s.WZ)("View and search all the notes."),
        },
        {
          key: i.TAG,
          image: (0, o.ju)("static/images/navigation-panel/filter-tag.svg"),
          tooltip: (0, s.WZ)("Highlight topics by marker, label and task."),
        },
      ];
      var l, c, A, u, f;
      !(function (t) {
      ...
      const d = [
          { key: c.TOPIC, category: l.FORMAT, label: (0, s.WZ)("Style") },
          { key: c.SLIDE, category: l.FORMAT, label: (0, s.WZ)("Pitch") },
          { key: A.MAP, category: l.THEME, label: (0, s.WZ)("Map") },
          {
            key: u.MARKER,
            category: l.IMAGE,
            image: (0, o.ju)(
        ...
        p = [
          {
            key: u.MARKER,
            label: (0, s.WZ)("Marker"),
            image: (0, o.ju)("static/assets/images/icon-panel/marker.svg"),
          },
          {
            key: u.STICKER,
            label: (0, s.WZ)("Sticker"),
            image: (0, o.ju)("static/assets/images/icon-panel/sticker.svg"),
          },
          {
            key: u.ILLUSTRATION,
    ...
    76893: (t, e, n) => {
      ...
      const o = (0, i.Q_)("editor", () => {
        ...
        return {
          mindmapCreated: e,
          updateMindMapCreated: (t) => (e.value = t),
          audioBarMode: g,
          audioAutoplay: y,
          audioTopicId: v,
          audioRecording: m,
          ...
          isEditorVisible: t,
          isAllowInsertHyperLink: h,
          sheetStatuses: f,
          outlinerSheetStatuses: d,
          suggestedDefaultZoomScale: p,
          isSheetBarVisible: s,
          changeSheetBarVisible: (t) => (s.value = t),
          isTopicCountLabelVisible: a,
          changeTopicCountVisible: (t) => {
            a.value = t;
          },
          isBeginnerDialogVisible: c,
          isTopicLinkDialogShowing: A,
          changeIsTopicLinkDialogShowing: (t) => {
            A.value = t;
          },
          changeBeginnerDialogVisible: (t) => (c.value = t),
          isBeginnerModeVisible: l,
          changeBeginnerModeVisible: (t) => (l.value = t),
          isTooltipsVisible: u,
          changeTooltipsVisible: (t) => (u.value = t),
          selectedMarkerId: w,
          updateSelectedMarkerId: (t) => {
            w.value = t;
          },
          getZoomScaleForSheet: (t) => {
            const e = f.value[t];
            return e ? e.suggestedZoomScale || p.value || e.zoomScale : null;
          },
          getOutlinerZoomScaleForSheet: (t) => {
            const e = d.value[t];
            return e ? e.suggestedZoomScale || p.value || e.zoomScale : 100;
          },
          updateAudioBarMode: (t) => {
            void 0 !== t.audioBarMode && (g.value = t.audioBarMode),
              void 0 !== t.audioAutoplay && (y.value = t.audioAutoplay),
              void 0 !== t.audioTopicId && (v.value = t.audioTopicId);
          },
          updateEditorVisible: (e) => {
            t.value = e;
          },
          ...
          updateSheetRendering: ({
            sheetRendering: t,
            sheetRenderingStartAt: e,
          }) => {
            (n.value = t), (i.value = e);
          },
          updateSheetRenderingInMode: ({ sheetRenderingInMode: t }) => {
            o.value = t;
          },
          updateSheetStatus: ({
            id: t,
            inited: e,
            suggestedZoomScale: n,
            zoomScale: i = null,
          }) => {
            if (void 0 === t) return;
            const r = {};
            e && (r.inited = e),
              null !== i &&
                (p.value ? (r.suggestedZoomScale = i) : (r.zoomScale = i)),
              void 0 !== n && ((r.suggestedZoomScale = n), (p.value = n)),
              (f.value = Object.assign(Object.assign({}, f.value), { [t]: r }));
          },
          updateOutlinerSheetStatus: ({ id: t, zoomScale: e = null }) => {
            if (void 0 === t) return;
            const n = {};
            t in d.value || (n.zoomScale = 100),
              null !== e && (n.zoomScale = e),
              (d.value = Object.assign(Object.assign({}, d.value), { [t]: n }));
          },
          updateAllowInsertHyperLink: (t) => {
            h.value = t;
          },
          isShapeShowMoreBtnVisible: M,
          updateShapeShowMoreBtnVisible: (t) => {
            M.value = t;
          },
        };
      });
    ...
    21029: (t, e, n) => {
      ...
      const a = (0, i.Q_)("workbench", () => {
        const t = (0, r.iH)(!1),
          ...
          u = (0, r.iH)(!1),
          f = (0, r.iH)(o.hO),
          d = (0, r.Fl)(() => f.value === o.Pq),
          p = (0, r.iH)(!1),
          h = (0, r.iH)(s.ll.MARKER),
          g = (0, r.iH)(!1),
          y = (0, r.iH)(!1),
          m = (0, r.iH)(s.QN.FORMAT),
          v = (0, r.iH)({
            [s.QN.FORMAT]: s.zZ.TOPIC,
            [s.QN.THEME]: s.x9.MAP,
            [s.QN.IMAGE]: s.ll.MARKER,
          }),
          w = (0, r.iH)(null),
          M = (0, r.iH)({ popover: "" }),
          I = (0, r.iH)(""),
        ...
        return {
          ...
          zenMode: a,
          zenModeNightMode: l,
          setZenMode: (t) => (a.value = t),
          setZenModeNightMode: (t) => (l.value = t),
          pitchMode: c,
          pitchPresenterViewMode: A,
          pitchRehearseMode: u,
          setPitchMode: ({ mode: t, isPresenterView: e, isRehearse: n }) => {
            "boolean" == typeof t && (c.value = t),
              "boolean" == typeof e && (A.value = e),
              "boolean" == typeof n && (u.value = n);
          },
          editorMode: f,
          setEditorMode: (t) => (f.value = t),
          isOutlinerMode: d,
          mapshotMode: p,
          setMapshotMode: (t) => (p.value = t),
          iconPanelTab: h,
          isIconPanelVisible: g,
          updateIconPanel: ({ visible: t, tab: e }) => {
            "boolean" == typeof t && (g.value = t), e && (h.value = e);
          },
          isRightbarVisible: y,
          rightBarPanel: m,
          rightPanelTab: v,
          rightPanelWin: w,
          rightPanelTabConfig: M,
          updateRightBarPanel: ({
            visible: t = null,
            panel: e = null,
            tab: n = null,
          ...
          updateSearchPanel: ({ visible: t, tab: i }) => {
            "boolean" == typeof t && (e.value = t), i && (n.value = i);
          },
          updateSearchPanelHighlightItem: (t) => {
            i.value = t;
          },
          userSelectedColorThemeTab: I,
          updateUserSelectedColorThemeTab: (t) => {
            I.value = t;
          },
          popoverEditorVisible: B,
          setPopoverEditorVisible: (t) => {
            B.value = t;
          },
          hyperLinkAutoFillOpt: b,
          changeHyperLinkAutoFillOpt: (t) => (b.value = t),
        };
      });
    },
    30266: (t, e, n) => {
    ...
    77760: (t) => {
      ...
      const U = new RegExp(
        ...
        P = H && /msie|trident/.test(H),
        $ = H && H.indexOf("msie 9.0") > 0,
        J = H && H.indexOf("edge/") > 0;
      H && H.indexOf("android");
      const W = H && /iphone|ipad|ipod|ios/.test(H);
      H && /chrome\/\d+/.test(H), H && /phantomjs/.test(H);
      const K = H && H.match(/firefox\/(\d+)/),
        Z = {}.watch;
      let X,
        q = !1;
      if (V)
      ...
      const Bt = { notify: T, depend: T, addSub: T, removeSub: T };
      class bt {
      ...
      function Tt(t) {
        return jt(t, !0), F(t, "__v_isShallow", !0), t;
      }
      function jt(t, e) {
        Ot(t) || Et(t, e, tt());
      }
      function St(t) {
        return Ot(t) ? St(t.__v_raw) : !(!t || !t.__ob__);
      }
      function kt(t) {
      ...
      function re(t) {
        return Jn(this.$options, "filters", t) || S;
      }
      function oe(t, e) {
      ...
      function Se(t, e, n) {
        if (
          ...
          for (let s = 0, a = t.children.length; s < a; s++) {
            ...
            r(a.tag) && (i(a.ns) || (o(n) && "svg" !== a.tag)) && Se(a, e, n);
          }
      }
      function ke(t, e, n) {
        ht();
      ...
      var nn = Object.freeze({
        ...
        computed: function (t, e) {
          let n, i;
          const r = a(t);
          r ? ((n = t), (i = T)) : ((n = t.get), (i = t.set));
          const o = tt() ? null : new cn(ot, n, T, { lazy: !0 }),
            s = {
              effect: o,
              get value() {
                return o
      ...
      function Rn(t, s, a, c, A) {
        ...
        if (o(t.options.functional))
          return (function (t, i, o, s, a) {
            ...
            const u = new Sn(o, c, a, s, t),
              f = l.render.call(null, u._c, u);
            if (f instanceof at) return kn(f, o, u.parent, l);
            if (n(f)) {
              const t = qt(f) || [],
                e = new Array(t.length);
              for (let n = 0; n < t.length; n++)
                e[n] = kn(t[n], o, u.parent, l);
              return e;
            }
          })(t, p, s, a, c);
        const h = s.on;
      ...
      function $n(t, e, i) {
        if (
          ...
          !e._base && (e.extends && (t = $n(t, e.extends, i)), e.mixins))
        )
      ...
      const ti = { enumerable: !0, configurable: !0, get: T, set: T };
      function ei(t, e, n) {
        (ti.get = function () {
          return this[e][n];
        }),
        ...
        if (
          ...
          (function (t) {
            ...
            if (n) {
              ...
              st(t), ht();
              const r = Oe(n, null, [t._props || Tt({}), i], t, "setup");
          ...
          e.methods &&
            (function (t, e) {
              t.$options.props;
              for (const n in e)
                t[n] = "function" != typeof e[n] ? T : N(e[n], t);
            })(t, e.methods),
          e.data)
        )
          !(function (t) {
        ...
        e.computed &&
          (function (t, e) {
            ...
            for (const r in e) {
              const o = e[r],
                s = a(o) ? o : o.get;
              i || (n[r] = new cn(t, s || T, T, ii)), r in t || ri(t, r, o);
            }
          })(t, e.computed),
          e.watch &&
            e.watch !== Z &&
      ...
      function ri(t, e, n) {
        const i = !tt();
        a(n)
          ? ((ti.get = i ? oi(e) : si(n)), (ti.set = T))
          : ((ti.get = n.get ? (i && !1 !== n.cache ? oi(e) : si(n.get)) : T),
            (ti.set = n.set || T)),
        ...
        if (t.super) {
          ...
          if (n !== t.superOptions) {
            ...
            i && _(t.extendOptions, i),
              (e = t.options = $n(n, t.extendOptions)),
        ...
        t.prototype._init = function (t) {
          ...
          (n._uid = li++),
            ...
            t && t._isComponent
              ...
              : (n.$options = $n(ci(n.constructor), t || {}, n)),
            (n._renderProxy = n),
            (n._self = n),
            (function (t) {
              const e = t.$options;
      ...
      !(function (t) {
        ...
        Object.defineProperty(Ai, "FunctionalRenderContext", { value: Sn }),
        (Ai.version = "2.7.14");
      ...
      xr &&
        (void 0 === window.ontransitionend &&
          ...
          ((Tr = "WebkitTransition"), (jr = "webkitTransitionEnd")),
        void 0 === window.onanimationend &&
          void 0 !== window.onwebkitanimationend &&
          ((Sr = "WebkitAnimation"), (kr = "webkitAnimationEnd")));
      const Or = V
      ...
      function zr(t, e) {
        ...
        return (
                ...
                (u = c ? ("transition" === c ? r.length : a.length) : 0)),
          {
            ...
            timeout: A,
            propCount: u,
            hasTransform: "transition" === c && Yr.test(n[Tr + "Property"]),
          }
        );
      }
      function Fr(t, e) {
        ...
        t.data.show ||
          ...
          R &&
            ...
            Dr(() => {
              Qr(n, x),
                z.cancelled ||
                  (Lr(n, j), Y || (Hr(Q) ? setTimeout(z, Q) : Rr(n, c, z)));
            })),
          ...
          I.cancelled ||
            ...
            v &&
              ...
              Dr(() => {
                Qr(n, c),
                  I.cancelled ||
                    (Lr(n, A), w || (Hr(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
      ...
      const Jr = (function (t) {
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, c);
            ...
            if (!i && Fi(t, e)) E(t, e, c, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
      ...
      function ao(t) {
        ...
        return e && e.Ctor.options.abstract ? ao(Te(e.children)) : t;
      }
      function lo(t) {
        const e = {},
          n = t.$options;
    ...
    77412: (t, e, n) => {
      ...
      function y(t, n, r = {}, s, l, c) {
        ...
        i.isVue2 && (T._r = !1);
        const j = i.reactive(T);
        s._s.set(t, j);
        const S = s._e.run(() => ((y = i.effectScope()), y.run(() => n())));
        for (const e in S) {
          const n = S[e];
          if (
            ...
            c ||
              (!E ||
                ((k = n), i.isVue2 ? h.has(k) : a(k) && k.hasOwnProperty(p)) ||
            ...
            const t = x(e, n);
            i.isVue2 ? i.set(S, e, t) : (S[e] = t), (m.actions[e] = n);
          }
        }
        var k, O;
        return (
          ...
          s._p.forEach((t) => {
            g(
              j,
              y.run(() => t({ store: j, app: s._a, pinia: s, options: m })),
            );
          }),
