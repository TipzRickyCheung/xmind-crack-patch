(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [2443],
  {
    59970: (t, e, s) => {
      ...
      a.push([
        t.id,
        ".uk-button-grey-link[data-v-070b398f] {\n  text-decoration: none;\n}\n.version-text[data-v-070b398f],\n.copyright-text[data-v-070b398f],\n.policy-text[data-v-070b398f] {\n  font-size: 12px;\n  line-height: 14px;\n  font-weight: 400;\n}\n.edition-text[data-v-070b398f] {\n  font-size: 13px;\n  line-height: 19px;\n  font-weight: 500;\n}\n.subscribed-text[data-v-070b398f] {\n  font-weight: 500;\n  font-size: 13px;\n  line-height: 16px;\n  letter-spacing: -0.08px;\n}\n.about-beta-btn[data-v-070b398f] {\n  padding: 0 4px;\n  background: #e8e8e8;\n  border-radius: 4px;\n}\nhtml[color-scheme='dark'] .about-beta-btn[data-v-070b398f] {\n  background: #2d2f31;\n}\n",
        "",
      ]);
      const n = a;
    },
    ...
    70909: (t, e, s) => {
      ...
      (async () => {
        const t = document.createElement("style"),
          e = `data:font/ttf;base64,${(await (0, b.zD)("static/snowbird/resource/fonts/files/NeverMind-DemiBold.ttf")).toString("base64")}`;
      ...
      const v = {
        ...
        computed: {
          ...
          activateHDLogoURL() {
            const t =
                this.activationStatus === l.wi.VALID && this.subscribedTimeText,
              e = this.isBetaVersion ? "beta-" : "";
            return t
              ? `${this.$toResourceURL("static/assets/images/about-dialog-activate-logo.png")} 1x, ${this.$toResourceURL("static/assets/images/about-dialog-activate-logo@2x.png")} 2x, ${this.$toResourceURL("static/assets/images/about-dialog-activate-logo@3x.png")} 3x`
              : `${this.$toResourceURL(`static/assets/images/${e}about-dialog-logo.png`)} 1x, ${this.$toResourceURL(`static/assets/images/${e}about-dialog-logo@2x.png`)} 2x, ${this.$toResourceURL(`static/assets/images/${e}about-dialog-logo@3x.png`)} 3x`;
          },
          editionText() {
            return l.sv || l.zr
              ? l.sv
        ...
        methods: {
          formatBuildNumber: (t = "") =>
            `${u().major(t, { loose: !0 })}.${u().minor(t, { loose: !0 }).toString().padStart(2, "0")}.${u().patch(t, { loose: !0 }).toString().padStart(5, "0")}`,
