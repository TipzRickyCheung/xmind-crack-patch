...
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [1189],
  {
    47680: (e, t, i) => {
      ...
      const y = (0, s.aZ)({
          components: {
            TopBar: () => i.e(4215).then(i.bind(i, 14215)),
            TabBar: () => i.e(4470).then(i.bind(i, 74470)),
            Workbench: () => i.e(9194).then(i.bind(i, 39194)),
            MapShot: () => i.e(7458).then(i.bind(i, 77458)),
          },
          setup() {
            const e = (0, f.JE)().T,
              t = (0, u.y)(),
              ...
              r = (0, s.Fl)(() => (0, v.A)().saving),
              d = (0, s.Fl)(() => (0, f.S)().language),
              l = (0, s.Fl)(() => (0, f.S)().systemAppearance),
              ...
              P = (0, s.Fl)(() => E.value === window.editorId),
              L = (e) => {
                var t;
                const i =
                  null === (t = (0, v.A)()) || void 0 === t
                    ? void 0
                    : t.commandById(e);
                return !!i && !!i.enabled;
              },
              V = (0, s.Fl)(() => {
                var e;
                return null === (e = (0, v.r)()) || void 0 === e
                  ? void 0
                  : e.tabbarScrollLeft;
              }),
              A = (0, s.Fl)(() => (0, C.F)().source),
              Z = (0, s.Fl)(() => {
                var e, t;
                const i =
                  null === (e = (0, v.r)()) || void 0 === e
                ...
                if (!i) return;
                return (
                  null === (t = (0, v.r)().editorViewInfos) || void 0 === t
                    ? void 0
                    : t.find(({ id: e }) => e === i)
                ).source;
              }),
            ...
            return (
              ...
              }),
              {
                ...
                progressText: O,
                isActivateEditor: n,
                activeEditorProgressText: F,
                isEditorTabChange: P,
                tabbarScrollLeft: V,
                canHandleCommand: L,
                handleCommand: (e) => {
                  (0, f.JX)().handleCommand(e);
                },
                handleCommandsRegister: (e) => {
                  t.registerCommands(e);
                },
                handleTabbarScroll: (e) => {
                  (0, v.r)().updateTabbarScrollLeft(e);
                },
              }
            );
          },
      ...
      const V = (e, t) => {
        ...
        B = (e) => `editor/${e}`,
        R = (e) => `editor/${e}/frame`,
        $ = (e) => `editor/${e}/mindmap/beginnerMode`,
        ...
        j = () => {
          ...
          const d =
              V("editor.showBranchOnly", i.value) ||
              V("editor.exitBranchOnly", i.value),
            l = V("editor.exitBranchOnly", i.value)
              ? n("Show Full Content")
              : n("Show Branch Only"),
            s =
              V("editor.foldBranch", i.value) ||
              V("editor.unfoldBranch", i.value),
            c = V("editor.foldBranch", i.value)
              ? n("Fold Subtopic")
              : n("Unfold Subtopic"),
            u =
              V("editor.foldAllDescendantBranches", i.value) ||
              V("editor.unfoldAllDescendantBranches", i.value),
            v = V("editor.foldAllDescendantBranches", i.value)
          ...
          return (
            a.push(
              ...
              ].map(({ id: t, actionName: n }) => {
                var o;
                return {
                  id: t,
                  enabled: !(null === (o = i.value[n]) || void 0 === o
                    ? void 0
                    : o.disabled),
                  provider: e,
                };
      ...
      function oe(e) {
        return ne(this, void 0, void 0, function* () {
          ...
          i({ name: "mutateProperty:fileLink", inputValue: (0, ie.u3)(r) });
        });
      }
      ...
      function pe() {
        ...
        (0, p.$)().mapshotMode
          ...
          : (0, f.JX)().handleCommand("showMapShot");
      }
      var me = i(23897),
        ve = i(55733),
        fe = i.n(ve),
            ...
            (yield (function (e, t) {
              return Ce(this, void 0, void 0, function* () {
                ...
                (0, ue.L9)({
                  ...
                  eventName: `target: ${t.mergeIntoMultiSheet ? "Multiple Sheets" : "Current Map"}, createIndexSheet: ${t.createIndexSheet}, fileCount: ${e.length}`,
                });
                let i = !0;
                const n = 1e3,
                  o = new Date().getTime();
      ...
      function we() {
        ...
        e.length && e[0].close();
        const t = "CUSTOM-" + (0, k.hb)();
        (0, f.JX)().handleCommand("themeEditor", {
          id: t,
          editorId: window.editorId,
          parentId: window.id,
      ...
      const Se = (0, ke.ZP)("editor:set-password");
      function Me() {
      ...
      function Ee() {
        return He(this, void 0, void 0, function* () {
          ...
          e({ name: "mutate:rotateImage", payload: Ve("left") });
        });
      }
      const { rotateRasterImage: Pe, rotateSvgImage: Le } =
      ...
      function We(e) {
        return _e("", e).replace(/[\x00-\x08\x0b-\x0c\x0e-\x1f]/g, "");
      }
      const De = "<br />",
        je = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
      function _e(e, t) {
        ...
        e += je;
        for (const n of t.children) i += _e(e, n);
        for (const e of t.detachedChildren) i += _e(je, e);
        return i;
      }
      var ze = i(96026),
        qe = i.n(ze),
      ...
      const Xe = 1,
        Ge = 3,
        Ke = (0, ke.ZP)("editor:share-to-library");
      function Je(e) {
        let t = e.split(","),
          i = t[0].match(/:(.*?);/)[1],
          n = atob(t[1]),
        ...
        return Ye(this, void 0, void 0, function* () {
          const t = yield (function (e) {
            return Re(this, void 0, void 0, function* () {
              ...
              return (0, f.qr)().usableShareItems.includes(e);
            });
          })(e);
          if (!t) return;
          const i = window.editorId,
            ...
            { source: h, title: p } = (0, C.F)(),
            { upload: v, canceled: g } = (function ({
              type: e,
              editorId: t,
              sheetId: i,
            }) {
              ...
              return {
                ...
                upload: (t, i, s, u = !1, p = !1) =>
                  Ue(this, void 0, void 0, function* () {
                    ...
                    try {
                      yield r.ZP.fetch(l.lf.UPLOAD_MAP, v);
                    } catch (e) {
            ...
            })({ type: e, editorId: i, sheetId: o.value.id });
          let y = null;
          const b = r.ZP.route((0, l.dm)(i), (t) =>
              v(
                t.title,
                t.description,
                t.lang,
            ...
            { id: w, title: T } = o.value,
            k = n.value.map((e) => e.id),
            I = a.value ? tt(a.value.viewAttributes.mapBackgroundColor) : null,
            { T: S } = (0, f.JE)(),
            M = new RegExp(`^(?:${S("Map")}) \\d+$`);
          y =
            "xmind share" === e || "xmind-share-of-cn" === e
              ? r.ZP.fetch(l.Fx, {
                  ...
                  query: {
                    ...
                    currSheetId: w,
                    mapTitle:
                      M.test(T) && o.value.rootTopic.title
                        ? (0, ie.N6)(o.value.rootTopic.title)
                        : (0, ie.N6)(T),
                    fileTitle:
                      h.startsWith("new://") && n.value[0].rootTopic.title
                        ? (0, ie.N6)(n.value[0].rootTopic.title)
                        : (0, ie.N6)(p),
                  },
                }).then(() => {
                  (g.value = !0), b(), u && u();
      ...
      function mt() {
        return st(this, void 0, void 0, function* () {
          const e = window.editorId,
            { getSheetViewer: t } = (0, m.nZ)(),
            {
              ...
              const { title: t, saveAsLocalFile: i } = (0, C.F)(),
                ...
                d = (0, s.iH)([]),
                c = () => {
                  const { oauthToken: e, username: t, china: i } = (0, f.Ak)();
                ...
                g = (i) =>
                  st(this, void 0, void 0, function* () {
                    ...
                    return {
                      resource: a,
                      content: `<div style="width:100%;text-align:center;"><h2>${t.replace(c.escape, (e) => s.escape[e])}</h2><br /><en-media type="${a.mime}" hash="${d}" /></div><br /><br />`,
                    };
                  }),
              ...
              return {
                ...
                checkOAuth: () =>
                  st(this, void 0, void 0, function* () {
                    const e = c();
                    return !!(null == e ? void 0 : e.oauthToken) || (yield u());
                  }),
                getNoteData: () =>
                  new Promise((e, t) =>
                    st(this, void 0, void 0, function* () {
                ...
                saveEvernote: ({
                  ...
                  st(this, void 0, void 0, function* () {
                    ...
                    if (i) {
                      const { resource: t, content: i } = yield v(e);
            ...
            d = () =>
              st(this, void 0, void 0, function* () {
                try {
                  ...
                  if (e instanceof ht) return a(), yield d();
          ...
          if (!Array.isArray(u) || !u.length)
            throw (
              (ut.info("got none evernote book list", u),
      ...
      const ft = (0, ke.ZP)("shareHandler:"),
        gt = {
          CLIENT_ID: "K9FIvBKyOCYhS1Q1i6ov2YuC5FZ7iXOVzTdBS7GD",
          CLIENT_SECRET: "Uoe5YUPf14wkes5Gy5HIwTygMxPGe7hrztVMuIGU",
        },
        Ct = "https://api.biggerplate.com/maps",
        yt = "https://accounts.biggerplate.com/oauth/token";
      function bt() {
        return vt(this, void 0, void 0, function* () {
          const e = window.editorId,
            ...
            { checkOAuth: o, upload: a } = (function () {
              const { updateBiggerplate: e } = (0, f.vF)(),
                { T: t } = (0, f.JE)(),
                    ...
                    if (!(i && n > Date.now()))
                      return o(a).catch(() => {
                        r.ZP.fetch(l.Fx, {
                          ...
                          const { accessToken: i, realExpireTime: n } = (0,
                          f.vF)();
                          i && n > Date.now() ? e() : t();
                        });
                      });
          ...
          yield o();
          const d = i.value
              ? tt(i.value.viewAttributes.mapBackgroundColor)
              : null,
            s = r.ZP.route((0, l.dm)(e), ({ title: e, description: t }) =>
              a(e, t)
                .catch((e) => (ft.info("upload biggerplate error", e), e))
                .then(() => {
                  (0, f.Rg)().addRateMasValue(10);
                }),
            );
      ...
      const Tt = () => {
        const {
                        ...
                        () => {
                          setTimeout(() => {
                            !window.document.fullscreenElement &&
                              (0, p.$)().zenMode &&
                              ((0, v.r)().setIsFullScreen(!1),
                              (0, v.r)().setIsZenMode(!1));
                          }, 400);
                        },
                      )
                    : (0, f.JX)().handleCommand("workbench.showZenMode");
              })(),
            "workbench.showZenMode": () => {
              r.ZP.fetch(l.O0, {
                ...
                setTimeout(() => {
                  window.document.fullscreenElement &&
                    !(0, p.$)().zenMode &&
                    ((0, v.r)().setIsFullScreen(!0),
                    (0, v.r)().setIsZenMode(!0));
                }, 400);
              });
            },
          },
          ...
          I = {
            "workbench.mapMode": () => w(),
            "workbench.outlineMode": () => T(),
            "workbench.switchToMapOrOutliner": () => {
              (0, p.$)().isOutlinerMode ? w() : T();
            },
          ...
          x = {
            ...
            "editor.showTopiclinkEditor": () =>
              (function ({
                ...
                let p = !1,
                  v = null;
                u && u.startsWith(c) && ((v = u.substr(7)), (p = !0));
                const f = () =>
            ...
            "editor.addFileLink": () => oe("file"),
            "editor.addFolderLink": () => oe("folder"),
            "editor.addAttachmentOnNewTopic": () =>
              se(void 0, void 0, void 0, function* () {
                ...
                if (ee.Z.existsSync(a)) {
                  if (ee.Z.statSync(a).isDirectory())
                    return void (0, re.N0)({
                      type: "warning",
                      title: "Xmind",
                  ...
                  i({
                    ...
                    payload: [
                      {
                        fileName: o,
                        resourcePath: (yield t(n, o)).substring(4),
                      },
                    ],
                  });
                }
          ...
          H = {
            ...
            "workbench.exportExcel": () =>
              Promise.all([i.e(1117), i.e(1395)])
                .then(i.bind(i, 41395))
                .then((e) => e.exportExcel()),
            "workbench.exportPowerPoint": () =>
              Promise.all([i.e(6486), i.e(2118), i.e(3907), i.e(8943)])
                .then(i.bind(i, 18943))
              ...
              (function () {
                return nt(this, void 0, void 0, function* () {
                  ...
                  ee.Z.writeFileSync(c, s.build()),
                    it.shell.openExternal((0, ie.u3)(c)).catch((e) => {
                      r.ZP.fetch(l.Fx, {
                        name: "dialog-problem",
                        payload: {
                          name: "OpenError",
          ...
          P = { printBranch: ce.Ln, print: ce.S0 },
          L = {
            showMapShot: he,
            mapShot: pe,
            mergeXMindFiles: ye,
          ...
          A = {
            "editor.enterPitchMode": () =>
              Promise.all([i.e(6486), i.e(2118), i.e(2205)])
                .then(i.bind(i, 72205))
      ...
      function Ht(e) {
        return Mt(this, void 0, void 0, function* () {
          let t = "";
          try {
            t = (0, f._I)().lastSaveDirectory || Q.app.getPath("downloads");
          } catch (e) {
            t = "downloads";
          }
      ...
      function Lt() {
        return Mt(this, void 0, void 0, function* () {
          ...
          Ht(o).then(function (e) {
            St().writeFileSync(e, r);
          });
        });
      }
      function Vt() {
          ...
          const {
            ...
            r =
              null === (t = n.value.query({ id: e })) || void 0 === t
                ...
                : t.asTopic();
          if (!r || !o.value) return;
          const d = o.value.topicFigureByTopicId[e];
          if (null == d ? void 0 : d.viewAttributes.hasImageLoadingFailed)
            return;
          const l = yield a(n.value.query({ id: r.id }).asTopic().imageSource),
            s = yield (0, _t.N8)(l),
            c = (0, f.km)();
          (null === (i = c.imageViewerContext) || void 0 === i
            ? void 0
            : i.imageUrl) !== l &&
            (0, f.JX)().handleCommand("imageViewer", {
              imageUrl: l,
              imageSize: s,
              title: r.title || "",
      ...
      const Xt = () => {
        ...
        Object.keys(L).forEach((t) => {
          ...
          (e["editor.toggleBranchOnly"] = () => {
            ...
            e.value
              ? (0, f.JX)().handleCommand("editor.exitBranchOnly")
              : (0, f.JX)().handleCommand("editor.showBranchOnly");
          }),
          (e["editor.toggleBranch"] = () => {
            const { actionStates: e, executeMutationAction: t } = (0, m.nZ)();
            t({
              name: V("editor.foldBranch", e.value)
                ? "mutate:foldBranch"
                : "mutate:unfoldBranch",
            });
          }),
          (e["editor.toggleAllBranch"] = () => {
            const { actionStates: e, executeMutationAction: t } = (0, m.nZ)();
            t({
              name: V("editor.foldAllDescendantBranches", e.value)
                ? "mutate:foldAllDescendantBranches"
                : "mutate:unfoldAllDescendantBranches",
            });
          }),
          (e["editor.editInfoItem"] = kt),
          (e["editor.saveAsAudioNote"] = Et),
          (e["editor.saveAsAttachment"] = Pt),
          (e["editor.saveAsImage"] = Lt),
          (e["editor.saveAsEquation"] = Vt),
          (e["editor.showEditBox"] = () =>
            Ut(void 0, void 0, void 0, function* () {
              ...
              if (
                ...
                return void (
                  1 === n.value.modelIds.length && qt(n.value.modelIds[0])
                );
              (null === (t = o.value["mutate:startEditingTopic"]) ||
              void 0 === t
                ? void 0
          ...
          (e["editor.clearText"] = At),
          (e["editor.removeMarker"] = Zt),
          (e["editor.removeLabel"] = Ot),
          (e["editor.removeLink"] = Ft),
          (e["editor.removeNote"] = Bt),
          (e["editor.removeStickerOrImageOrEquation"] = Rt),
          (e["editor.removeTopicContent"] = () => {}),
          (e["editor.removeMarkerForTopicContextMenu"] = Zt),
          (e["editor.removeLabelForTopicContextMenu"] = Ot),
          (e["editor.removeTaskForTopicContextMenu"] = () => {
            const { executeMutationAction: e } = (0, m.nZ)();
            e({ name: "mutate:removeTask" });
          }),
          (e["editor.removeLinkForTopicContextMenu"] = Ft),
          (e["editor.previousSheet"] = $t),
          (e["editor.nextSheet"] = Nt);
        [
          ...
          e[t.id] = () => {
            const { markerGroups: e, addMarker: i } = (0, jt.HV)(),
        ...
        return (
          ...
          (e["editor.changeNumberingPatternToNumeralRoman"] = () =>
            t("numeral-roman")),
          (e["editor.toggleNumberingTieredEnabled"] = () =>
            Ut(void 0, void 0, void 0, function* () {
              var e, t;
              const { styles: i, executeStyleAction: n } = (0, m.nZ)();
              n({
                name: "mutateProperty:topicNumberingTieredEnabled",
                inputValue: !(null ===
                  (t =
          ...
          (e["editor.toggleNumberingStartsHereEnabled"] = () =>
            Ut(void 0, void 0, void 0, function* () {
              var e, t;
              const { styles: i, executeStyleAction: n } = (0, m.nZ)();
              n({
      ...
      function Gt(e) {
        ...
        const {
          ...
          a = null === (t = L[e]) || void 0 === t ? void 0 : t.actionId;
        return (function (e) {
        ...
        const e = Xt(),
          t = (e) => {
            ...
            return (0, s.Fl)(() => {
              var i, n;
              return null ===
                (n = null === (i = t.value) || void 0 === i ? void 0 : i[e]) ||
                void 0 === n
                ? void 0
                : n.value;
            });
          ...
          n = (e) => () => {
            const n = t(e);
            if ("boolean" != typeof n.value) return;
            i(e)(!n.value);
          },
          o = (e, n, o) => () => {
            const a = t(e);
            if (!Number.isSafeInteger(a.value)) return;
            i(e)(n > 0 ? Math.min(a.value + n, o) : Math.max(a.value + n, o));
          };
        return {
          ...
          insertText: (e) => {
            const { activeSheetViewer: t } = (0, m.nZ)();
            t.value.textInputManager.insertText(e);
          },
          ...
          "editor.strikethroughText": n("textDecorationLineThrough"),
          "editor.boldText": n("textFontBold"),
          "editor.italicText": n("textFontItalic"),
          "editor.increaseFontSize": o("textFontSize", 2, 60),
          "editor.decreaseFontSize": o("textFontSize", -2, 8),
        };
      };
      var Qt = i(22345);
      const ei = (e) => (
      ...
      function ti() {
        const e = (0, f.f7)().keybindingByCommandId("editor.addSubTopic");
        ei(e), Gt("editor.addSubTopic")();
      }
      function ii() {
        const e = (0, f.f7)().keybindingByCommandId("editor.addTopic");
        ei(e), Gt("editor.addTopic")();
      }
      function ni() {
        const e = (0, f.f7)().keybindingByCommandId("editor.showEditBox");
        ei(e), Gt("editor.showEditBox")();
      }
      function oi() {
      ...
      const di = () => ({
        start: () => {
            ...
            (0, s.YP)(
              () => {
                ...
                const i = R(window.editorId),
                  ...
                  f = {};
                "function" == typeof e && Object.assign(f, e());
                const g = u[i].filter((e) => !!e),
                  C = u[n].concat(f[n]).filter((e) => !!e),
                  y = u[l].concat(f[l]).filter((e) => !!e),
                  b = u[o].concat(f[o]).filter((e) => !!e),
                  w = u[s].concat(f[s]).filter((e) => !!e),
                  T = u[r].concat(f[r]).filter((e) => !!e),
                  k = u[a].concat(f[a]).filter((e) => !!e),
                  I = u[c].concat(f[c]).filter((e) => !!e),
                  S = u[d].concat(f[d]).filter((e) => !!e),
                  M = [],
                  x = [],
                  H = Object.keys(f)
                    .filter((e) => !(e in u))
              ...
              const t = R(window.editorId),
                ...
                h = {
                  [t]: {
                    ...
                    closeComplexWindow: () =>
                      (0, f.JX)().handleCommand("closeWindow"),
                  },
                  [i]: Tt(),
                  [o]: Xt(),
                  [a]: {
                    "editor.addSubTopic": ti,
                    "editor.addTopic": ii,
                    "editor.showEditBox": ni,
                    escape: oi,
                  },
                  [d]: Yt(),
                  [u]: ai(),
          ...
          (0, f.JX)().injectDoHandleCommand((e, i) =>
            ri(void 0, void 0, void 0, function* () {
              var n;
              const o =
                  null === (n = (0, v.A)()) || void 0 === n
                    ? void 0
                    : n.commandById(e),
      ...
      function li(e, t) {
            ...
            b.forEach((e) => {
              ...
              const o =
                  null === (i = t.query({ id: e })) || void 0 === i
                    ? void 0
                    : i.asTopic(),
                { getSheetViewer: a } = (0, m.nZ)(),
                r =
                  null === (n = a(o.ownerSheet.id).getSheetFigure()) ||
                  void 0 === n
                    ? void 0
                    : n.topicFigureByTopicId[e];
              (null == o ? void 0 : o.extensionBy(m.o9.Equation))
                ? (g += 1)
                : (f += 1),
        ...
        return {
          "selection.none": 0 === i && 0 === p && 0 === v && 0 === f && 0 === g,
          "selection.single": i + p + v + f + g === 1,
          "selection.couple": i + p + v + f + g === 2,
          "selection.greaterThanCouple": i + p + v + f + g > 2,
          "selection.multiple": i + p + v + f + g > 1,
          "selection.some": i + p + v + f + g >= 1,
          "selection.hasTopic": i > 0,
          "selection.hasCentralTopic": r > 0,
          "selection.hasBoundary": p > 0,
          "selection.hasRelationship": v > 0,
          "selection.hasSummary": n > 0,
          "selection.hasCallout": o > 0,
          "selection.hasFloatingTopic": a > 0,
          "selection.hasImage": f > 0,
          ...
          "selection.allImages": 0 === i && 0 === p && 0 === v && f > 0,
      ...
      const ci = {
        ...
        ui = o().parse(window.location.search.slice(1)),
        hi = ui.editorId || "";
      window.editorId = hi;
      const pi = ui.source;
      let mi = "",
      ...
      (mi = document.querySelector("html").style.backgroundColor),
        (vi = document.querySelector("html").style.opacity),
        ...
        (0, a.Z)(w, {
          ...
          const t = r.ZP.route((0, l.uT)(window.editorId), () => {
            ...
            i = (0, C.F)();
          await i.init(pi || "new://workbook", hi);
        }),
        (0, s.YP)(
          () => (0, T.i)().ready,
          async (e) => {
            if (!e) return;
            const t = (0, f.OD)((0, d.aJ)(hi));
            (0, s.YP)(
              () => t().ownerFrameId,
              async (e, i) => {
                if (!e) return;
                ...
                h.isAlive
                  ? fi().then(() => {
                      (document.querySelector("html").style.backgroundColor =
                        mi),
                        (document.querySelector("html").style.opacity = vi);
                    })
                  : fi().then(() => {
                      (document.querySelector("html").style.backgroundColor =
                        mi),
                ...
                const p = await window.getWindowIdAsync(),
                  m = (0, d.b3)(p),
                  v = await r.ZP.fetch(l.Pp, {
                    mutations: [{ id: m, kind: "window" }],
                  });
                (0, f._t)(m)().$patch((0, s.qj)(v[m])),
    ...
    95246: (e, t, i) => {
      ...
      const w = (e, t) => d.Z.test({ width: e, height: t, sizes: [e, t] }),
        T = async (e, t, i = 1) => {
          if (w(e * i, t * i)) return i;
        ...
        m = [
          {
            key: u.MARKER,
            label: (0, r.WZ)("Marker"),
            image: (0, a.ju)("static/assets/images/icon-panel/marker.svg"),
          },
          {
            key: u.STICKER,
            label: (0, r.WZ)("Sticker"),
            image: (0, a.ju)("static/assets/images/icon-panel/sticker.svg"),
          },
          {
            key: u.ILLUSTRATION,
            label: (0, r.WZ)("Illustration"),
            image: (0, a.ju)(
              "static/assets/images/icon-panel/illustration.svg",
            ),
          },
        ];
    },
    ...
    76893: (e, t, i) => {
      ...
      const a = (0, n.Q_)("editor", () => {
        ...
        return {
          ...
          sheetStatuses: h,
          outlinerSheetStatuses: p,
          suggestedDefaultZoomScale: m,
          isSheetBarVisible: r,
          ...
          isBeginnerDialogVisible: s,
          isTopicLinkDialogShowing: c,
          changeIsTopicLinkDialogShowing: (e) => {
            c.value = e;
          },
          changeBeginnerDialogVisible: (e) => (s.value = e),
          isBeginnerModeVisible: l,
          changeBeginnerModeVisible: (e) => (l.value = e),
          isTooltipsVisible: u,
          changeTooltipsVisible: (e) => (u.value = e),
          selectedMarkerId: b,
          ...
          getZoomScaleForSheet: (e) => {
            const t = h.value[e];
            return t ? t.suggestedZoomScale || m.value || t.zoomScale : null;
          },
          getOutlinerZoomScaleForSheet: (e) => {
            const t = p.value[e];
            return t ? t.suggestedZoomScale || m.value || t.zoomScale : 100;
          },
          updateAudioBarMode: (e) => {
            void 0 !== e.audioBarMode && (f.value = e.audioBarMode),
              void 0 !== e.audioAutoplay && (g.value = e.audioAutoplay),
              void 0 !== e.audioTopicId && (y.value = e.audioTopicId);
          },
          ...
          updateSheetStatus: ({
            ...
            t && (o.inited = t),
              null !== n &&
                (m.value ? (o.suggestedZoomScale = n) : (o.zoomScale = n)),
              void 0 !== i && ((o.suggestedZoomScale = i), (m.value = i)),
              (h.value = Object.assign(Object.assign({}, h.value), { [e]: o }));
          },
          updateOutlinerSheetStatus: ({ id: e, zoomScale: t = null }) => {
            if (void 0 === e) return;
            const i = {};
            e in p.value || (i.zoomScale = 100),
              null !== t && (i.zoomScale = t),
              (p.value = Object.assign(Object.assign({}, p.value), { [e]: i }));
          },
          updateAllowInsertHyperLink: (e) => {
            v.value = e;
          },
          isShapeShowMoreBtnVisible: w,
    ...
    42799: (e, t, i) => {
      ...
      const H = (0, g.ZP)("from-temp:"),
        E = {
              ...
              return (
                ...
                (function (e) {
                  return x(this, void 0, void 0, function* () {
                    ...
                    const t = yield f.Z.readFile(e),
                      i = yield k().loadAsync(t);
                    if (!i || !i.files)
          ...
          canSave(e) {
            ...
            if (f.Z.existsSync(t))
              try {
                f.Z.accessSync(t, f.Z.constants.R_OK | f.Z.constants.W_OK);
              } catch (e) {
                return !1;
              }
            return !!t;
          ...
          handleOpenError(e, t) {
            return x(this, void 0, void 0, function* () {
              ...
              if ("TO_CLOSE_DOCUMENT" === t.code)
                return (
                  v.ZP.fetch(p.s2, { editors: [o], forceQuit: !0 }),
          ...
          heartbeatTest(e) {
            return x(this, void 0, void 0, function* () {
              ...
              try {
                return (
                  yield f.Z.access(r, f.Z.constants.R_OK), { shouldClose: !1 }
                );
              } catch (e) {
                const r = yield (0, I.N0)({
                  type: "warning",
                  title: "Xmind",
                  message: a(
                    "This mind map has been deleted from disk. You can delete it now or save as a new xmind file.",
                  ),
                  buttons: [a("Save As"), a("Delete")],
                  defaultId: 0,
                  cancelId: 0,
                  noLink: !0,
                });
                if (Array.isArray(r) && r.length > 0 && 0 === r[0]) {
                  const e = yield (0, I.ZZ)({
                    suggestPath: { doc: { source: t, title: i } },
                    filters: [
                      { name: a("Xmind Workbook"), extensions: ["xmind"] },
                    ],
                  });
                  if (e) return yield n((0, h.u3)(e)), { shouldClose: !1 };
                }
                return o(!1), { shouldClose: !0 };
              }
            });
          },
        };
      ...
      const $ = {
            ...
            return R(this, void 0, void 0, function* () {
              const i = l().parse(e),
                ...
                c =
                  ...
                  (function (e) {
                    const t = e("Untitled"),
                      i = P.BrowserWindow.getAllWindows().filter((e) => {
                        var t;
                        return (
                          e.id !==
                          (null === (t = P.getCurrentWindow()) || void 0 === t
                            ? void 0
                            : t.id)
                        );
                      }),
              ...
              {
                let e;
                if ("local" === h) e = r().join((0, s.d6)(), g);
                else {
                  const t = r().join((0, s.tM)(), `files/${b}/${m}.xmind`);
                  if (B().existsSync(t)) e = t;
                  else {
                    ...
                    let i = !1,
                      n = !1;
                    const o = yield v.ZP.fetch(p.lf.DOWNLOAD_TEMPLATE_FILE, {
                      id: u,
                      groupId: f,
                      snowbirdLang: W(b),
                    }).catch((e) => {
                    ...
                    yield B().ensureDir(r().dirname(t)),
                      yield B().writeFile(t, o),
                      (e = t);
                  }
                }
                const i = yield L.Z.read(e),
                  n = yield k().loadAsync(i),
                  a = JSON.parse(yield n.file("content.json").async("string"));
                if ("local" === h) {
                  const e = (0, V.e)(A.getLocalI18nContent(), W(b)),
                    t = Z.J(a, e),
                    i = JSON.stringify(t);
                  n.file("content.json", i);
                }
                const d = r().basename(e, ".xmind"),
                  l = yield n.generateAsync({ type: "arraybuffer" }),
                  C = yield (0, M.ee)(l, d, t.stage);
                return (
                  "content" in C && (C.content = (0, M.zw)(C.content)),
                  yield v.ZP.fetch(p.Pp, {
                    mutations: [
                      {
                        id: y.i0,
                        type: "appendRecentlyTemplates",
                        payload: [u, b],
                      },
                    ],
                  }),
          ...
          handleOpenError(e, t) {
            return R(this, void 0, void 0, function* () {
              const { $T: i } = e;
              return "VERIFICATION_FAILED" === t.code
                ? (yield (0, I.N0)({
                    message: i("Verification Failed"),
                    detail: i(
                      "Unable to detect any valid subscription. Please subscribe Xmind Pro and try again.",
                    ),
                    buttons: [i("OK")],
                  }),
                  v.ZP.fetch(p.Fx, { name: "new" }),
                  { recovered: !1, prompted: !0 })
                : "NETWORK_FAILURE" === t.code
                  ? (yield (0, I.N0)({
                      type: "warning",
                      message: i("Download Failed"),
                      detail: i(
        ...
        N = ({ $T: e } = {}) => ({
          ...
          class: "sheet",
          title: e("Map 1"),
          topicOverlapping: C.sp.Overlapping,
          rootTopic: {
            id: (0, u.hb)(),
            class: "topic",
        ...
        return (t) =>
          D(this, void 0, void 0, function* () {
            if (".textbundle" === r().extname(t)) {
              const i = yield f.Z.readFile(r().join(t, z)),
                n = {};
              if (f.Z.existsSync(r().join(t, _))) {
                const e = yield f.Z.readdir(r().join(t, _));
                for (const i of e) {
                  const e = yield f.Z.readFile(r().join(t, _, i));
                  n[i] = e;
                }
              }
              return e(i.buffer, n);
      ...
      function G(e, t) {
        return X(this, void 0, void 0, function* () {
          ...
          let d;
          try {
            d = yield v.ZP.fetch(p.lf.FILE_DOWNLOAD, {
              downloadUrl: e,
              filename: a,
              cacheId: a,
            });
      ...
      const K = { protocol: "http", open: G },
        J = { protocol: "https", open: G };
      ...
      const re = {
        ...
        open(e, t) {
          ...
          return ne(this, void 0, void 0, function* () {
            ...
            const s = new (k())();
            s.file("manifest.json", yield f.Z.readFile(a)),
              s.file("content.json", yield f.Z.readFile(d)),
              s.file("metadata.json", yield f.Z.readFile(l));
            ...
            yield (0, C.KR)(
              ...
              (e, n) =>
                ne(this, void 0, void 0, function* () {
                  ...
                  if (o) {
                    const i = (0, ie.H)(e, new TextEncoder().encode(n).buffer, {
                      password: o,
                    });
                    yield f.Z.writeFile(r().join(t, e.path), Buffer.from(i));
                  } else yield f.Z.writeFile(r().join(t, e.path), n);
                }),
              ae,
            );
          });
        ...
        close(e) {
          return ne(this, void 0, void 0, function* () {
            const t = e.tempStorageDir;
            oe.debug("Start clearing temp storage: ", t);
            const i = function (e) {
              if (f.Z.statSync(e).isDirectory()) {
                for (const t of f.Z.readdirSync(e)) i(r().join(e, t));
                f.Z.rmdirSync(e);
              } else f.Z.removeSync(e);
            };
            try {
              i(t);
            } catch (e) {
              oe.warn(`Something wrong when clearing temp storage: ${t}`, e);
            }
          });
        },
        updateMemento(e, t) {
            ...
            if (t || f.Z.existsSync(n))
              try {
                const t = {
                  ...
                  frameId: (0, te.A)().ownerFrameId,
                };
                oe.debug("Save Memento: ", t),
                  f.Z.writeFileSync(n, JSON.stringify(t));
              } catch (e) {
                oe.error("Error when saving memento.json.", (0, u.SC)(e));
              }
          });
        },
      };
      ...
      const le = (0, g.ZP)("fm:"),
        se = {};
      [$, E, q, K, J, Q].forEach((e) => (se[e.protocol] = e));
      const ce = (0, n.Q_)("file-manager", () => {
        const { addFileEventHook: e, emitFileEvent: t } = (function () {
          ...
          k = (0, o.Fl)(() => {
            ...
            return e
              ? (e.endsWith(":") && (e = e.substr(0, e.length - 1)), se[e])
              : null;
          });
        let I, S, x, H;
        const E = (0, o.iH)(!1),
          ...
          V = {
            askForPassword(e, t, i) {
              return de(this, void 0, void 0, function* () {
                ...
                const { result: n } = yield v.ZP.fetch(p.Fx, {
          ...
          B = () => {
            ...
            return (
              k.value &&
              (null === (t = (e = k.value).canSave) || void 0 === t
                ? void 0
          ...
          R = (e) =>
            de(void 0, void 0, void 0, function* () {
              ...
              v.ZP.fetch(p.xr, { editorId: I, source: a.value });
              const i = yield k.value.save(F());
              E.value
              ...
              W(r().basename(n, ".xmind")),
                j(!1),
                yield N(!1),
                t("saveAs", "postsaveas"),
                (0, te.A)().setSaving(!1),
                (0, y.Rg)().addRateMasValue(1);
            }),
          $ = (0, o.iH)(0),
          N = (e) =>
            de(void 0, void 0, void 0, function* () {
              var t;
              return null === (t = re.updateMemento) || void 0 === t
                ? void 0
                : t.call(re, F(), e);
            }),
          W = (e) => (d.value = e),
          ...
          U = () =>
            de(void 0, void 0, void 0, function* () {
              ...
              if (
                ...
                b.value &&
                "file" ===
                  (null === (e = k.value) || void 0 === e ? void 0 : e.protocol)
              )
                try {
                  const e = (0, y.yj)(),
                    t = b.value,
        ...
        return {
          ...
          init: (e, t) =>
            de(void 0, void 0, void 0, function* () {
              ...
              if (((S = r().join(i, I)), f.Z.ensureDirSync(S), t))
                try {
                  const e = r().join(S, ".memento.json");
                  x = JSON.parse(f.Z.readFileSync(e).toString());
                } catch (e) {}
              (g.value = {
                take: (e) =>
                  de(void 0, void 0, void 0, function* () {
                    const t = r().join(S, e);
                    return f.Z.existsSync(t) ? f.Z.readFile(t) : null;
                  }),
                add: (e, t) =>
                  de(void 0, void 0, void 0, function* () {
                    const i = r().join(S, e);
                    return (
                      yield f.Z.ensureDir(r().dirname(i)),
                      f.Z.writeFile(i, Buffer.from(t))
                    );
                  }),
                delete: (e) =>
                  de(void 0, void 0, void 0, function* () {
                    const t = r().join(S, e);
                    return f.Z.existsSync(t) && f.Z.remove(t);
                  }),
                toUrl: (e) =>
                  de(void 0, void 0, void 0, function* () {
          ...
          open: z(() =>
            de(void 0, void 0, void 0, function* () {
              ...
              if ("verificationFailed" in o)
                throw new he(
                  "VERIFICATION_FAILED",
                  "Current user does not have permission to download",
                );
              if ("networkFailure" in o)
                throw new he(
                  "NETWORK_FAILURE",
                  "Unable to download due to network not connected",
                );
              if ("needToClose" in o)
                throw new ue("TO_CLOSE_DOCUMENT", "Cannot open this file");
              const r = C.viewerKit.validateDocumentForLayoutEngine(o.content);
              return (
                (o.content = r.document),
                (T.value = r.incompatibility),
                (H = o.content),
                (b.value = o.fileId),
                (E.value = o.isEncrypted),
                (P.value = o.password),
                (L.value = o.passwordHint),
                W(o.fileName),
                q(a.value),
                j(null !== (e = o.isDirty) && void 0 !== e && e),
                t("open", "opened"),
                i || (yield D()),
                E.value
                  ? (A.value = (yield (0, c.zD)(
          ...
          save: z(() =>
            de(void 0, void 0, void 0, function* () {
              ...
              t("save", "presave"), (0, te.A)().setSaving(!0);
              const e = H,
                i = yield k.value.save(F());
              E.value
                ? (A.value = (yield (0, c.zD)(
                    "static/images/xmindfile-lock.png",
                  )).buffer)
          ...
          close: z(() =>
            de(void 0, void 0, void 0, function* () {
              var e, i, n;
              t("close", "preclose"),
                yield de(void 0, void 0, void 0, function* () {
                  let e;
                  const t = new Promise((t) => {
                      e = (0, o.YP)(
                        () => $.value,
                ...
                j(!1),
                yield null === (i = (e = k.value).close) || void 0 === i
                  ? void 0
                  : i.call(e, { tempStorageDir: S, document: H }),
                yield null === (n = re.close) || void 0 === n
                  ? void 0
                  : n.call(re, F()),
                t("close", "closed"),
                t("close", "postclose");
          ...
          changePassword: (e) => {
            (E.value = !!e),
              (P.value = null == e ? void 0 : e.password),
              (L.value = null == e ? void 0 : e.passwordHint);
          },
        ...
        return C(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (!o) return { needToClose: !0 };
            {
              ...
              if (e) return yield T(e, t, i, n);
            }
            throw e;
          }
        });
      }
      function T(e, t, i = null, n) {
        var o, a;
        return C(this, void 0, void 0, function* () {
          let r = null;
          try {
            ...
            (d.src = e),
              d.addEventListener("load", () => {
                window.requestIdleCallback(
                  () =>
                    v(void 0, void 0, void 0, function* () {
                      const e = yield (0, p.mi)(d.width, d.height, t);
                      (r.width = d.width * e),
                        (r.height = d.height * e),
    ...
    95804: (e, t, i) => {
      ...
      function d(e, t) {
        const i = (0, o.gP)(),
          n = (e.pageSizes && e.pageSizes[t]) || e.pageSize,
          a = (e.pageSizes && e.pageSizes[t].orientation) || e.orientation,
          r = {
            x: "portrait" === a ? n.x : n.y,
            y: "portrait" === a ? n.y : n.x,
          };
        return {
          orientation: a,
          targetPage: r,
        ...
        return r(this, void 0, void 0, function* () {
          ...
          "actualSize" == e.scale
            ? Object.keys(t).forEach((i) => {
                const o = t[i];
                s.forSheets[i] = [];
                const { orientation: a, targetPage: l, pageSize: c } = d(e, i),
                  h = Math.ceil(o.width / c.x),
                  p = Math.ceil(o.height / c.y),
                  m = (h * c.x - o.width) / 2,
                  v = (p * c.y - o.height) / 2;
                for (let t = 0; t < p; t++)
                  for (let d = 0; d < h; d++) {
                    const h = "print_" + (0, n.hb)();
                    s.forSheets[i].push(h),
                      (u[h] =
                        `@page{\n            size:${l.x}mm ${l.y}mm ${a};\n              }`);
                    const p = o.data.cloneNode(!0);
                    p.setAttribute(
                      "viewBox",
                      d * c.x - m + " " + (t * c.y - v) + " " + c.x + " " + c.y,
                    ),
            ...
            : Object.keys(t).forEach((i) => {
                const o = t[i];
                s.forSheets[i] = [];
                const { orientation: a, targetPage: c, pageSize: h } = d(e, i),
                  p = "print_" + (0, n.hb)();
                s.forSheets[i].push(p),
                  (u[p] =
                    `@page{\n        size:${c.x}mm ${c.y}mm ${a};\n            }`);
                const m = o.data;
                if (
                  ...
                  const t = (function (e, t) {
                    ...
                    p + "-footer",
                    Math.floor(((e.margins.bottom - 2) * l.y) / 25.4),
                  );
        ...
        return r(this, void 0, void 0, function* () {
          ...
          Object.keys(t).forEach((i) => {
            ...
            const a = (e.pageSizes && e.pageSizes[i]) || e.pageSize,
              ...
              u = "portrait" === c ? a.x : a.y,
              h = "portrait" === c ? a.y : a.x,
              p = {
                x: Math.round(
    ...
    10102: (e, t, i) => {
          ...
          (0, y.$)().isOutlinerMode
            ...
            : yield (function (e) {
                return b(this, void 0, void 0, function* () {
                  const t =
                      s().parse(window.location.search.slice(1)).editorId || "",
                    { sheets: i, activeSheetId: n } = (0, f.nZ)(),
                  ...
                  Object.assign(C, { withFooter: !0, boundaryFillNone: !1 });
                  const w = {};
                  if ("currentMap" === C.content) {
                    let t = yield S(n.value, {
                      scopeTopicId: e,
                      opaqueBackground: y,
                  ...
                  const T = yield (0, v.k6)(C, w);
                  T &&
                    x(C, () => {
                      setTimeout(() => {
                        T.clean(), (0, m.Rg)().addRateMasValue(10);
                      }, 500);
                    });
                });
              })(e);
      ...
      const S = (e, t) =>
          b(void 0, void 0, void 0, function* () {
            ...
            const { getSheetViewer: n, sheets: o } = (0, f.nZ)(),
              a = n(e),
        ...
        M = (e, t, i) => {
          const { pageSize: n } = (0, v.UM)(e, t),
            o = Math.min(n.x / i.width, n.y / i.height);
          return (n.y - i.height * o) / 2 / o;
        };
      const x = (e, t) =>
          b(void 0, void 0, void 0, function* () {
            const i = H(),
            ...
            null !== (t = r.fillColor) && void 0 !== t
              ...
              : (function (e) {
                  ...
                  }
                  {
                    ...
                    return (null === (d = null == t ? void 0 : t.theme) ||
                    void 0 === d
                      ? void 0
                      : d.map) && "fillColor" in t.theme.map
                      ? null ===
                          (s =
                            null === (l = null == t ? void 0 : t.theme) ||
                            void 0 === l
                              ? void 0
                              : l.map) || void 0 === s
                        ? void 0
    ...
    21029: (e, t, i) => {
      ...
      const d = (0, n.Q_)("workbench", () => {
        ...
        return {
          ...
          iconPanelTab: v,
          isIconPanelVisible: f,
          updateIconPanel: ({ visible: e, tab: t }) => {
            "boolean" == typeof e && (f.value = e), t && (v.value = t);
          },
          isRightbarVisible: g,
          rightBarPanel: C,
          rightPanelTab: y,
          ...
          userSelectedColorThemeTab: T,
          updateUserSelectedColorThemeTab: (e) => {
            T.value = e;
          },
          popoverEditorVisible: k,
      ...
      const I = (0, w.ZP)("illustration"),
        S = () => {
          const { illustrationModule: e, createXapUrl: t } = (0, d.nZ)(),
            ...
            u = (0, n.iH)(!1),
            h = (0, n.iH)(0),
            m = (0, n.Fl)(() => (0, a.S)().language),
            g = (0, n.Fl)(() => {
              const {
                getLocalIllustrationsContent: t,
                getLocalI18nContent: i,
                getTranslatedIllustrationsContent: n,
              } = e;
              let o = s.value;
              0 === o.length && (o = t());
              return n(o, i(), m.value);
            }),
            w = (0, n.Fl)(() => {
            ...
            S = (0, n.Fl)(() => {
              ...
              return t(l.value, g.value);
            }),
            M = (0, n.Fl)(() => {
              if (!r.value) return [];
              const { searchIllustrationsByTag: t } = e;
              return t(r.value, g.value, l.value);
            }),
            x = (0, n.Fl)(() => w.value.find((e) => e.id === l.value)),
            H = (e) => {
              u.value = e;
            },
            E = p()((e) => {
            ...
            P = (e, t) => {
              ...
              switch (t) {
                case "add":
                  i = Array.from(new Set(c.value.concat(e)));
                  break;
                case "remove":
                  i = c.value.filter((t) => t !== e);
              }
              c.value = i;
            },
            L = (e, t) =>
              k(void 0, void 0, void 0, function* () {
                const n = v().join(i, e);
                yield C().ensureDir(v().dirname(n)), yield C().writeFile(n, t);
              });
          return {
            illustrationsPath: i,
            illustrationGroups: w,
            illustrationGroupDetails: S,
            illustrationSearchGroups: M,
            illustrationActiveGroupId: l,
            activeIllustrationGroup: x,
            illustrationSearchValue: o,
            debounceIllustrationSearchValue: r,
            hasIllustrationLoadFaild: u,
            downloadingIllustrations: c,
            getAllIllustrationsContent: () =>
              k(void 0, void 0, void 0, function* () {
                try {
                  const e = yield y.ZP.fetch(f.lf.FETCH_ILLUSTRATIONS);
                  (s.value = e),
                    yield L("all-content.json", JSON.stringify(e)),
                    H(!1);
                } catch (t) {
                  I.error(t);
                  const n = v().join(i, "all-content.json");
                  if (C().existsSync(n)) {
                    const t = yield ((e = "all-content.json"),
                      k(void 0, void 0, void 0, function* () {
                        const t = v().join(i, e);
                        return yield C().readFile(t);
                      })),
            ...
            changeImage: (e) =>
              k(void 0, void 0, void 0, function* () {
                if ("pro" === e.license) {
                  if (!(yield y.ZP.fetch(f.Gy, "action.changeIllustration")))
                    return void (0, T.Zk)(e.id);
                }
                const n = `${e.hash}.png`,
                  o = v().join(i, "original", n);
                if (
                  "server" === e.host &&
                  !C().existsSync(o) &&
                  !c.value.includes(e.id)
                )
                  try {
                    P(e.id, "add");
                    const t = yield y.ZP.fetch(f.lf.DOWNLOAD_ILLUSTRATION, {
                      hash: e.hash,
                    });
                    yield L(v().join("original", n), t), P(e.id, "remove");
                  } catch (t) {
                    I.error(t), H(!0), P(e.id, "remove");
                  }
                const r = yield t("local" === e.host ? e.relativeResource : o);
                (0, a.JX)().handleCommand("editor.changeImage", { value: r }),
                  (0, T.p3)(e.id);
              }),
            changeIllustrationSearchValue: (e) => {
              "" === e && "" === l.value && H(!1), (o.value = e), E(e);
            },
            changeIllustrationActiveGroupId: (e) =>
              k(void 0, void 0, void 0, function* () {
                "" === e
                  ? (H(!1),
                    setTimeout(() => {
                      document
                        ...
                        .scrollTo({ top: h.value });
                    }))
                  : ((h.value = document.querySelector(
            ...
            changeHasIllustrationLoadFaild: H,
            saveIllustrationsFile: L,
            onDragStart: (e, t, i) => {
  ...
  (e) => {
    e.O(0, [2768, 219, 2079, 5734, 1505], () => {
      return (t = 47680), e((e.s = t));
      var t;
    });
    var t = e.O();
    module.exports = t;
