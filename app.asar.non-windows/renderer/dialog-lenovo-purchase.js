/*! For license information please see dialog-lenovo-purchase.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [4587],
  {
    ...
    34931: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".uk-win32 .uk-window-dialog[data-v-31ae3b3a] ::-webkit-scrollbar-track {\n  margin: 43px 0 0 0;\n}\n.lenovo-purchase-content[data-v-31ae3b3a] {\n  padding: 64px;\n  overflow: hidden;\n}\n.purchase-info-text[data-v-31ae3b3a] {\n  line-height: 16px;\n  white-space: nowrap;\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    75070: (t, e, n) => {
      ...
      const u = (0, r.aZ)({
        __name: "app",
        setup(t) {
          const e = (0, r.Fl)(() => (0, o.S)().language),
            n = (0, r.iH)(""),
            i = (0, r.iH)({
              autorenew: 0,
              formattedPrice: 0,
              formattedPricePerMonth: 0,
            }),
            u = (0, r.iH)({ orderHash: "", orderNumber: 0 });
          let f = null;
          const d = () =>
              A(this, void 0, void 0, function* () {
                var t;
                if (u.value.orderHash)
                  try {
                    const e = yield l.ZP.fetch(c.lf.LENOVO_GET_ORDER_STATUS, {
                      orderHash: u.value.orderHash,
                    });
                    0 ===
                      (null === (t = null == e ? void 0 : e.order) ||
                      void 0 === t
                        ? void 0
                        : t.status) &&
                      ((0, a.L9)({
                        eventAction: "subscriptionSuccessFromLenovo",
            ...
            p = () => {
              const t = (0, s.R)(window.location.search);
              (i.value = JSON.parse(t.product)),
                (n.value = t.payQr),
                (u.value.orderHash = t.orderHash),
                (u.value.orderNumber = t.orderNumber),
                (0, a.L9)({
                  eventAction: "showLenovoPaymentDialog",
                  eventName: "showPaymentDialog",
                }),
                (f = setInterval(d, 2e3));
            };
          return (
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-window-body uk-flex uk-flex-column uk-flex-middle lenovo-purchase-content",
                },
                [
                  e(
                    "h1",
                    {
                      staticClass: "uk-text-bold uk-text-lead",
                      staticStyle: {
                        "font-size": "34px",
                        "margin-bottom": "40px",
                      },
                  ...
                  e(
                    "div",
                    { staticClass: "uk-flex", staticStyle: { width: "100%" } },
                    [
                      e("div", { staticClass: "uk-form-label" }, [
                        t._v("\n        " + t._s(t.$T("Product")) + "\n      "),
                      ]),
                      t._v(" "),
                      e(
                        ...
                        {
                          staticClass:
                            "uk-form-label purchase-info-text uk-margin-auto-left",
                        },
                        [
                          t._v(
                            "\n        " +
                              t._s(t.$T("Xmind Pro (Desktop + Mobile)")) +
                              "\n      ",
                          ),
                        ],
                      ),
                  ...
                  t._v(" "),
                  e("hr", { staticStyle: { width: "100%" } }),
                  t._v(" "),
                  e(
                    "div",
                    {
                      staticClass: "uk-flex uk-form-label purchase-info-text",
                    ...
                    [
                      ...
                      t._v(" "),
                      e("div", { staticClass: "uk-flex uk-margin-auto-left" }, [
                        0 === n.product.extend
                          ? e("div", [
                              t._v(
                                "\n          " +
                                  t._s(n.product.formattedPrice) +
                                  " / " +
                                  t._s(t.$T("Month")) +
                                  "\n        ",
                              ),
                        ...
                        12 === n.product.extend
                          ...
                          : t._e(),
                        t._v(" "),
                        1 === n.product.autorenew
                          ? e("div", [
                              t._v(
                                "\n           " +
                                  t._s(t.$T("Auto-renewal")) +
                                  "\n        ",
                              ),
                            ])
                          : t._e(),
                    ...
                    [
                      e(
                        ...
                        [
                            ...
                            [
                              t._v(
                                "\n          1." +
                                  t._s(
                                    t.$T(
                                      "Please don't scan the QR code more than once to avoid additional deductions.",
                                    ),
                                  ) +
                                  "\n          ",
                              ),
                              ...
                              t._v(
                                "\n          2." +
                                  t._s(
                                    t.$T(
                                      "After payment, please wait patiently for the result of the payment, and don't close the order page before the result is returned.",
                                    ),
                                  ) +
                                  "\n          ",
                              ),
                              ...
                              t._v(
                                "\n          3." +
                                  t._s(
                                    t.$T(
                                      "This payment is made through Lenovo App Store, please contact Lenovo App Store customer service if you have any questions about invoicing or refund.",
                                    ),
                                  ) +
                                  "\n        ",
                              ),
                          ...
                          e(
                            "div",
                            { staticClass: "uk-flex uk-margin-auto-top" },
                            [
                              "zh-CN" !== n.currentLanguage
                                ? e("img", {
                                    staticClass: "uk-margin-xsmall-right",
                                    attrs: {
                                      src: t.$toResourceURL(
                                        "static/assets/images/dialog-lenovo-purchase/alipay-en.svg",
                                      ),
                                    },
                                  })
                                : t._e(),
                              ...
                              "zh-CN" === n.currentLanguage
                                ? e("img", {
                                    ...
                                    attrs: {
                                      src: t.$toResourceURL(
                                        "static/assets/images/dialog-lenovo-purchase/alipay-cn.svg",
                                      ),
                                    },
                                  })
                                : t._e(),
                              ...
                              1 !== n.product.autorenew
                                ? e("img", {
                                    attrs: {
                                      src: t.$toResourceURL(
                                        "static/assets/images/dialog-lenovo-purchase/wechatpay-en.svg",
                                      ),
                                    },
                                  })
                                : t._e(),
                              ...
                              1 !== n.product.autorenew
                                ? e("img", {
                                    ...
                                    attrs: {
                                      src: t.$toResourceURL(
                                        "static/assets/images/dialog-lenovo-purchase/wechatpay-cn.svg",
                                      ),
                                    },
                                  })
                                : t._e(),
                      ...
                      e(
                        ...
                        {
                          staticClass:
                            "uk-flex uk-flex-column uk-flex-middle uk-margin-large-left",
                        ...
                        [
                          ...
                          e(
                            ...
                            {
                              staticClass:
                                "uk-form-label uk-margin-large-bottom",
                            },
                            [
                              t._v(
                                "\n          " +
      ...
      (0, i.Z)(f, { name: "dialog-lenovo-purchase" });
    },
    4075: (t, e, n) => {
      "use strict";
      n.d(e, { R: () => r });
