/*! For license information please see dialog-file-cache.js.LICENSE.txt */
  ...
  [1584],
  {
    ...
    27028: (t, e, n) => {
      ...
      const A = {
        mixins: [a.Z],
        data: function () {
          return { selectedFileCacheId: null };
        },
        computed: {
          ...(0, c.rn)(l.yj, { fileCacheItems: (t) => t.fileCacheItems }),
          touchBarItems() {
            return [
              { type: "space", size: "flexible" },
              {
                type: "button",
                label: this.$T("Clear Cache"),
                click: "removeAll",
              },
              { type: "space", size: "flexible" },
              { type: "button", label: this.$T("Close"), click: "close" },
              null !== this.selectedFileCacheId
                ? {
                    type: "button",
                    label: this.$T("Retrieve"),
        ...
        methods: {
          ...
          open() {
            if (null === this.selectedFileCacheId) return;
            let t = this.getFileCacheItem(this.selectedFileCacheId),
              e = t.firstSnapshotId;
            if (t.snapshots.length > 0) {
              e = t.snapshots.pop().id;
            }
            (0, l.JX)().handleCommand("restoreSnapshot", {
              ...
              (0, o.L9)({
                ...
                eventAction: "retrieve",
              });
          },
          remove() {
            s.ZP.fetch(r.S5, {
              action: "fileCache",
              fileCacheId: this.selectedFileCacheId,
            });
          },
          removeAll() {
            s.ZP.fetch(r.S5, { action: "all" });
          },
          getFileCacheItem(t) {
            return this.fileCacheItems.find((e) => e.fileCacheId === t);
          },
          formatDate(t) {
            const e = new Date(t);
            let n = e.getMinutes();
            return (
              n < 10 && (n = "0" + n),
              `${e.getFullYear()}-${e.getMonth() + 1}-${e.getDate()} ${e.getHours()}:${n}`
            );
          },
        },
      };
          ...
          return e(
            ...
            [
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-window-body uk-flex uk-flex-column uk-padding-large uk-padding-remove-bottom",
                },
                [
                  e("div", [
                    t._v(
                      "\n      " +
                        t._s(
                          t.$T(
                            "File Cache will auto backup your edited xmind files on this device.",
                          ),
                        ) +
                        "\n    ",
                    ),
                  ...
                  e(
                    ...
                    {
                      staticClass:
                        "uk-panel-scrollable uk-margin uk-margin-large-top uk-padding-remove uk-height-expand uk-background-default",
                    },
                    [
                      e(
                        "table",
                        {
                          staticClass:
                            "uk-table uk-table-hover uk-table-small uk-table-striped",
                        },
                        [
                          e(
                            "tbody",
                            t._l(
                              t.fileCacheItems.slice().reverse(),
                              function (n, i) {
                                return e(
                                  "tr",
                                  {
                                    ...
                                    on: {
                                      click: function (e) {
                                        t.selectedFileCacheId = n.fileCacheId;
                                      },
                                    },
                                  },
                                  [
                                          ...
                                          directives: [
                                            {
                                              name: "model",
                                              rawName: "v-model",
                                              value: t.selectedFileCacheId,
                                              expression: "selectedFileCacheId",
                                            },
                                          ],
                                    ...
                                    e(
                                      ...
                                      {
                                        staticClass:
                                          "uk-table-shrink uk-text-nowrap",
                                      },
                                      [
                                        t._v(
                                          "\n              " +
                                            t._s(t.formatDate(n.timestamp)) +
                                            "\n            ",
                                        ),
                                      ],
                                    ),
                ...
                e("div", { staticClass: "uk-button-group" }, [
                  e(
                    "button",
                    {
                      ...
                      attrs: { disabled: null === t.selectedFileCacheId },
                      on: { click: t.open },
                    },
                    [t._v("\n        " + t._s(t.$T("Retrieve")) + "\n      ")],
                  ),
      ...
      (0, i.Z)(u, { name: "dialog-file-cache" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
