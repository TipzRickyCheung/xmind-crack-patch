/*! For license information please see video-viewer.js.LICENSE.txt */
  ...
  [5475],
  {
      ...
      t.exports = (function (t) {
        ...
        function (t, e, n) {
          ...
          e.a = function (t, e, n, i, r, o, s, a) {
            ...
            if (
              (e &&
                ((A.render = e), (A.staticRenderFns = n), (A._compiled = !0)),
              i && (A.functional = !0),
          ...
          var l = (s.MD5 = o.extend({
            ...
            _doProcessBlock: function (t, e) {
              ...
              var o = this._hash.words,
                ...
                j = o[3];
              (C = A(C, _, x, j, s, 7, a[0])),
                (j = A(j, C, _, x, l, 12, a[1])),
                (x = A(x, j, C, _, d, 17, a[2])),
                (_ = A(_, x, j, C, p, 22, a[3])),
                (C = A(C, _, x, j, h, 7, a[4])),
                (j = A(j, C, _, x, g, 12, a[5])),
                (x = A(x, j, C, _, y, 17, a[6])),
                (_ = A(_, x, j, C, m, 22, a[7])),
                (C = A(C, _, x, j, v, 7, a[8])),
                (j = A(j, C, _, x, w, 12, a[9])),
                (x = A(x, j, C, _, M, 17, a[10])),
                (_ = A(_, x, j, C, I, 22, a[11])),
                (C = A(C, _, x, j, B, 7, a[12])),
                (j = A(j, C, _, x, b, 12, a[13])),
                (x = A(x, j, C, _, E, 17, a[14])),
                (C = c(
                  C,
                  (_ = A(_, x, j, C, N, 22, a[15])),
                  x,
                  j,
                  l,
                  5,
                ...
                (j = c(j, C, _, x, y, 9, a[17])),
                (x = c(x, j, C, _, I, 14, a[18])),
                (_ = c(_, x, j, C, s, 20, a[19])),
                (C = c(C, _, x, j, g, 5, a[20])),
                (j = c(j, C, _, x, M, 9, a[21])),
                (x = c(x, j, C, _, N, 14, a[22])),
                (_ = c(_, x, j, C, h, 20, a[23])),
                (C = c(C, _, x, j, w, 5, a[24])),
                (j = c(j, C, _, x, E, 9, a[25])),
                (x = c(x, j, C, _, p, 14, a[26])),
                (_ = c(_, x, j, C, v, 20, a[27])),
                (C = c(C, _, x, j, b, 5, a[28])),
                (j = c(j, C, _, x, d, 9, a[29])),
                (x = c(x, j, C, _, m, 14, a[30])),
                (C = u(
                  C,
            ...
            _doFinalize: function () {
              ...
              (n[15 + (((r + 64) >>> 9) << 4)] =
                ...
                this._process();
              for (var a = this._hash, l = a.words, A = 0; A < 4; A++) {
                var c = l[A];
                l[A] =
                  (16711935 & ((c << 8) | (c >>> 24))) |
                  (4278255360 & ((c << 24) | (c >>> 8)));
    ...
    69413: (t, e, n) => {
      ...
      var i = n(51505),
        ...
        c = n.n(A);
      const u =
        '{"v":"5.8.1","fr":60,"ip":0,"op":71,"w":480,"h":480,"nm":"合成 1","ddd":0,"assets":[],"layers":[{"ddd":0,"ind":1,"ty":4,"nm":"形状图层 1","sr":1,"ks":{"o":{"a":0,"k":100,"ix":11},"r":{"a":0,"k":0,"ix":10},"p":{"a":0,"k":[240,240,0],"ix":2,"l":2},"a":{"a":0,"k":[0,0,0],"ix":1,"l":2},"s":{"a":0,"k":[50,50,100],"ix":6,"l":2}},"ao":0,"shapes":[{"ty":"gr","it":[{"d":1,"ty":"el","s":{"a":0,"k":[480,480],"ix":2},"p":{"a":0,"k":[0,0],"ix":3},"nm":"椭圆路径 1","mn":"ADBE Vector Shape - Ellipse","hd":false},{"ty":"st","c":{"a":0,"k":[1,1,1,1],"ix":3},"o":{"a":0,"k":100,"ix":4},"w":{"a":0,"k":40,"ix":5},"lc":2,"lj":1,"ml":4,"bm":0,"nm":"描边 1","mn":"ADBE Vector Graphic - Stroke","hd":false},{"ty":"tr","p":{"a":0,"k":[0,0],"ix":2},"a":{"a":0,"k":[0,0],"ix":1},"s":{"a":0,"k":[100,100],"ix":3},"r":{"a":0,"k":0,"ix":6},"o":{"a":0,"k":100,"ix":7},"sk":{"a":0,"k":0,"ix":4},"sa":{"a":0,"k":0,"ix":5},"nm":"变换"}],"nm":"椭圆 1","np":3,"cix":2,"bm":0,"ix":1,"mn":"ADBE Vector Group","hd":false},{"ty":"tm","s":{"a":1,"k":[{"i":{"x":[0.295],"y":[1]},"o":{"x":[0.705],"y":[0]},"t":13,"s":[0]},{"t":70,"s":[99.9]}],"ix":1},"e":{"a":1,"k":[{"i":{"x":[0.295],"y":[1]},"o":{"x":[0.705],"y":[0]},"t":0,"s":[0.1]},{"t":70,"s":[100]}],"ix":2},"o":{"a":0,"k":0,"ix":3},"m":1,"ix":2,"nm":"修剪路径 1","mn":"ADBE Vector Filter - Trim","hd":false}],"ip":0,"op":600,"st":0,"bm":0}],"markers":[]}';
      var f = n(2954),
        d = function (t, e, n, i) {
      ...
      const p = (0, f.aZ)({
        setup() {
          const t = o().parse(window.location.search.slice(1)),
            e = (0, f.iH)(t.url),
            n = (0, f.iH)(),
            i = (0, f.iH)(),
            r = (0, f.iH)("loading");
          ...
          let A = s.ZP.route(a.Tb, ({ url: t }) =>
            d(this, void 0, void 0, function* () {
              (0, l.getCurrentWindow)().show(),
                t === e.value
                  ? "failed" === r.value && (r.value = "loading")
                  : (r.value = "loading"),
                (e.value = t);
            }),
          );
          return (
            ...
            }),
            {
              ...
              reload: () => {
                (r.value = "loading"),
                  n.value.contentWindow.location.replace(e.value);
              },
              handleLoad: () => {
                "failed" !== r.value && (r.value = "loaded");
              },
            }
          );
        },
      ...
      const h = (0, n(51900).Z)(
        ...
        function () {
          ...
          return e(
            "div",
            {
              staticClass: "uk-window uk-window-default",
              attrs: { id: "app" },
            },
            [
              e(
              ...
              e(
                "div",
                {
                  staticClass: "uk-window-body uk-overflow-hidden",
                ...
                [
                  e(
                    "div",
                    {
                      ...
                      staticClass: "uk-height-1-1 uk-width-1-1",
                    },
                    [
                      e("div", {
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: "failed" === t.status,
                          expression: "status === 'failed'",
                        },
                      ],
                      staticClass: "uk-position-absolute uk-position-center",
                      ...
                      e(
                        ...
                        [
                          e("img", {
                            ...
                            attrs: {
                              src: t.$toResourceURL(
                                "static/assets/images/warning.svg",
                              ),
                            },
                          }),
                          t._v(" "),
      ...
      (0, i.Z)(h, { name: "video-video-viewer" });
    },
    30266: (t, e, n) => {
      "use strict";
      function i(t, e, n) {
    ...
    77760: (t) => {
      ...
      function d(t) {
        return null == t
          ? ""
          : Array.isArray(t) || (c(t) && t.toString === A)
      ...
      function Nt(t, e, i, r, o, s) {
        ...
        const A = l && l.get,
          c = l && l.set;
        (A && !c) || (i !== wt && 2 !== arguments.length) || (i = t[e]);
        let u = !o && Et(i, !1, s);
        return (
          Object.defineProperty(t, e, {
            enumerable: !0,
      ...
      function Kt(t, e, n, r, s, a) {
        ...
        for (l in t)
          (A = t[l]),
            ...
            i(A) ||
              (i(c)
                ? (i(A.fns) && (A = t[l] = Wt(A, a)),
                  o(u.once) && (A = t[l] = s(u.name, A, u.capture)),
                  n(u.name, A, u.capture, u.passive, u.params))
                : A !== c && ((c.fns = A), (t[l] = c)));
      ...
      function qt(t) {
        return s(t) ? [At(t)] : n(t) ? ee(t) : void 0;
      }
      function te(t) {
            ...
            i(A) ||
              ...
              n(A)
                ? A.length > 0 &&
                  ...
                  te(A[0]) &&
                    te(u) &&
                    ((a[c] = At(u.text + A[0].text)), A.shift()),
                  a.push.apply(a, A))
                : s(A)
                  ? te(u)
                    ? (a[c] = At(u.text + A))
                    : "" !== A && a.push(At(A))
                  : te(A) && te(u)
                    ? (a[c] = At(u.text + A.text))
                    : (o(t._isVList) &&
                        r(A.tag) &&
                        i(A.key) &&
                        r(e) &&
                        (A.key = `__vlist${e}_${l}__`),
                      a.push(A)));
        return a;
      }
      function ne(t, e) {
        ...
        if (n(t) || "string" == typeof t)
          for (A = new Array(t.length), i = 0, o = t.length; i < o; i++)
            A[i] = e(t[i], i);
        else if ("number" == typeof t)
          for (A = new Array(t), i = 0; i < t; i++) A[i] = e(i + 1, i);
        else if (l(t))
          if (it && t[Symbol.iterator]) {
            A = [];
            const n = t[Symbol.iterator]();
            let i = n.next();
            for (; !i.done; ) A.push(e(i.value, A.length)), (i = n.next());
          } else
            for (
              s = Object.keys(t), A = new Array(s.length), i = 0, o = s.length;
              i < o;
              i++
            )
              (a = s[i]), (A[i] = e(t[a], a, i));
      ...
      function Te(t, e, i, A, c, u) {
        return (
          (n(i) || s(i)) && ((c = A), (A = i), (i = void 0)),
          o(u) && (c = 2),
          (function (t, e, i, o, s) {
      ...
      var nn = Object.freeze({
        ...
        computed: function (t, e) {
          ...
          const o = tt() ? null : new An(ot, n, j, { lazy: !0 }),
            s = {
              effect: o,
              get value() {
                return o
      ...
      function kn(t, i, r, s, a) {
        ...
        (this.data = t),
          ...
          l._scopeId
            ? (this._c = (t, e, i, r) => {
                const o = Te(A, t, e, i, r, u);
                return (
                  o && !n(o) && ((o.fnScopeId = l._scopeId), (o.fnContext = s)),
                  o
                );
              })
            : (this._c = (t, e, n, i) => Te(A, t, e, n, i, u));
      }
      ...
      const Qn = {
          ...
          prepatch(t, n) {
            ...
            !(function (t, n, i, r, o) {
              ...
              let A = !!(o || t.$options._renderChildren || l);
              const c = t.$vnode;
      ...
      function Rn(t, s, a, A, c) {
        ...
        if (o(t.options.functional))
          return (function (t, i, o, s, a) {
            const l = t.options,
              A = {},
              c = l.props;
            if (r(c)) for (const t in c) A[t] = Wn(t, c, i || e);
            else r(o.attrs) && Sn(A, o.attrs), r(o.props) && Sn(A, o.props);
            const u = new kn(o, A, a, s, t),
        ...
        return new at(
          ...
          void 0,
          a,
          { Ctor: t, propsData: p, listeners: h, tag: c, children: A },
          d,
        );
      }
      function Yn(t, e) {
        ...
        for (let a = 0; a < s.length; a++)
          (i = s[a]),
            "__ob__" !== i &&
              ((r = t[i]),
              (o = e[i]),
              n && v(t, i) ? r !== o && c(r) && c(o) && Un(r, o) : Ct(t, i, o));
        return t;
      }
      function Gn(t, e, n) {
        return n
        ...
        e.computed &&
          (function (t, e) {
            ...
            for (const r in e) {
              const o = e[r],
                s = a(o) ? o : o.get;
              i || (n[r] = new An(t, s || j, j, ii)), r in t || ri(t, r, o);
            }
          })(t, e.computed),
          e.watch &&
            e.watch !== Z &&
      ...
      function fi(t, e) {
        return n(t)
          ...
          : "string" == typeof t
            ? t.split(",").indexOf(e) > -1
            : ((i = t), "[object RegExp]" === A.call(i) && t.test(e));
        var i;
      }
      function di(t, e) {
        ...
        t.prototype._init = function (t) {
          ...
          (n._uid = li++),
            ...
            t && t._isComponent
              ...
              : (n.$options = Hn(Ai(n.constructor), t || {}, n)),
            (n._renderProxy = n),
            (n._self = n),
            (function (t) {
              const e = t.$options;
      ...
      !(function (t) {
        ...
        Object.defineProperty(ci, "FunctionalRenderContext", { value: kn }),
        (ci.version = "2.7.14");
      ...
      function Ki(t, e) {
        ...
        for (s in ((r(u.__ob__) || o(u._v_attr_proxy)) &&
          (u = e.data.attrs = _({}, u)),
        u))
          (a = u[s]), (l = c[s]), l !== a && Zi(A, s, a, e.data.pre);
        for (s in ((P || J) && u.value !== c.value && Zi(A, "value", u.value),
        c))
          i(u[s]) &&
            (Bi(s)
              ? A.removeAttributeNS(Ii, bi(s))
              : vi(s) || A.removeAttribute(s));
      }
      function Zi(t, e, n, i) {
      ...
      function cr(t, e) {
        ...
        const a = e.elm,
          l = t.data.domProps || {};
        let A = e.data.domProps || {};
        for (n in ((r(A.__ob__) || o(A._v_attr_proxy)) &&
          (A = e.data.domProps = _({}, A)),
        l))
          n in A || (a[n] = "");
        for (n in A) {
          if (((s = A[n]), "textContent" === n || "innerHTML" === n)) {
          ...
          if ("value" === n && "PROGRESS" !== a.tagName) {
            ...
            (Ar = Ar || document.createElement("div")),
              (Ar.innerHTML = `<svg>${s}</svg>`);
            const t = Ar.firstChild;
      ...
      function zr(t, e) {
        ...
        return (
          "transition" === e
            ? o > 0 && ((A = "transition"), (c = o), (u = r.length))
            : "animation" === e
              ? l > 0 && ((A = "animation"), (c = l), (u = a.length))
              : ((c = Math.max(o, l)),
                (A = c > 0 ? (o > l ? "transition" : "animation") : null),
                (u = A ? ("transition" === A ? r.length : a.length) : 0)),
          {
            type: A,
            timeout: c,
            propCount: u,
            hasTransform: "transition" === A && Yr.test(n[jr + "Property"]),
          }
        );
      }
      function Fr(t, e) {
      ...
      function Gr(t, e) {
        ...
        const x = _ && d ? d : c,
          ...
          z = (n._enterCb = O(() => {
            R && (Lr(n, T), Lr(n, j)),
              z.cancelled ? (R && Lr(n, x), Q && Q(n)) : S && S(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
          ...
          R &&
            ...
            Or(() => {
              Lr(n, x),
                z.cancelled ||
                  (Qr(n, T), Y || ($r(L) ? setTimeout(z, L) : Rr(n, A, z)));
            })),
        ...
        const {
          ...
          I = (n._leaveCb = O(() => {
            n.parentNode &&
              ...
              v && (Lr(n, c), Lr(n, u)),
              I.cancelled ? (v && Lr(n, A), g && g(n)) : (e(), h && h(n)),
              (n._leaveCb = null);
          }));
        function B() {
          I.cancelled ||
            ...
            v &&
              ...
              Or(() => {
                Lr(n, A),
                  I.cancelled ||
                    (Qr(n, c), w || ($r(M) ? setTimeout(I, M) : Rr(n, a, I)));
              })),
            d && d(n, I),
            v || w || I());
        }
      ...
      const Jr = (function (t) {
        let e, a;
        const l = {},
          { modules: A, nodeOps: c } = t;
        for (e = 0; e < zi.length; ++e)
          for (l[zi[e]] = [], a = 0; a < A.length; ++a)
            r(A[a][zi[e]]) && l[zi[e]].push(A[a][zi[e]]);
        function u(t) {
          const e = c.parentNode(t);
          r(e) && c.removeChild(e, t);
        }
        function f(t, e, n, i, s, a, A) {
          if (
            (r(t.elm) && r(a) && (t = a[A] = ct(t)),
            (t.isRootInsert = !s),
            (function (t, e, n, i) {
              let s = t.data;
              if (r(s)) {
                        ...
                        : Fi(g, v)
                          ...
                          : Fi(y, M)
                            ...
                            : Fi(g, M)
                              ...
                              : Fi(y, v)
                                ? (E(y, v, o, n, p),
                                  B && c.insertBefore(t, y.elm, g.elm),
                                  (y = e[--h]),
                                  (v = n[++p]))
                                : (i(a) && (a = Ui(e, d, h)),
                                  ...
                                  i(l)
                                    ...
                                    : ((A = e[l]),
                                      Fi(A, v)
                                        ? (E(A, v, o, n, p),
                                          (e[l] = void 0),
                                          B && c.insertBefore(t, A.elm, g.elm))
                                        : f(v, o, t, g.elm, !1, n, p)),
                                  (v = n[++p]));
                  d > h
        ...
        function _(t, e, n, i) {
          let s;
          const { tag: a, data: l, children: A } = e;
          if (
            ((i = i || (l && l.pre)),
            (e.elm = t),
        ...
        return function (t, e, n, s) {
          ...
          if (i(t)) (a = !0), f(e, A);
            ...
            if (!i && Fi(t, e)) E(t, e, A, null, null, s);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
              ...
              const s = t.elm,
                a = c.parentNode(s);
              if (
                (f(e, A, s._leaveCb ? null : a, c.nextSibling(s)), r(e.parent))
              ) {
                let t = e.parent;
                const n = y(e);
                for (; t; ) {
      ...
      (ci.config.mustUseProp = (t, e, n) =>
        ...
        ("checked" === n && "input" === t) ||
        ("muted" === n && "video" === t)),
        (ci.config.isReservedTag = ki),
        (ci.config.isReservedAttr = yi),
    ...
    77412: (t, e, n) => {
      ...
      function y(t, n, r = {}, s, l, A) {
        ...
        return (
          ...
          E && A && r.hydrate && r.hydrate(T.$state, E),
          (w = !0),
          (M = !0),
          T
        );
