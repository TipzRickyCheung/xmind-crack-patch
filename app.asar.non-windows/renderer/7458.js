(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [7458],
  {
    ...
    24983: (e, t, a) => {
      ...
      o.push([
        e.id,
        "#map-shot-modal[data-v-23a31c00] {\n  -webkit-touch-callout: none;\n  -webkit-user-select: none;\n  -khtml-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n@keyframes springish-23a31c00 {\n0.00% {\n    transform: scale(0.9);\n    opacity: 0.3;\n}\n40% {\n    transform: scale(1.1106);\n    opacity: 1;\n}\n80% {\n    transform: scale(0.9591);\n    opacity: 1;\n}\n100.00% {\n    transform: scale(1);\n    opacity: 1;\n}\n}\n.springish[data-v-23a31c00] {\n  animation: springish-23a31c00;\n  animation-duration: 0.5s;\n  animation-timing-function: cubic-bezier(0.445, 0.05, 0.55, 0.95);\n}\n.activation-text[data-v-23a31c00] {\n  margin-top: 8px;\n  font-size: 12px;\n  font-weight: 400;\n  line-height: 14px;\n  letter-spacing: 0.07px;\n}\n.uk-lang-ru-RU .map-shot-save-btn[data-v-23a31c00] {\n  padding: 4px 18px;\n  line-height: 14px;\n}\n",
        "",
      ]);
      const i = o;
    },
    ...
    97952: (e, t, a) => {
      ...
      const s = (0, n.aZ)({
        ...
        setup(e, { emit: t }) {
          ...
          const c = (0, n.Fl)(() => (a.isMultiple ? "multi-color" : a.value)),
            h = () => {
              var e, t;
              if (!d.value) return;
              const a = d.value.$el.querySelector("[uk-popover]");
              null ===
                (t =
            ...
            p = (0, n.Fl)(() => (0, o.km)().recentlyUsedColors);
          return {
            __sfc: !0,
            presetColors: s,
            props: a,
            ...
            popoverHide: () => {
              setTimeout(() => {
                (0, r.U)().updateLastFocusedElementTag(null);
              }, 100);
            },
            recentlyUsedColors: p,
            handleRecentColorChange: (e) =>
              (0, o.km)().updateRecentlyUsedColor(e),
            ColorWell: i.Z,
            colorWall: l.Z,
          };
        },
    ...
    77458: (e, t, a) => {
      ...
      const m = (0, n.aZ)({
        ...
        setup(e, { expose: t, emit: a }) {
          ...
          const W = (0, n.Fl)(() => Math.max(d.value, u.value) + 500),
            R = (0, n.Fl)(() => {
              const e = {
                width: "auto",
                height: "auto",
            ...
            E = (0, n.Fl)({
              ...
              get: () => $.value.find((e) => e.key === x.value),
            }),
            L = (0, n.Fl)(() =>
          ...
          const P = (e) => {
            ...
            N = (e) => {
              ...
              const S = { top: r + u + 14 + 4, left: l },
                C = { bottom: "calc(100% + 8px)", color: "#FFF" };
              if (
                (t.scrollTop + r - 16 <= 0 &&
                  ((C.bottom = "calc(100% - 16px)"),
                  o.backgroundGrayscale > 128 && (C.color = "#333")),
              ...
              (f.style.top = `${S.top}px`),
                ...
                (m.style.bottom = C.bottom);
              const x =
                0 < S.top && S.top + g <= k && -10 < S.left && S.left + b <= y;
              x && w.value && (w.value = !1), x || w.value || (w.value = !0);
            };
          let Z = (e) => {
            const { value: t } = s,
              { value: a } = h;
          ...
          return (
            t({ isShowGoMapShotBar: w, updateMapShotFrameStyle: U }),
            {
              ...
              closeMapShotIcon: A,
              cameraIcon: H,
              commputedBoxShadow: W,
              computedContainerStyle: R,
              frameSizeList: $,
              ...
              onMapShotHandlerDown: (e, t) => {
                ...
                (b.value = i),
                  (k.value = "handler"),
                  (S.value = e.slice()),
                  (C.value = document.querySelector(
      ...
      const x = (0, n.aZ)({
        ...
        components: { ColorPicker: S.Z, WatermarkCheckbox: y.Z },
        setup(e, t) {
                            ...
                            "div",
                            {
                              ...
                              style: {
                                boxShadow: e.checkedShadow
                                  ? `0px 0px ${parseInt(0.4 * e.previewPadding)}px 0px rgba(0, 0, 0, 0.2)`
                                  : "",
                              },
                            },
                            [
      ...
      const { BrowserWindow: I, screen: V, BrowserView: A } = p;
      const H = (e) => (0, k.lF)(e),
        W = class {
          constructor(e) {
            const t = V.getAllDisplays().reduce(
              (e, t) =>
                e
            ...
            (this.window = new I({
              ...
              this.view.webContents.loadURL(
                (0, M.ju)("static/html/map-shot-placeholder.html"),
              ),
                    ...
                    fn: (e) =>
                      T(this, void 0, void 0, function* () {
                        ...
                        const r = Math.ceil(a.width / n.width),
                          ...
                          h = d.match(/scale\(([^,]+),\s*([^)]+)\)/),
                          p = parseFloat(null == h ? void 0 : h[1]),
                          v = parseFloat(null == h ? void 0 : h[2]);
                        for (let t = 0; t < s; t++)
                          for (let a = 0; a < r; a++) {
                            const o = a * n.width,
                              r = t * n.height,
      ...
      class L {
        constructor(e, t) {
          (this.canvas = document.createElement("canvas")),
            ...
            (this.watermarkUrl = (0, M.ju)(
              "static/images/map-shot/watermark-light.svg",
            )),
            (this.watermarkDarkUrl = (0, M.ju)(
        ...
        initCanvas(e) {
          return $(this, void 0, void 0, function* () {
            const {
              ...
              l = i.width < i.height ? "width" : "height",
              r = "width" === l ? "height" : "width",
              s = { width: 400, height: 360 };
            let u = [0, 0, 0, 0];
            t
              ? (u = u.map(() => i[l] * o))
              : a
                ? (u = u.map(
                    () => i[l] * this.shadowBlurRatio * this.shadowBlurRatio,
                  ))
                : n &&
                  (u[2] = i[l] * this.shadowBlurRatio * this.shadowBlurRatio);
            const d = () => i.width + u[1] + u[3],
              c = () => i.height + u[0] + u[2],
              h = { width: d(), height: c() };
            let p = { [r]: s[r], [l]: s[r] * (h[l] / h[r]) };
            (p.width < s.width + 1 && p.height < s.height + 1) ||
              (p = { [l]: s[l], [r]: s[l] * (h[r] / h[l]) });
            const v = p.height * (i.height / h.height);
            let f = null;
            if (n) {
              const e = h.width / p.width,
                a = h.height / p.height;
              (f = this.getAppropriateWatermark(i)),
                f.width > d() &&
                  (u[1] = u[3] = (f.width - i.width) / 2 + 1 * e),
                f.height + u[0] + i.height > c() &&
                  (u[2] = f.height + 2 * a * 2),
                !t &&
                  f.height / u[2] > this.watermarkBottomBorderNoFrameMaxRatio &&
                  (u[2] = f.height / this.watermarkBottomBorderNoFrameMaxRatio);
            }
            let m = null;
            if (a) {
              m = i.height * (this.shadowBlurWidth / v);
              const e = Math.min.apply(null, u);
              m > Math.min.apply(null, u) && (m = e);
            }
            const g = { width: d(), height: c() };
            return (
              (this.canvasScale = yield (0, k.mi)(g.width, g.height)),
              (this.canvas.width = g.width * this.canvasScale),
              (this.canvas.height = g.height * this.canvasScale),
              {
                context: this.canvas.getContext("2d"),
                border: u.map((e) => e * this.canvasScale),
                watermarkSize: {
                  width: (null == f ? void 0 : f.width) * this.canvasScale,
                  height: (null == f ? void 0 : f.height) * this.canvasScale,
                },
                shadowBlur: m * this.canvasScale,
              }
            );
          });
        }
      ...
      const U = (0, n.aZ)({
        ...
        setup(e) {
          ...
          (0, n.bv)(() => {
            q(!1),
              (C.value = new W({ currentBrowserWindowId: window.id })),
              f.$el.focus(),
              (oe = ne());
          }),
            (0, n.Jd)(() => {
              q(!0), C.value.destroy(), oe && oe(), le();
            });
          const I = (0, n.Fl)(() => (0, b.S)().appearance),
            V = (0, n.Fl)(() =>
              (0, P.E)().getZoomScaleForSheet((0, O.nZ)().activeSheetId.value),
            ),
            A = (0, n.Fl)(() => (0, b.tP)().screenshot.size || t),
            R = (0, n.Fl)(() => (0, b.tP)().screenshot.rate || a),
            $ = (0, n.Fl)(() => (0, O.nZ)().editorContainer.value),
            E = (0, n.Fl)(() => {
            ...
            X = (0, n.Fl)(() => {
              ...
              return (
                ...
                { bottom: `${30 + t}px`, right: `${t}px`, top: `${N.value}px` }
              );
            }),
            G = (0, n.Fl)(() => {
              var e, t, a, n;
            ...
            j = (0, n.Fl)(() => {
              const { sheets: e, activeSheetId: t } = (0, O.nZ)(),
                a = e.value.findIndex((e) => e.id === t.value);
              if (a < 0) return;
              const n = $.value.children[a];
              return n || null;
            }),
            q = (e) => {
              const t = v();
            ...
            Q = (e) =>
              D(this, void 0, void 0, function* () {
                const { activeSheetViewer: t } = (0, O.nZ)(),
                ...
                (n.style.width = K.width + "px"),
                  ...
                  n.appendChild(a);
                const { width: o, height: i } = Z.value;
                ...
                const l = a.querySelector('g[data-view-id="preview"]'),
                  r =
                    `translate(${-(e.left + j.value.scrollLeft)}, ${-(e.top + j.value.scrollTop)}) ` +
                    Y.value;
          ...
          const ie = () => {
            ...
            de = () => {
              var e, t;
              M.value
                ? ((t = M.value), h.shell.showItemInFolder(t))
          ...
          return {
            ...
            defaultRate: R,
            editorContainer: $,
            defaultModalOptions: E,
            isShowTabBar: U,
            topbarHeight: N,
            canvasClient: Z,
            canvasContentTransform: Y,
            containerStyle: X,
            ...
            onWheelAndPinch: (e) => {
              if (e.ctrlKey) {
                ...
                a > l.Y1 ? (a = l.Y1) : a < l.d_ && (a = l.d_),
                  (0, P.E)().updateSheetStatus({
                    id: (0, O.nZ)().activeSheetId.value,
                    zoomScale: a,
                  });
