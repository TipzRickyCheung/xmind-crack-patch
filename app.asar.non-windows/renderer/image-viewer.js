/*! For license information please see image-viewer.js.LICENSE.txt */
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [7746, 9891],
  {
    ...
    61575: (t, e, n) => {
      ...
      r.push([
        t.id,
        "#app[data-v-19822ed4] {\n  display: flex;\n  flex-direction: column;\n}\nmain[data-v-19822ed4] {\n  padding: 16px;\n  flex-grow: 1;\n  overflow: overlay;\n}\n.image-viewer[data-v-19822ed4] {\n  object-fit: contain;\n  transition: all 0.1s;\n}\n.loading-spinner[data-v-19822ed4] {\n  z-index: 99;\n  position: absolute;\n  overflow: hidden;\n}\n.loading-spinner .spinner-container[data-v-19822ed4] {\n  margin: auto;\n}\n.uk-window-control-button-group[data-v-19822ed4] {\n  width: auto;\n  height: 100%;\n}\n",
        "",
      ]);
      const o = r;
    },
    ...
    94135: (t, e, n) => {
      ...
      const A = () => ({
        ...
        u = (t, e, n, i) => {
          ...
          if (n > i) {
            if (e > 0) return { [t]: o };
            if (e < 0 && r < i) return { [t]: -o };
          } else if (e < 0 || r > i) return { [t]: e < 0 ? o : -o };
          return {};
        };
      ...
      const d = (0, r.aZ)({
        ...
        setup(t) {
          ...
          const n = (0, r.iH)(e.get("imageUrl"));
          let i = !1,
            d = { deltaX: 0, deltaY: 0, transformX: 0, transformY: 0 };
          const p = (0, r.iH)(null),
            h = (t) => {
              n.value = t;
            },
            ...
            m = (0, r.iH)({ scale: 1, x: 0, y: 0 }),
            v = (t) => {
              m.value = Object.assign(Object.assign({}, m.value), t);
            },
            w = (0, r.Fl)(() => ({
              transform: `translate3d(${m.value.x}px,${m.value.y}px, 0px ) scale3d(${m.value.scale}, ${m.value.scale}, 1)`,
            }));
          let M = a.ZP.route(l.RV, ({ imageUrl: t, imageSize: e, title: n }) =>
            f(this, void 0, void 0, function* () {
              y(!0);
              const i = (function () {
                let t;
                const e = o.screen.getAllDisplays();
                if (1 === e.length) t = e[0];
                else {
                  if (!t) {
                    const e = o.BrowserWindow.getFocusedWindow();
                    e && (t = o.screen.getDisplayMatching(e.getBounds()));
                  }
                  t ||
                    ((t = o.screen.getPrimaryDisplay()),
                    !t && e.length > 1 && (t = e[0]));
                }
                return t;
              })();
              let r = e;
              (r.width = Math.min(r.width, i.size.width * c.Mb)),
                (r.width = Math.max(r.width, i.size.width * c.bc)),
                (r.height = Math.min(r.height, i.size.height * c.Mb)),
                (r.height = Math.max(r.height, i.size.height * c.bc));
              const s = (0, o.getCurrentWindow)();
              ...
              a.set("imageUrl", t),
                a.set("imageWidth", e.width),
                a.set("imageHeight", e.height),
                a.set("title", n);
              const l = `${window.location.pathname}?${a.toString()}`;
              history.pushState(null, "", l), h(t), v({ scale: 1, x: 0, y: 0 });
            }),
          );
          const I = (t) => {
            (0, o.getCurrentWindow)().isFocused() &&
              ["Space", "Escape"].includes(t.code) &&
              window.close();
          };
          (0, r.Jd)(() => {
            M && (M(), (M = null)), window.removeEventListener("keydown", I);
          }),
            (0, r.bv)(() => {
              if (!p.value) return;
              const t = (0, o.getCurrentWindow)();
              t.setTitle(e.get("title")),
                t.focus(),
          ...
          const B = (t, e, n) => {
            ...
            let c = t,
              u = m.value.scale * t;
            u > 3
              ? ((c = 3 / m.value.scale), (u = 3))
              : u < 1 && ((c = 1 / m.value.scale), (u = 1));
            const f = null != e ? e : innerWidth / 2,
              d = null != n ? n : innerHeight / 2,
              h = c - 1,
              g = h * i * 0.5,
              y = h * r * 0.5,
              w = h * (f - m.value.x - a),
          ...
          return {
            ...
            updateImageUrl: h,
            isImageLoading: g,
            updateIsImageLoading: y,
            transform: m,
            updateTransform: v,
            imageElementStyle: w,
            unroute: M,
            onKeyDown: I,
            dispatchZoomChange: B,
            handleWheel: (t) => {
              if (0 == t.deltaY) return;
              const e = Math.abs(t.deltaY / 100);
              let n = 1 + 0.2 * Math.min(e, 1);
              t.deltaY > 0 && (n = 1 / n), B(n, t.clientX, t.clientY);
            },
            handleStartMove: (t) => {
              0 === t.button &&
                ((d = {
                  deltaX: t.pageX - m.value.x,
                  deltaY: t.pageY - m.value.y,
                  transformX: m.value.x,
                  transformY: m.value.y,
                }),
                (i = !0));
            },
            handleOnMove: (t) => {
              i && v({ x: t.pageX - d.deltaX, y: t.pageY - d.deltaY });
            },
            handleStopMove: () => {
              if (!i) return;
              i = !1;
              const { x: t, y: e, scale: n } = m.value,
                { transformX: r, transformY: o } = d;
              if (!(t !== r && e !== o)) return;
              const s = p.value.offsetWidth * n,
                a = p.value.offsetHeight * n,
                { left: l, top: c } = p.value.getBoundingClientRect(),
                f = ((t, e, n, i) => {
                  const { width: r, height: o } = A();
                  let s = null;
                  return (
                    t <= r && e <= o
                      ? (s = { x: 0, y: 0 })
      ...
      const p = (0, n(51900).Z)(
        ...
        function () {
          ...
          return e(
            "div",
            {
              staticClass: "uk-window uk-flex uk-flex-column",
            ...
            [
              n.isImageLoading
                ? e(n.Spinner, {
                    staticClass: "loading-spinner uk-width-1-1 uk-height-1-1",
                    attrs: { text: t.$T("Loading...") },
                  })
                : t._e(),
              t._v(" "),
              e(
                ...
                {
                  staticClass:
                    "uk-window-title-bar uk-width-1-1 uk-flex uk-flex-center uk-flex-middle uk-background-default",
                },
              ...
              e(
                "main",
                {
                  ref: "container",
                  staticClass:
                    "uk-flex uk-flex-center uk-flex-middle uk-width-1-1",
                  on: {
                    wheel: function (t) {
                      return (
                        t.preventDefault(),
                        t.stopPropagation(),
                        n.handleWheel.apply(null, arguments)
                      );
                    },
                    mousedown: function (t) {
                      return (
                        t.preventDefault(),
                        t.stopPropagation(),
                        n.handleStartMove.apply(null, arguments)
                      );
                    },
                    mousemove: function (t) {
                      return (
                        t.preventDefault(),
                        t.stopPropagation(),
                        n.handleOnMove.apply(null, arguments)
                      );
                    },
                    mouseup: function (t) {
                      return (
                        t.preventDefault(),
                        t.stopPropagation(),
                        n.handleStopMove.apply(null, arguments)
                      );
                    },
                ...
                [
                  e("img", {
                    ref: "imageElement",
                    staticClass: "uk-height-1-1 uk-width-1-1 image-viewer",
                    style: n.imageElementStyle,
                    attrs: { src: n.imageUrl, draggable: "false" },
                    on: { load: n.onImageLoadFinished },
                  }),
                ],
              ),
            ],
    ...
    77760: (t) => {
      ...
      function St(t) {
        return Dt(t) ? St(t.__v_raw) : !(!t || !t.__ob__);
      }
      function kt(t) {
