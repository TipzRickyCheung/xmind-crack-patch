...
(global.webpackChunkxmind_vana = global.webpackChunkxmind_vana || []).push([
  [8656],
  {
          ...
          var l = (o.MD5 = s.extend({
            ...
            _doProcessBlock: function (t, e) {
              ...
              var s = this._hash.words,
                ...
                k = s[3];
              (C = c(C, x, _, k, o, 7, a[0])),
                (k = c(k, C, x, _, l, 12, a[1])),
                (_ = c(_, k, C, x, d, 17, a[2])),
                (x = c(x, _, k, C, p, 22, a[3])),
                (C = c(C, x, _, k, h, 7, a[4])),
                (k = c(k, C, x, _, g, 12, a[5])),
                (_ = c(_, k, C, x, m, 17, a[6])),
                (x = c(x, _, k, C, y, 22, a[7])),
                (C = c(C, x, _, k, v, 7, a[8])),
                (k = c(k, C, x, _, w, 12, a[9])),
                (_ = c(_, k, C, x, M, 17, a[10])),
                (x = c(x, _, k, C, I, 22, a[11])),
                (C = c(C, x, _, k, b, 7, a[12])),
                (k = c(k, C, x, _, B, 12, a[13])),
                (_ = c(_, k, C, x, E, 17, a[14])),
                (C = A(
                  C,
                  (x = c(x, _, k, C, N, 22, a[15])),
                  _,
                  k,
                  l,
                  5,
                ...
                (k = A(k, C, x, _, m, 9, a[17])),
                (_ = A(_, k, C, x, I, 14, a[18])),
                (x = A(x, _, k, C, o, 20, a[19])),
                (C = A(C, x, _, k, g, 5, a[20])),
                (k = A(k, C, x, _, M, 9, a[21])),
                (_ = A(_, k, C, x, N, 14, a[22])),
                (x = A(x, _, k, C, h, 20, a[23])),
                (C = A(C, x, _, k, w, 5, a[24])),
                (k = A(k, C, x, _, E, 9, a[25])),
                (_ = A(_, k, C, x, p, 14, a[26])),
                (x = A(x, _, k, C, v, 20, a[27])),
                (C = A(C, x, _, k, B, 5, a[28])),
                (k = A(k, C, x, _, d, 9, a[29])),
                (_ = A(_, k, C, x, y, 14, a[30])),
                (C = u(
                  C,
                  (x = A(x, _, k, C, b, 20, a[31])),
                  _,
                  k,
                  g,
                  4,
                ...
                (k = u(k, C, x, _, v, 11, a[33])),
                (_ = u(_, k, C, x, I, 16, a[34])),
                (x = u(x, _, k, C, E, 23, a[35])),
                (C = u(C, x, _, k, l, 4, a[36])),
                (k = u(k, C, x, _, h, 11, a[37])),
                (_ = u(_, k, C, x, y, 16, a[38])),
                (x = u(x, _, k, C, M, 23, a[39])),
                (C = u(C, x, _, k, B, 4, a[40])),
                (k = u(k, C, x, _, o, 11, a[41])),
                (_ = u(_, k, C, x, p, 16, a[42])),
                (x = u(x, _, k, C, m, 23, a[43])),
                (C = u(C, x, _, k, w, 4, a[44])),
                (k = u(k, C, x, _, b, 11, a[45])),
                (_ = u(_, k, C, x, N, 16, a[46])),
                (C = f(
                  C,
                  (x = u(x, _, k, C, d, 23, a[47])),
                  _,
                  k,
                  o,
                  6,
                ...
                (k = f(k, C, x, _, y, 10, a[49])),
                (_ = f(_, k, C, x, E, 15, a[50])),
                (x = f(x, _, k, C, g, 21, a[51])),
                (C = f(C, x, _, k, b, 6, a[52])),
                (k = f(k, C, x, _, p, 10, a[53])),
                (_ = f(_, k, C, x, M, 15, a[54])),
                (x = f(x, _, k, C, l, 21, a[55])),
                (C = f(C, x, _, k, v, 6, a[56])),
                (k = f(k, C, x, _, N, 10, a[57])),
                (_ = f(_, k, C, x, m, 15, a[58])),
                (x = f(x, _, k, C, B, 21, a[59])),
                (C = f(C, x, _, k, h, 6, a[60])),
                (k = f(k, C, x, _, I, 10, a[61])),
                (_ = f(_, k, C, x, d, 15, a[62])),
                (x = f(x, _, k, C, w, 21, a[63])),
                (s[0] = (s[0] + C) | 0),
                (s[1] = (s[1] + x) | 0),
                (s[2] = (s[2] + _) | 0),
                (s[3] = (s[3] + k) | 0);
    ...
    6671: (t, e, n) => {
      ...
      r.push([
        t.id,
        ".fd-margin-left[data-v-65dd9eb7] {\n  margin-left: 12px;\n}\n.fd-margin-bottom[data-v-65dd9eb7] {\n  margin-bottom: 12px;\n}\n.fd-margin-top[data-v-65dd9eb7] {\n  margin-top: 12px;\n}\n.fd-margin-bottom-zero[data-v-65dd9eb7] {\n  margin-bottom: 0;\n}\n.fd-textarea-box[data-v-65dd9eb7] {\n  overflow: auto;\n  height: 213px;\n  box-sizing: border-box;\n}\n.fd-textarea-box > textarea[data-v-65dd9eb7] {\n  border-color: transparent;\n}\n.fd-textarea-box > textarea[data-v-65dd9eb7]:hover {\n  box-shadow: none !important;\n}\n.fd-textarea-seprator[data-v-65dd9eb7] {\n  margin-top: 5px;\n  margin-left: 12px;\n  margin-right: 12px;\n  height: 1px;\n}\n.fd-warning-box[data-v-65dd9eb7] {\n  margin-bottom: 20px;\n  height: 120px;\n}\n.uk-textarea[data-v-65dd9eb7] {\n  box-shadow: none;\n}\n#fd-send-diagnostic[data-v-65dd9eb7] {\n  margin-top: 12px;\n}\n.fd-diagnistic-text p[data-v-65dd9eb7],\n.fd-diagnistic-text ul[data-v-65dd9eb7],\n.fd-diagnistic-text ol[data-v-65dd9eb7],\n.fd-diagnistic-text dl[data-v-65dd9eb7] {\n  margin: 0;\n}\n.fd-diagnistic-text li[data-v-65dd9eb7],\n.fd-diagnistic-text p.fd-margin-top[data-v-65dd9eb7] {\n  margin-top: 12px;\n}\n.fd-diagnistic-text ul[data-v-65dd9eb7] {\n  padding-inline-start: 20px;\n  padding-right: 20px;\n}\n#fd-diagnostic-list[data-v-65dd9eb7] {\n  list-style-type: initial;\n}\n",
        "",
      ]);
      const s = r;
    },
    ...
    26964: (t, e, n) => {
      ...
      const f =
        ...
        d = s().parse(location.search.substr(1)),
        p = {
          mixins: [A.Z],
          data() {
            return {
          ...
          computed: {
            isBetaVersion: () => (0, c.Z)("version").includes("beta"),
            qrcodeURL() {
              return this.isBetaVersion
                ? `${this.$toResourceURL("static/images/feedback-beta-qrcode.png")}`
                : `${this.$toResourceURL("static/images/feedback-qrcode.png")}`;
            },
            qrcodeHDURL() {
              return this.isBetaVersion
                ? `${this.$toResourceURL("static/images/feedback-beta-qrcode.png")} 1x, ${this.$toResourceURL("static/images/feedback-beta-qrcode@2x.png")} 2x`
                : `${this.$toResourceURL("static/images/feedback-qrcode.png")} 1x, ${this.$toResourceURL("static/images/feedback-qrcode@2x.png")} 2x`;
            },
            vanaEmail() {
              if (this.isBetaVersion) return "beta@xmind.app";
              return "xmind-2024@xmind.app";
            },
            activationStatus: () => (0, u.Yh)().status,
            isChinaArea: () => "cn" === (0, u.qr)().serviceRegion,
            isSendDisabled() {
              return (
                !this.isEmailValid ||
                (!this.feedbackModel.trim() && !this.isSendDiagnostic) ||
                this.isOversize ||
                this.isSending
              );
            },
            touchBarItems() {
              return "contact" === this.activeTab
                ? [
          ...
          async mounted() {
            (this.emailModel = (0, u.c7)().primaryEmail),
              this.emailModel && this.$refs.textareaRef.focus(),
              d.message && (this.feedbackModel = d.message);
          },
          created() {
            const t = s().parse(window.location.search.slice(1));
            this.isSendDiagnostic = "true" === t.isSendDiagnostic;
          },
          methods: {
            cancel() {
              window.close();
            ...
            validateEmail() {
              this.isEmailValid = this.emailModel && f.test(this.emailModel);
            },
            attachFile({ target: t }) {
              ...
              (this.file = e),
                ...
                (this.isOversize = e.size > 20971520);
            },
            async send() {
              if (this.isSending) return;
              (this.isSending = !0), (0, u.c)().updateFeedback(this.emailModel);
              const t = this.feedbackModel.trim(),
                e = {
                  title: "Bug Report",
                  name: this.reporterModel,
                  email: this.emailModel,
                  sub_status: this.activationStatus === o.wi.VALID ? 1 : 0,
                  content: t || "Default feedback",
                  isSendDiagnostic: this.isSendDiagnostic.toString(),
                };
              if (this.file) {
                ...
                e.image = [t, this.fileName];
              }
              return l.ZP.fetch(a.lf.FEEDBACK, e)
                .then(() => {
                  (this.isSending = !1), window.close();
                })
                .catch((t) => {
                  (this.isSending = !1), (this.error = t);
                });
            },
            removeAttachment() {
              (this.file = null), (this.fileName = ""), (this.isOversize = !1);
            },
          },
          components: {
            SupportCenterTemplate: {
              render(t) {
                const e = this.$T("Support Center"),
                  n = this.$T(
                    "Solution to some frequent problems can be found at $1.",
                    e,
                  ),
                  i = t(
                    "span",
                    {
                      class: "uk-link",
                      on: {
                        mousedown: () => (0, u.JX)().handleCommand("support"),
                      },
                    },
                    e,
                  ),
                  r = n.split(e).map((e) => t("span", e));
                return t("div", { class: "uk-margin-small-top" }, [
                  r[0],
                  i,
                  r[1],
                ]);
          ...
          return e(
            ...
            [
              e(
                ...
                [
                  e("div", { staticClass: "uk-window-title" }, [
                    t._v("\n      " + t._s(t.$T("Feedback")) + "\n    "),
                  ]),
                  t._v(" "),
              ...
              t._v(" "),
              e("div", { staticClass: "uk-window-body uk-overflow-hidden" }, [
                e(
                  "ul",
                  {
                    staticClass:
                      "uk-tab uk-tab-capsule uk-tab-large uk-flex-center uk-margin-top fd-margin-bottom-zero",
                    ...
                    e(
                      ...
                      [
                        e(
                          ...
                          [t._v(t._s(t.$T("Report a Problem")))],
                        ),
                      ],
                    ),
                    t._v(" "),
                    e("li", { attrs: { "aria-expanded": "false" } }, [
                      e(
                        "a",
                        {
                          attrs: { draggable: "false", href: "#" },
                ...
                e(
                  "ul",
                  {
                    staticClass: "uk-switcher uk-padding main_content_switcher",
                  },
                  [
                    e(
                      "li",
                      ...
                      [
                        e(
                          "div",
                          { staticClass: "uk-margin uk-flex fd-margin-bottom" },
                          [
                            e("input", {
                              directives: [
                                {
                              ...
                              class: { "uk-form-danger": !t.isEmailValid },
                              attrs: {
                                type: "text",
                                placeholder: t.$T("Email Address"),
                                autofocus: !t.emailModel,
                              },
                              domProps: { value: t.emailModel },
                              on: {
                                blur: t.validateEmail,
                                input: function (e) {
                                  e.target.composing ||
                                    (t.emailModel = e.target.value);
                                },
                              },
                            }),
                            t._v(" "),
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: t.reporterModel,
                                  expression: "reporterModel",
                                },
                              ],
                              staticClass: "uk-input fd-margin-left",
                              staticStyle: { width: "160px" },
                              attrs: {
                                type: "text",
                                placeholder: t.$T("Name (Optional)"),
                              },
                              domProps: { value: t.reporterModel },
                              on: {
                                input: function (e) {
                                  e.target.composing ||
                                    (t.reporterModel = e.target.value);
                                },
                              },
                            }),
                          ],
                        ...
                        e(
                          ...
                          {
                            ref: "textareaBox",
                            staticClass: "uk-form-input fd-textarea-box",
                          },
                          [
                            e("textarea", {
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: t.feedbackModel,
                                  expression: "feedbackModel",
                                },
                              ],
                              ref: "textareaRef",
                              ...
                              attrs: {
                                placeholder: t.$T(
                                  "If you have encountered software issues, or have software-related suggestion, please send us feedback with detailed description.",
                                ),
                              },
                              domProps: { value: t.feedbackModel },
                              on: {
                                input: function (e) {
                                  e.target.composing ||
                                    (t.feedbackModel = e.target.value);
                                },
                              },
                            }),
                            t._v(" "),
                            e("div", {
                              staticClass:
                                "uk-tab-divider fd-textarea-seprator",
                            }),
                            t._v(" "),
                            e(
                              "div",
                              {
                                staticClass:
                                  "fd-attachment-box uk-margin uk-margin-small-top uk-margin-xsmall-bottom uk-flex uk-flex-middle fd-margin-left",
                              },
                              [
                                e("div", { staticClass: "uk-form-custom" }, [
                                  e("input", {
                                    attrs: {
                                      type: "file",
                                      onfocus: "this.blur()",
                                  ...
                                  e(
                                    ...
                                    {
                                      staticClass:
                                        "uk-button uk-button-icon uk-icon uk-flex-row-reverse uk-button-text",
                                      attrs: { "uk-icon": "attachment" },
                                    },
                                    [
                                      e(
                                        "span",
                                        {
                                          staticClass:
                                            "uk-overflow-hidden uk-display-block uk-text-nowrap",
                                          staticStyle: {
                                  ...
                                  directives: [
                                    {
                                      name: "show",
                                      rawName: "v-show",
                                      value: t.isAttachmentSelected,
                                      expression: "isAttachmentSelected",
                                    },
                                  ],
                                  staticClass:
                                    "uk-margin-small-left uk-button-icon",
                                  attrs: { "uk-icon": "icon: clear" },
                                  on: { click: t.removeAttachment },
                                }),
                              ],
                            ),
                          ],
                        ...
                        e(
                          "div",
                          {
                            staticClass: "uk-flex uk-width-1-1 uk-flex-middle",
                            attrs: { id: "fd-send-diagnostic" },
                          },
                          [
                            e("input", {
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: t.isSendDiagnostic,
                                  expression: "isSendDiagnostic",
                                },
                              ],
                              staticClass:
                                "uk-checkbox uk-flex-no-shrink uk-flex-no-grow uk-margin-remove-top",
                              staticStyle: { outline: "none" },
                              attrs: { type: "checkbox" },
                              domProps: {
                                checked: Array.isArray(t.isSendDiagnostic)
                                  ? t._i(t.isSendDiagnostic, null) > -1
                                  : t.isSendDiagnostic,
                              },
                              on: {
                                change: function (e) {
                                  var n = t.isSendDiagnostic,
                                    i = e.target,
                                    r = !!i.checked;
                                  if (Array.isArray(n)) {
                                    var s = t._i(n, null);
                                    i.checked
                                      ? s < 0 &&
                                        (t.isSendDiagnostic = n.concat([null]))
                                      : s > -1 &&
                                        (t.isSendDiagnostic = n
                                          .slice(0, s)
                                          .concat(n.slice(s + 1)));
                                  } else t.isSendDiagnostic = r;
                                },
                              },
                            }),
                            t._v(" "),
                            e(
                              ...
                              {
                                staticClass:
                                  "uk-margin-remove-bottom uk-margin-xsmall-left",
                                on: {
                                  click: () =>
                                    (t.isSendDiagnostic = !t.isSendDiagnostic),
                                },
                              },
                              [t._v(t._s(t.$T("Share Diagnostic Data")))],
                            ),
                            t._v(" "),
                            e("span", {
                              staticClass:
                                "uk-flex-no-shrink uk-flex-no-grow uk-margin-xsmall-left",
                              staticStyle: { outline: "none" },
                              attrs: {
                                id: "fd-question",
                            ...
                            e(
                              "div",
                              {
                                ...
                                attrs: {
                                  ...
                                  "data-align-size": "false",
                                  "data-z-index": "1000",
                                  "data-target": "#fd-question [uk-popover]",
                                },
                              },
                              [
                                e(
                                  ...
                                  {
                                    staticClass:
                                      "fd-diagnistic-text uk-background-default uk-padding-medium uk-text-left",
                                  ...
                                  [
                                    e("p", [
                                      t._v(
                                        "\n                " +
                                          t._s(
                                            t.$T(
                                              "Diagnostic data helps Xmind troubleshoot your problems and improve the product. Here is what data is collected and why:",
                                            ),
                                          ) +
                                          "\n              ",
                                      ),
                                          ...
                                          e("p", [
                                            t._v(
                                              "\n                    " +
                                                t._s(
                                                  t.$T(
                                                    "Xmind version and system information, e.g. the system is Windows, MacOS, or Linux. This is basic for understanding the specific environment where the problems/issues occur.",
                                                  ),
                                                ) +
                                                "\n                  ",
                                            ),
                                          ...
                                          e("p", [
                                            t._v(
                                              "\n                    " +
                                                t._s(
                                                  t.$T(
                                                    "Events in Xmind. This includes what happened in Xmind, e.g. a window was closed by user. It helps to analyze the reasons caused the problems/issues.",
                                                  ),
                                                ) +
                                                "\n                  ",
                                            ),
                                          ...
                                          e("p", [
                                            t._v(
                                              "\n                    " +
                                                t._s(
                                                  t.$T(
                                                    "Error message. This records detailed information of the error, e.g. which part of the program code the error occurred at.",
                                                  ),
                                                ) +
                                                "\n                  ",
                                            ),
                                    ...
                                    t._v(" "),
                                    e("p", { staticClass: "fd-margin-top" }, [
                                      t._v(
                                        "\n                " +
                                          t._s(
                                            t.$T(
                                              "The collected information is basic, but sometimes the username of your system and the file paths accessed by Xmind may be collected as well. They are usually recorded in error message.",
                                            ),
                                          ) +
                                          "\n              ",
                                      ),
                        ...
                        t._v(" "),
                        e("SupportCenterTemplate"),
                        t._v(" "),
                        e(
                          "div",
                          { staticClass: "uk-margin-small-top uk-flex" },
                          [
                            e("span", {
                              directives: [
                                {
                                  name: "show",
                                  rawName: "v-show",
                                  value: t.isOversize || t.error,
                                  expression: "isOversize || error",
                                },
                              ],
                            ...
                            t._v(" "),
                            e("span", { staticClass: "uk-text-muted" }, [
                              t._v(
                                "\n            " +
                                  t._s(
                                    t.isOversize
                                      ? t.$T("File size cannot exceed 20MB.")
                                      : "",
                                  ) +
                                  "\n          ",
                              ),
                    ...
                    e(
                      "li",
                      { staticClass: "uk-panel-scrollable uk-padding-remove" },
                      [
                        e(
                          "div",
                          { staticClass: "uk-child-separator uk-text-center" },
                          [
                            e("div", { staticClass: "uk-padding uk-panel" }, [
                              e(
                                "div",
                                {
                                  staticClass:
                                    "uk-margin-auto uk-flex uk-flex-middle",
                                  style: {
                                    width: t.isChinaArea ? "204px" : "244px",
                                  },
                                },
                                [
                                  e("div", {
                                    ...
                                    attrs: {
                                      "data-src": t.$toResourceURL(
                                        "static/images/feedback-email-icon.svg",
                                      ),
                                      "uk-img": "",
                                    },
                                  }),
                                  ...
                                  e(
                                    ...
                                    {
                                      staticClass:
                                        "uk-margin-left uk-button uk-button-link",
                                      attrs: {
                                        draggable: "false",
                                        href: "mailto:" + t.vanaEmail,
                                        target: "_blank",
                                      },
                                    },
                                    [t._v(t._s(t.vanaEmail))],
                                  ),
                                ],
                              ),
                            ]),
                            ...
                            t.isSME || t.isVLE
                              ...
                              : e("div", [
                                  t.isChinaArea
                                    ...
                                    : e(
                                        "div",
                                        { staticClass: "uk-padding uk-panel" },
                                        [
                                          e(
                                            "div",
                                            {
                                            ...
                                            [
                                              e("div", {
                                                ...
                                                attrs: {
                                                  "data-src": t.$toResourceURL(
                                                    "static/images/feedback-discord-icon.svg",
                                                  ),
                                                  "uk-img": "",
                                                },
                                              }),
                                              ...
                                              e(
                                                "a",
                                                {
                                                  ...
                                                  attrs: {
                                                    draggable: "false",
                                                    href: "https://discord.gg/Z9TNaBZRDQ",
                                                    target: "_blank",
                                                  },
                                                },
                                                [
                                                  t._v(
                                                    "Discord-Xmindist community",
                                                  ),
                                                ],
                                              ),
                                            ],
                                          ...
                                          e(
                                            ...
                                            [
                                              e("div", {
                                                ...
                                                attrs: {
                                                  "data-src": t.$toResourceURL(
                                                    "static/images/feedback-wechat-icon.svg",
                                                  ),
                                                  "uk-img": "",
                                                },
                                              }),
                                              ...
                                              e(
                                                ...
                                                {
                                                  staticClass:
                                                    "uk-width-expand uk-flex",
                                                },
                                                [
                                                  e("div", {
                                                    staticClass:
                                                      "uk-background-contain uk-margin-left",
                                                    staticStyle: {
                                                      width: "140px",
                                                      height: "140px",
                                                    },
                                                    attrs: {
                                                      "data-src": t.qrcodeURL,
                                                      "data-srcset":
                                                        t.qrcodeHDURL,
                                                      "uk-img": "",
                                                    },
              ...
              e(
                ...
                {
                  staticClass:
                    "uk-switcher uk-window-button-bar main_content_switcher",
                },
                [
                  e("li", { staticClass: "uk-button-group uk-active" }, [
                    e(
                      "button",
                      {
                        staticClass: "uk-button uk-button-primary",
                        attrs: { disabled: t.isSendDisabled },
                        on: { click: t.send },
                      },
                      [
                        e("span", {
                        ...
                        t.isSendDiagnostic
                          ? e("span", [
                              t._v(t._s(t.$T("Send (with Diagnostic Data)"))),
                            ])
                          : e("span", [t._v(t._s(t.$T("Send")))]),
                      ],
                    ),
                    t._v(" "),
                    e(
                  ...
                  t._v(" "),
                  e("li", { staticClass: "uk-button-group" }, [
                    e(
                      "button",
                      {
                        staticClass: "uk-button uk-button-default",
    ...
    45346: (t, e, n) => {
      ...
      function i(t, e) {
        for (var n = [], i = {}, r = 0; r < e.length; r++) {
          var s = e[r],
            o = s[0],
            a = { id: t + ":" + r, css: s[1], media: s[2], sourceMap: s[3] };
    ...
    77760: (t) => {
      ...
      function _(t) {
        const e = {};
        for (let n = 0; n < t.length; n++) t[n] && x(e, t[n]);
        return e;
      }
      function k(t, e, n) {}
      const j = (t, e, n) => !1,
      ...
      const bt = { notify: k, depend: k, addSub: k, removeSub: k };
      class Bt {
        ...
        return (
          Object.defineProperty(t, e, {
            ...
            get: function () {
              ...
              return (
                dt.target && (a.depend(), u && (u.dep.depend(), n(e) && _t(e))),
                Ot(e) && !s ? e.value : e
              );
            },
            set: function (e) {
      ...
      function _t(t) {
        for (let e, i = 0, r = t.length; i < r; i++)
          (e = t[i]), e && e.__ob__ && e.__ob__.dep.depend(), n(e) && _t(e);
      }
      function kt(t) {
        return jt(t, !0), U(t, "__v_isShallow", !0), t;
      }
      function jt(t, e) {
        Dt(t) || Et(t, e, tt());
      }
      ...
      function Lt(t, e) {
        ...
        return (
          U(n, "__v_isRef", !0),
          U(n, "__v_isShallow", e),
          U(n, "dep", Nt(n, "value", t, null, e, tt())),
          n
        );
      }
      function Qt(t, e, n) {
            ...
            if (m.active)
              if (i) {
                ...
                (s || p || (h ? t.some((t, e) => L(t, y[e])) : L(t, y))) &&
                  (d && d(),
                  u(i, "watcher callback", [t, y === Gt ? void 0 : y, g]),
                  (y = t));
              } else m.get();
          }),
          "sync" === o
        ...
        try {
          (s = n ? t.apply(e, n) : t.call(e)),
            s &&
              ...
              f(s) &&
              !s._handled &&
              (s.catch((t) => Se(t, i, r + " (Promise/async)")),
              (s._handled = !0));
        } catch (t) {
          Se(t, i, r);
        }
      ...
      var nn = Object.freeze({
        ...
        computed: function (t, e) {
          ...
          const s = tt() ? null : new cn(st, n, k, { lazy: !0 }),
            o = {
              effect: s,
              get value() {
                return s
          ...
          return U(o, "__v_isRef", !0), U(o, "__v_isReadonly", r), o;
        },
      ...
      function _n() {
        let t, e;
        for (Nn = Cn(), Bn = !0, wn.sort(xn), En = 0; En < wn.length; En++)
          (t = wn[En]),
            t.before && t.before(),
            (e = t.id),
            (In[e] = null),
      ...
      function Tn(t, i, r, o, a) {
        ...
        (this.data = t),
          ...
          l._scopeId
            ? (this._c = (t, e, i, r) => {
                const s = je(c, t, e, i, r, u);
                return (
                  s && !n(s) && ((s.fnScopeId = l._scopeId), (s.fnContext = o)),
                  s
                );
              })
            : (this._c = (t, e, n, i) => je(c, t, e, n, i, u));
      }
      ...
      function Rn(t, o, a, c, A) {
          ...
          (t = (function (t, e) {
            ...
            if (n && !r(t.owners)) {
              ...
              const A = (t) => {
                ...
                u = O((n) => {
                  (t.resolved = _e(n, e)), o ? (s.length = 0) : A(!0);
                }),
                d = O((e) => {
                ...
                l(p) &&
                  (f(p)
                    ...
                    : f(p.component) &&
                      ...
                      r(p.error) && (t.errorComp = _e(p.error, e)),
                      r(p.loading) &&
                        ((t.loadingComp = _e(p.loading, e)),
                        0 === p.delay
                          ? (t.loading = !0)
                          : (a = setTimeout(() => {
                              (a = null),
        ...
        if (s(t.options.functional))
          return (function (t, i, s, o, a) {
            ...
            const u = new Tn(s, c, a, o, t),
              f = l.render.call(null, u._c, u);
            if (f instanceof at) return Sn(f, s, u.parent, l);
            if (n(f)) {
              const t = qt(f) || [],
                e = new Array(t.length);
              for (let n = 0; n < t.length; n++)
                e[n] = Sn(t[n], s, u.parent, l);
              return e;
            }
          })(t, p, o, a, c);
        const h = o.on;
        ...
        for (let a = 0; a < o.length; a++)
          (i = o[a]),
            "__ob__" !== i &&
              ((r = t[i]),
              (s = e[i]),
              n && v(t, i) ? r !== s && A(r) && A(s) && Fn(r, s) : Ct(t, i, s));
        return t;
      }
      function Gn(t, e, n) {
        return n
        ...
        (Un.provide = function (t, e) {
          return t
            ? function () {
                const n = Object.create(null);
                return (
                  Fn(n, a(t) ? t.call(this) : t),
                  e && Fn(n, a(e) ? e.call(this) : e, !1),
                  n
                );
              }
            : e;
        ...
        if (
          ...
          (function (t) {
            ...
            if (n) {
              ...
              ot(t), ht();
              const r = De(n, null, [t._props || kt({}), i], t, "setup");
          ...
          e.methods &&
            (function (t, e) {
              t.$options.props;
              for (const n in e)
                t[n] = "function" != typeof e[n] ? k : N(e[n], t);
            })(t, e.methods),
          e.data)
        )
          !(function (t) {
        ...
        e.computed &&
          (function (t, e) {
            ...
            for (const r in e) {
              const s = e[r],
                o = a(s) ? s : s.get;
              i || (n[r] = new cn(t, o || k, k, ii)), r in t || ri(t, r, s);
            }
          })(t, e.computed),
          e.watch &&
            e.watch !== Z &&
      ...
      function ri(t, e, n) {
        const i = !tt();
        a(n)
          ? ((ti.get = i ? si(e) : oi(n)), (ti.set = k))
          : ((ti.get = n.get ? (i && !1 !== n.cache ? si(e) : oi(n.get)) : k),
            (ti.set = n.set || k)),
            ...
            (function (t) {
              ...
              (t.$slots = me(n._renderChildren, r)),
                (t.$scopedSlots = i
                  ...
                  : e),
                (t._c = (e, n, i, r) => je(t, e, n, i, r, !1)),
                (t.$createElement = (e, n, i, r) => je(t, e, n, i, r, !0));
              const s = i && i.data;
              Nt(t, "$attrs", (s && s.attrs) || e, null, !0),
                Nt(t, "$listeners", n._parentListeners || e, null, !0);
            })(n),
            vn(n, "beforeCreate", void 0, !1),
            (function (t) {
              const e = jn(t.$options.inject, t);
              e &&
                (It(!1),
          ...
          ge(t.prototype),
            ...
            (t.prototype._render = function () {
              ...
              i &&
                ...
                (t.$vnode = i);
              try {
                ot(t), (xe = t), (r = e.call(t._renderProxy, t.$createElement));
              } catch (e) {
      ...
      var Oi = Object.freeze({
          ...
          createElementNS: function (t, e) {
            return document.createElementNS(_i[t], e);
          },
            ...
            for (l in s)
              (c = r[l]),
                ...
                c
                  ...
                  : (Ji(A, "bind", e, t), A.def && A.def.inserted && o.push(A));
            if (o.length) {
              const i = () => {
                for (let n = 0; n < o.length; n++) Ji(o[n], "inserted", e, t);
              };
              n ? Zt(e, "insert", i) : i();
            }
            if (
              ...
              for (l in r) s[l] || Ji(r[l], "unbind", t, t, i);
          })(t, e);
      }
      ...
      function Ki(t, e) {
        ...
        for (o in ((P || J) && u.value !== A.value && Zi(c, "value", u.value),
        A))
          i(u[o]) &&
            (bi(o)
      ...
      function Ar(t, e) {
        ...
        for (n in c) {
          ...
          if ("value" === n && "PROGRESS" !== a.tagName) {
            ...
            ur(a, t) && (a.value = t);
          } else if ("innerHTML" === n && ji(a.tagName) && i(a.innerHTML)) {
      ...
      function hr(t) {
        return Array.isArray(t) ? _(t) : "string" == typeof t ? dr(t) : t;
      }
      const gr = /^--/,
        mr = /\s*!important$/,
        yr = (t, e, n) => {
          if (gr.test(e)) t.style.setProperty(e, n);
            ...
            t.style.setProperty(E(e), n.replace(mr, ""), "important");
          else {
            const i = Mr(e);
            if (Array.isArray(n))
          ...
          let i;
          {
            ...
            for (; e.componentInstance; )
              (e = e.componentInstance._vnode),
                e && e.data && (i = pr(e.data)) && x(n, i);
          }
          (i = pr(t.data)) && x(n, i);
          let r = t;
          for (; (r = r.parent); ) r.data && (i = pr(r.data)) && x(n, i);
          return n;
        })(e);
        for (a in u) i(d[a]) && yr(l, a, "");
        for (a in d) (o = d[a]), o !== u[a] && yr(l, a, null == o ? "" : o);
      }
      ...
      function Cr(t) {
        if (t) {
          if ("object" == typeof t) {
            const e = {};
            return !1 !== t.css && x(e, xr(t.name || "v")), x(e, t), e;
          }
      ...
      function Qr(t, e) {
        t._transitionClasses && m(t._transitionClasses, e), Nr(t, e);
      }
      function Rr(t, e, n) {
        const { type: i, timeout: r, propCount: s } = zr(t, e);
        if (!i) return n();
        const o = "transition" === i ? jr : Sr;
        let a = 0;
        const l = () => {
      ...
      function zr(t, e) {
        ...
        return (
                ...
                (u = c ? ("transition" === c ? r.length : a.length) : 0)),
          {
            ...
            timeout: A,
            propCount: u,
            hasTransform: "transition" === c && Yr.test(n[kr + "Property"]),
          }
        );
      }
      function Ur(t, e) {
      ...
      function Gr(t, e) {
        ...
        const x = !N._isMounted || !t.isRootInsert;
        if (x && !I && "" !== I) return;
        const _ = x && d ? d : A,
          k = x && g ? g : f,
          j = x && h ? h : u,
          ...
          z = (n._enterCb = O(() => {
            R && (Qr(n, j), Qr(n, k)),
              z.cancelled ? (R && Qr(n, _), L && L(n)) : D && D(n),
              (n._enterCb = null);
          }));
        t.data.show ||
          Zt(t, "insert", () => {
          ...
          R &&
            ...
            Or(() => {
              Qr(n, _),
                z.cancelled ||
                  (Lr(n, j), Y || ($r(Q) ? setTimeout(z, Q) : Rr(n, c, z)));
            })),
          t.data.show && (e && e(), S && S(n, z)),
          R || Y || z();
      }
      function Vr(t, e) {
        const n = t.elm;
      ...
      const Jr = (function (t) {
                  ...
                  for (; d <= h && p <= y; )
                    i(g)
                      ...
                      : i(m)
                        ? (m = e[--h])
                        : Ui(g, v)
                          ? (E(g, v, s, n, p), (g = e[++d]), (v = n[++p]))
                          : Ui(m, M)
                            ? (E(m, M, s, n, y), (m = e[--h]), (M = n[--y]))
                            : Ui(g, M)
                              ? (E(g, M, s, n, y),
                                b &&
                                  A.insertBefore(
                              ...
                              : Ui(m, v)
                                ? (E(m, v, s, n, p),
                                  b && A.insertBefore(t, m.elm, g.elm),
                                  (m = e[--h]),
                                  (v = n[++p]))
                                : (i(a) && (a = Fi(e, d, h)),
        ...
        return function (t, e, n, o) {
          ...
          if (i(t)) (a = !0), f(e, c);
            ...
            if (!i && Ui(t, e)) E(t, e, c, null, null, o);
            else {
              if (i) {
                if (
                  (1 === t.nodeType &&
      ...
      function as(t) {
        ...
        return e && e.Ctor.options.abstract ? as(ke(e.children)) : t;
      }
      function ls(t) {
        const e = {},
          n = t.$options;
      ...
      const ds = x({ tag: String, moveClass: String }, os);
      delete ds.mode;
      var ps = {
        props: ds,
        beforeMount() {
      ...
      (Ai.config.mustUseProp = (t, e, n) =>
        ...
        x(Ai.options.directives, ss),
        x(Ai.options.components, ys),
        (Ai.prototype.__patch__ = V ? Jr : k),
      ...
      function m(t, n, r = {}, o, l, c) {
        ...
        function _(e, n) {
          return function () {
            ...
            try {
              l = n.apply(this && this.$id === t ? this : j, i);
            } catch (t) {
              throw (f(a, t), t);
            }
        ...
        return (
          ...
          o._p.forEach((t) => {
            g(
              j,
              m.run(() => t({ store: j, app: o._a, pinia: o, options: y })),
            );
          }),
          E && c && r.hydrate && r.hydrate(j.$state, E),
          (w = !0),
          (M = !0),
          j
        );
